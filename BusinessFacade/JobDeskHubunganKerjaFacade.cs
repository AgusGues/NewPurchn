...
{
    public class JobDeskHubunganKerjaFacade : AbstractTransactionFacade
    {
        ...
        public JobDeskHubunganKerjaFacade(object objDomain)
            : base(objDomain)
        {
            objJobdeskDetail = (JobdeskDetail)objDomain;
        }

        public JobDeskHubunganKerjaFacade()
        {
        ...
        public override int Insert(TransactionManager transManager)
        {
            try
            {
                ...
                int intResult = transManager.DoTransaction(sqlListParam, "spInsertJobDeskHubunganKerja");
        ...
        public override int Update(TransactionManager transManager)
        {
            try
            {
                ...
                List<SqlParameter> sqlListParam = new List<SqlParameter>();
                sqlListParam.Add(new SqlParameter("@tampil", "updateHK"));
        ...
        {
            string strSQL = "select * from JobDeskHK";

...
{
    public class JobDeskPendidikanFacade : AbstractTransactionFacade
    {
        ...
        public JobDeskPendidikanFacade(object objDomain)
            : base(objDomain)
        {
            objJobdeskDetail = (JobdeskDetail)objDomain;
        }

        public JobDeskPendidikanFacade()
        {
        ...
        public override int Insert(TransactionManager transManager)
        {
            try
            {
                ...
                int intResult = transManager.DoTransaction(sqlListParam, "spInsertJobDeskPendidikan");
        ...
        public override int Update(TransactionManager transManager)
        {
            try
            {
                ...
                List<SqlParameter> sqlListParam = new List<SqlParameter>();
                sqlListParam.Add(new SqlParameter("@tampil", "updatePendidikan"));
        ...
        {
            string strSQL = "select * from JobDeskPendidikan";

...
{
    public class JobDeskPengetahuanFacade : AbstractTransactionFacade
    {
        ...
        public JobDeskPengetahuanFacade(object objDomain)
            : base(objDomain)
        {
            objJobdeskDetail = (JobdeskDetail)objDomain;
        }

        public JobDeskPengetahuanFacade()
        {
        ...
        public override int Insert(TransactionManager transManager)
        {
            try
            {
                ...
                int intResult = transManager.DoTransaction(sqlListParam, "spInsertJobDeskPengetahuan");
        ...
        public override int Update(TransactionManager transManager)
        {
            try
            {
                ...
                List<SqlParameter> sqlListParam = new List<SqlParameter>();
                sqlListParam.Add(new SqlParameter("@tampil", "updatePengetahuan"));
        ...
        {
            string strSQL = "select * from JobDeskPengetahuan";

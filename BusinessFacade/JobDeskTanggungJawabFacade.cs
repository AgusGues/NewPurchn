...
{
    public class JobDeskTanggungJawabFacade : AbstractTransactionFacade
    {
        ...
        public JobDeskTanggungJawabFacade(object objDomain)
            : base(objDomain)
        {
            objJobdeskDetail = (JobdeskDetail)objDomain;
        }

        public JobDeskTanggungJawabFacade()
        {
        ...
        public override int Insert(TransactionManager transManager)
        {
            try
            {
                ...
                int intResult = transManager.DoTransaction(sqlListParam, "spInsertJobDeskTanggungJawab");
        ...
        public override int Update(TransactionManager transManager)
        {
            try
            {
                ...
                List<SqlParameter> sqlListParam = new List<SqlParameter>();
                sqlListParam.Add(new SqlParameter("@tampil", "updateTanggungJawab"));
        ...
        {
            string strSQL = "select * from JobDeskTJ";

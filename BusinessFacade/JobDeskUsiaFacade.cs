...
{
    public class JobDeskUsiaFacade : AbstractTransactionFacade
    {
       ...
       // private List<SqlParameter> sqlListParam;
        ...
        public JobDeskUsiaFacade(object objDomain)
            : base(objDomain)
        {
            objJobdeskDetail = (JobdeskDetail)objDomain;
        }

        public JobDeskUsiaFacade()
        {
        ...
        public override int Insert(TransactionManager transManager)
        {
            try
            {
                ...
                int intResult = transManager.DoTransaction(sqlListParam, "spInsertJobDeskUsia");
        ...
        public override int Update(TransactionManager transManager)
        {
            try
            {
                ...
                List<SqlParameter> sqlListParam = new List<SqlParameter>();
                sqlListParam.Add(new SqlParameter("@tampil", "updateUsia"));
        ...
        {
            string strSQL = "select * from JobDeskUsia";

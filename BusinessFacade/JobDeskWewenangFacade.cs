...
{
    public class JobDeskWewenangFacade : AbstractTransactionFacade
    {
        ...
        public JobDeskWewenangFacade(object objDomain)
            : base(objDomain)
        {
            objJobdeskDetail = (JobdeskDetail)objDomain;
        }

        public JobDeskWewenangFacade()
        {
        ...
        public override int Insert(TransactionManager transManager)
        {
            try
            {
                ...
                int intResult = transManager.DoTransaction(sqlListParam, "spInsertJobDeskWewenang");
        ...
        public override int Update(TransactionManager transManager)
        {
            try
            {
                ...
                List<SqlParameter> sqlListParam = new List<SqlParameter>();
                sqlListParam.Add(new SqlParameter("@tampil", "updateWewenang"));
        ...
        {
            string strSQL = "select * from JobDeskWewenang";

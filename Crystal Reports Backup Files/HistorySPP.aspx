<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HistorySPP.aspx.cs" Inherits="GRCweb1.Modul.Purchasing.HistorySPP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="col-xs-12 col-sm-12 form-group-sm" id="Tbldetail" style="display:none">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">History SPP</h3>
                    </div>
                    <div class="panel-body">
    ...
    <script src="../../Scripts/jquery.blockui.min.js"></script>
        ...
        <script src="../../Scripts/Purchasing/HistSPP.js" type="text/javascript"></script>

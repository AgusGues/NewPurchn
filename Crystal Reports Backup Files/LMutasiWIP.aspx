<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LMutasiWIP.aspx.cs" Inherits="GRCweb1.Modul.AccountingReport.LaporanMutasiWIP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <head>
        ...
        <title>Laporan Mutasi WIP</title>
    ...
    <body class="no-skin">
        ...
        <div id="modalwip" class="modal fade">
            <div class="modal-dialog1">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h3 class="smaller lighter blue no-margin">Laporan Mutasi WIP</h3>
                    </div>
        ...
        <div id="modalwipm3" class="modal fade">
            <div class="modal-dialog1">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    ...
    <script src="../../Scripts/AccountingReport/LaporanMutasiWIP.js"></script>
    </html>

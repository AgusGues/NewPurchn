<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="LStockTransitT1.aspx.cs" Inherits="GRCweb1.Modul.ListReportT1T3.LStockTransitT1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <head>
        ...
        <title>Laporan Stock Lokasi Transit Tahap 1</title>
            ...
            <div class="col-xs-12 col-sm-12 form-group-sm">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">LAPORAN STOCK LOKASI TRANSIT TAHAP 1</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <button type='button' class="btn btn-sm btn-default" id="print">
                            ...
                            <div id="tbtranst1"></div>
                        </div>

                                                    <div class="table-responsive" hidden>
                            <div id="tbtranst1print"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="../../Scripts/ReportT1T3/LaporanLokasiTransitTahap1.js"></script>
    </html>

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="LapMutasiStockBJ.aspx.cs" Inherits="GRCweb1.Modul.AccountingReport.LaporanMutasiBJ" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="col-xs-12 col-sm-12 form-group-sm">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Laporan Mutasi Barang Jadi</h3>
                    </div>
            ...
            <div class="modal-dialog1">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        ...
                        <h3 class="smaller lighter blue no-margin">Laporan Mutasi Barang Jadi</h3>
                    </div>
    ...
    <script src="../../Scripts/AccountingReport/LaporanMutasiBJ.js"></script>
    </html>

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="LapMutasiStockBJT1.aspx.cs" Inherits="GRCweb1.Modul.AccountingReport.LaporanMutasiBJT1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <head>
        ...
        <title>Laporan Mutasi Barang Jadi Tahap 1</title>
    ...
    <body class="no-skin">
            ...
            <div class="col-xs-12 col-sm-12 form-group-sm">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Laporan Mutasi Barang Jadi Tahap 1</h3>
                    </div>
        ...
        <div id="modalbj" class="modal fade">
            <div class="modal-dialog1">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h3 class="smaller lighter blue no-margin">Laporan Mutasi Barang Jadi Tahap 1</h3>
                    </div>
        ...
        <div id="modalbjm3" class="modal fade">
            <div class="modal-dialog1">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    ...
    <script src="../../Scripts/AccountingReport/LaporanMutasiBJT1.js"></script>
    </html>

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="LapMutasiStockBS.aspx.cs" Inherits="GRCweb1.Modul.AccountingReport.LaporanMutasiBS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <head>
        ...
        <title>Laporan Mutasi Barang BS</title>
    ...
    <body class="no-skin">
            ...
            <div class="col-xs-12 col-sm-12 form-group-sm">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Laporan Mutasi Barang BS</h3>
                    </div>
                    <div class="panel-body">
                        <div class="col-xs-12 col-sm-6 form-group-sm">
                            ...
                            <div>
                                <input type="radio" id="normal" name="report" value="1" checked>
                                <label for="Tanggal" style="padding: 5px">Report Normal</label>
                                <input type="radio" id="autobs" name="report" value="2">
                                <label for="Approval" style="padding: 5px">Report BS Auto </label>
                                <input type="radio" id="utuh" name="report" value="2">
                                <label for="Approval" style="padding: 5px">Report Konversi Ke Ukuran Utuh </label>
                            </div>
            ...
            <div class="modal-dialog1">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        ...
                        <h3 class="smaller lighter blue no-margin">Laporan Mutasi Barang BS</h3>
                    </div>
        ...
        <div id="modalbsm3" class="modal fade">
            <div class="modal-dialog1">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    ...
    <script src="../../Scripts/AccountingReport/LaporanMutasiBS.js"></script>
    </html>

...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LapStockBarang.aspx.cs" Inherits="GRCweb1.Modul.ListReport.LapStockBarang" %>
		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class=panel-heading>
					<span class="the-title">Laporan Stock Barang</span>
				</div>
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="row">
								<div class="col-md-4">Type Stock</div>
								<div class="col-md-8">
									<select class="form-control input-sm select2" id="TypeStock" style="width: 100%;"></select>
									<div style="padding: 2px"></div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-4">Type Status</div>
								<div class="col-md-8">
									<select class="form-control input-sm select2" id="TypeStatus" style="width: 100%;"></select>
									<div style="padding: 2px"></div>
								</div>
							</div>
						</div>
...
<script src="../../Scripts/ListReport/LapStockBarang.js" type="text/javascript"></script>
</asp:Content>

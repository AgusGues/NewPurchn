                              ...
                              <table id="table" class="table table-striped table-bordered table-hover" border="1">
                               ...
                               <tfoot>
                                   <tr>
                                       ...
                                       <td>
                                           <asp:GridView ID="GrdDyntotal" runat="server" CssClass="table table-bordered"
                                           AutoGenerateColumns="False" PageSize="15" Width="100%" HeaderStyle-HorizontalAlign="Center">
                                           <RowStyle BackColor="WhiteSmoke" Font-Names="tahoma"  />
                                           <PagerStyle BorderStyle="Solid" />
                                           <AlternatingRowStyle BackColor="Gainsboro" />
                                       ...
                                       <td>
                                           <asp:GridView ID="GrdDyntotal2" runat="server" CssClass="table table-bordered"
                                           AutoGenerateColumns="False" PageSize="15" Width="100%" HeaderStyle-HorizontalAlign="Center">
                                           <RowStyle BackColor="WhiteSmoke" Font-Names="tahoma"  />
                                           <PagerStyle BorderStyle="Solid" />
                                           <AlternatingRowStyle BackColor="Gainsboro" />
                                       ...
                                       <td>
                                           <asp:GridView ID="GrdDyntotal3" runat="server" CssClass="table table-bordered"
                                           AutoGenerateColumns="False" PageSize="15" Width="100%" HeaderStyle-HorizontalAlign="Center">
                                           <RowStyle BackColor="WhiteSmoke" Font-Names="tahoma"  />
                                           <PagerStyle BorderStyle="Solid" />
                                           <AlternatingRowStyle BackColor="Gainsboro" />
                                       ...
                                       <td>
                                           <asp:GridView ID="GrdDyntotal4" runat="server" CssClass="table table-bordered"
                                           AutoGenerateColumns="False" PageSize="15" Width="100%" HeaderStyle-HorizontalAlign="Center" >
                                           <RowStyle BackColor="WhiteSmoke" Font-Names="tahoma"  />
                                           <PagerStyle BorderStyle="Solid" />
                                           <AlternatingRowStyle BackColor="Gainsboro" />
                                       ...
                                       <td>
                                           <asp:GridView ID="GrdDyntotal5" runat="server" CssClass="table table-bordered"
                                           AutoGenerateColumns="False" PageSize="15" Width="100%" HeaderStyle-HorizontalAlign="Center">
                                           <RowStyle BackColor="WhiteSmoke" Font-Names="tahoma"  />
                                           <PagerStyle BorderStyle="Solid" />
                                           <AlternatingRowStyle BackColor="Gainsboro" />
                                       ...
                                       <td>
                                           <asp:GridView ID="GrdDyntotal6" runat="server" CssClass="table table-bordered"
                                           AutoGenerateColumns="False" PageSize="15" Width="100%" HeaderStyle-HorizontalAlign="Center" >
                                           <RowStyle BackColor="WhiteSmoke" Font-Names="tahoma"  />
                                           <PagerStyle BorderStyle="Solid" />
                                           <AlternatingRowStyle BackColor="Gainsboro" />
                                   ...
                                   <tr>
                                       <td colspan="5">
                                           Keterangan :<br />
                                           *Note : Toleransi penyimpangan produk diatas ketebalan 4mm ± 10%
                                       </td>
                                       <td>BOARDMILL</td>
                                       <td>PPIC</td>
                                   </tr>

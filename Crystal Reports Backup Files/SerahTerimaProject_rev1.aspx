...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SerahTerimaProject_rev1.aspx.cs" Inherits="GRCweb1.Modul.MTC.SerahTerimaProject_rev1" %>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-8">
									<select class="form-control input-sm select2" id="NamaProject" style="width: 100%;"></select>
						...
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-8">
									<input type="text" class="form-control input-sm" id="Quantity" disabled="">
									<div style="padding: 2px"></div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-4">BiayaActual</div>
								<div class="col-md-8">
									<input type="text" class="form-control input-sm" id="BiayaActual" disabled="">
									<div style="padding: 2px"></div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-md-8">
									<input type="text" class="form-control input-sm" id="StatusProject" disabled="">
									<div style="padding: 2px"></div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-md-8">
									<input type="text" class="form-control input-sm" id="DeptPemohon" disabled="">
									<div style="padding: 2px"></div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12 text-right">
									<label class="btn btn-primary btn-xs" id="BtnApv">Approve</label>
...
<script src="../../Scripts/Maintenance/SerahTerima.js" type="text/javascript"></script>
</asp:Content>

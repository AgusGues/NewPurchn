...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UserPes.aspx.cs" Inherits="GRCweb1.Modul.Pes.UserPes" %>
		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class=panel-heading>
					<span class="the-title">Master Pes</span>
				</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-8">
									<input  type="number" class="form-control input-sm" id="UserId" value="-1" style="display: none;">
							...
							<div class="row">
								...
								<div class="col-md-8">
									<select class="form-control input-sm select2" id="Company" style="width: 100%;"></select>
									<div style="padding: 2px"></div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-md-8">
									<select class="form-control input-sm select2" id="TypeUnitKerja" style="width: 100%;"></select>
									<div style="padding: 2px"></div>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-8">
									<select class="form-control input-sm select2" id="UnitKerja" style="width: 100%;"></select>
									<div style="padding: 2px"></div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-md-8">
									<select class="form-control input-sm select2" id="Jabatan" style="width: 100%;"></select>
									<div style="padding: 2px"></div>
								</div>
							</div>
							<div class="row">
...
<script src="../../Scripts/Pes/UserPes.js" type="text/javascript"></script>
</asp:Content>

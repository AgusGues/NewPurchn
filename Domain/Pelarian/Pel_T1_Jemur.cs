...
namespace Domain
{
    public class Pel_T1_Jemur : GRCBaseDomain
    {
        private int iD = 0;
        private int flag = 0;
        ...
        private string pLine = string.Empty;

        public string PLine { get { return pLine; } set { pLine = value; } }
        public string Oven
        {
            get { return oven; }
            set { oven = value; }
        ...
        public string PartnoAsal
        {
            get { return partnoAsal; }
            set { partnoAsal = value; }
        }

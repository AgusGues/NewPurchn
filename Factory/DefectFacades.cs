...
namespace Factory
{
    public class DefectFacades : BusinessFacade.AbstractTransactionFacade
    {
        ...
        public override int Insert(TransactionManager transManager)
        {
            try
            {
                ...
                sqlListParam.Add(new SqlParameter("@Tkw", objDefect.TKw));
                int intResult = transManager.DoTransaction(sqlListParam, "spInsertDef_Defect2");
        ...
        public override int Update(TransactionManager transManager)
        {
            try
            {
                ...
                sqlListParam.Add(new SqlParameter("@Tkw", objDefect.TKw ));
                int intResult = transManager.DoTransaction(sqlListParam, "spInsertDef_Defect1B");
                strError = transManager.Error;
                return intResult;
            }
            catch (Exception ex)

    ...
    public class DefectLDetailFacade : AbstractTransactionFacade
    {
        ...
        public override int Insert(TransactionManager transManager)
        {
            try
            {
                ...
                int intResult = transManager.DoTransaction(sqlListParam, "spInsertDef_DefectLDetail");
        ...
        public override int Delete(TransactionManager transManager)
        {
            try
            {
                ...
                int intResult = transManager.DoTransaction(sqlListParam, "spDeleteDef_DefectLDetail");
        ...
        public override ArrayList Retrieve()
        {
            ...
            SqlDataReader sqlDataReader = dataAccess.RetrieveDataByString("select * from Def_DefectLDetail where RowStatus>-1");
        ...
        {
            string strSQL = "SELECT A.ID, B.DefName, A.Qty FROM Def_DefectLDetail AS A LEFT OUTER JOIN Def_MasterDefect AS B " +

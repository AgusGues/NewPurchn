...
namespace Factory
{
    public class T1_LR2_StrapingFacade : BusinessFacade.AbstractTransactionFacadeF
    {
        private T1_LR2_Straping objT1_LR2_Straping = new T1_LR2_Straping();
        private ArrayList arrT1_LR2_Straping;
        private List<SqlParameter> sqlListParam;

        public T1_LR2_StrapingFacade(object objDomain)
            : base(objDomain)
        {
            objT1_LR2_Straping = (T1_LR2_Straping)objDomain;
        }
        public T1_LR2_StrapingFacade()
        {
        }
        ...
        public override int Insert(TransactionManager transManager)
        {
            try
            {
                ...
                sqlListParam.Add(new SqlParameter("@L1ID", objT1_LR2_Straping.L1ID));
                sqlListParam.Add(new SqlParameter("@DestID", objT1_LR2_Straping.DestID));
                sqlListParam.Add(new SqlParameter("@ItemID0", objT1_LR2_Straping.ItemID0));
                sqlListParam.Add(new SqlParameter("@lokid0", objT1_LR2_Straping.LokasiID0));
                sqlListParam.Add(new SqlParameter("@ItemID", objT1_LR2_Straping.ItemID));
                sqlListParam.Add(new SqlParameter("@lokid", objT1_LR2_Straping.LokasiID));
                sqlListParam.Add(new SqlParameter("@JemurID", objT1_LR2_Straping.JemurID));
                sqlListParam.Add(new SqlParameter("@RakID", objT1_LR2_Straping.RakID));
                sqlListParam.Add(new SqlParameter("@TglTrans", objT1_LR2_Straping.TglTrans));
                sqlListParam.Add(new SqlParameter("@QtyIn", objT1_LR2_Straping.QtyIn));
                sqlListParam.Add(new SqlParameter("@HPP", objT1_LR2_Straping.HPP));
                sqlListParam.Add(new SqlParameter("@CreatedBy", objT1_LR2_Straping.CreatedBy));
                int intResult = transManager.DoTransaction(sqlListParam, "spInsertT1_LR2_Straping");
        ...
        public override int Update(TransactionManager transManager) //UpdateQtyJemur
        {
            try
            {
                objT1_LR2_Straping = (T1_LR2_Straping)objDomain;
                sqlListParam = new List<SqlParameter>();
                sqlListParam.Add(new SqlParameter("@Flag", objT1_LR2_Straping.Flag));
                sqlListParam.Add(new SqlParameter("@ID", objT1_LR2_Straping.ID));
                sqlListParam.Add(new SqlParameter("@QtyOut", objT1_LR2_Straping.QtyOut));
                sqlListParam.Add(new SqlParameter("@CreatedBy", objT1_LR2_Straping.CreatedBy));
                int intResult = transManager.DoTransaction(sqlListParam, "spUpdateQtyT1_LR2_Straping");
                strError = transManager.Error;
                return intResult;
            }
            catch (Exception ex)
        ...
        public override int Insert1(TransactionManager transManager) //insert jemurlg
        {
            ...
            try
            {
                ...
                sqlListParam.Add(new SqlParameter("@lokid", objT1_LR2_Straping.LokasiID));
                sqlListParam.Add(new SqlParameter("@L1ID", objT1_LR2_Straping.L1ID));
                sqlListParam.Add(new SqlParameter("@JemurID", objT1_LR2_Straping.ID));
                sqlListParam.Add(new SqlParameter("@DestID", objT1_LR2_Straping.DestID));
                sqlListParam.Add(new SqlParameter("@ItemID", objT1_LR2_Straping.ItemID));
                sqlListParam.Add(new SqlParameter("@RakID", objT1_LR2_Straping.RakID));
                sqlListParam.Add(new SqlParameter("@TglTrans", objT1_LR2_Straping.TglTrans));
                ...
                sqlListParam.Add(new SqlParameter("@HPP", objT1_LR2_Straping.HPP));
                sqlListParam.Add(new SqlParameter("@CreatedBy", objT1_LR2_Straping.CreatedBy));
                intResult = transManager.DoTransaction(sqlListParam, "spInsertT1_LR2_Straping");
                strError = transManager.Error;
                return intResult;
            }
            catch (Exception ex)
        ...
        public override int Update1(TransactionManager transManager) //Update QtyJemurlg
        {
            try
            {
                ...
                sqlListParam.Add(new SqlParameter("@QtyOut", objT1_LR2_Straping.QtyOut));
                sqlListParam.Add(new SqlParameter("@CreatedBy", objT1_LR2_Straping.CreatedBy));
                int intResult = transManager.DoTransaction(sqlListParam, "spUpdateT1_LR2_Straping");
                strError = transManager.Error;
                return intResult;
            }
            catch (Exception ex)
        ...
        public ArrayList RetrieveCuring(string tglProduksi, string criteria, string sorting)
        {
            ...
            strError = dataAccess.Error;
            arrT1_LR2_Straping = new ArrayList();

            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_LR2_Straping.Add(GenerateObjectForCuring(sqlDataReader));
                }
            }
            else
                arrT1_LR2_Straping.Add(new T1_LR2_Straping());

            return arrT1_LR2_Straping;
        }
        public ArrayList RetrieveforJmrLg(string tglProduksi, string criteria, string sortby)
        {
            string strSQL = "SELECT top 15 0 AS Flag, A.ID AS DestID, A.ItemID, H.ID, H.ID AS JemurID, H.TglTrans, G.PartNo,G.Lebar * G.Panjang AS luasA, " +
                ...
                "FROM T1_LR2_Straping AS H INNER JOIN BM_Destacking AS A ON H.DestID = A.ID INNER Join FC_Items AS G ON A.ItemID = G.ID " +
            ...
            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_LR2_Straping.Add(GenerateObjectforjemurlg(sqlDataReader));
                }
            }
            else
                arrT1_LR2_Straping.Add(new T1_LR2_Straping());
        ...
        public ArrayList RetrieveforSerah(string tglProduksi, string criteria, string sortby)
        {
            ...
            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_LR2_Straping.Add(GenerateObjectforserah(sqlDataReader));
                }
            }
            else
                arrT1_LR2_Straping.Add(new T1_LR2_Straping());
        ...
        public T1_LR2_Straping RetrieveJemur(string tglProduksi, string nopalet)
        {
            ...
            return new T1_LR2_Straping();
        }
        public T1_LR2_Straping RetrieveByID(string ID)
        {
            string strSQL = "select * from (SELECT  0 AS Flag, A.ID AS DestID, H.ItemID, H.ID, H.JemurID, H.TglTrans, G.PartNo,G.Lebar * G.Panjang AS luasA, " +
                ...
                "CASE WHEN H.RakID > 0 THEN (SELECT Rak FROM FC_Rak WHERE id = H.RakID) END AS rak, A.TglProduksi, ISNULL(A.HPP, 0) AS HPP,  " +
                "H.QtyIn, H.RakID, H.QtyOut, H.HPP AS Expr2,H.QtyIn-H.QtyOut as Sisa    " +
                "FROM T1_LR2_Bevel AS H INNER JOIN BM_Destacking AS A ON H.DestID = A.ID INNER Join FC_Items AS G ON A.ItemID = G.ID  " +
        ...
        public ArrayList RetrieveforPelarian(string tglProduksi, string criteria, string sortby)
        {
            string strSQL = "SELECT top 25 0 AS Flag,A.ID AS DestID, A.ItemID, H.ID, H.ID AS JemurID, H.TglTrans, G.PartNo, G.Lebar * G.Panjang AS luasA, " +
                ...
                "FROM T1_LR2_Strapinglg AS H left JOIN BM_Destacking AS A ON H.DestID = A.ID left JOIN FC_Items AS G ON H.ItemID0 = G.ID " +
        ...
        {
            string strSQL = "update T1_LR2_Straping set qtyout=qtyout+" + qty + " where id=" + id;
            int intError = 0;
            DataAccess dataAccess = new DataAccess(Global.ConnectionString());
            SqlDataReader sqlDataReader = dataAccess.RetrieveDataByString(strSQL);
            strError = dataAccess.Error;
        ...
        public ArrayList RetrieveTransJmrLg(string TglTrans)
        {
            string strSQL = "SELECT TOP (25) A.ID AS DestID, H.ID, H.JemurID, E.FormulaCode, B.[Group] AS gp, G.PartNo, F.NoPAlet, C.Lokasi, A.TglProduksi, " +
                          ...
                          "T1_LR2_StrapingLg AS H ON J.ID = H.LokID0 LEFT OUTER JOIN " +
        ...
        public ArrayList RetrieveByTglProduksi(string tglProduksi)
        {
            string strSQL = "SELECT A.ID as Destid,H.ID as ID,E.FormulaCode, B.[Group] as gp, G.PartNo, F.NoPAlet, C.Lokasi,A.TglProduksi,H.TglTrans, H.RakID,H.QtyIn,isnull(A.HPP,0) as HPP, I.Rak " +
                      ...
                      "T1_LR2_Straping as H ON A.ID = H.DestID INNER JOIN " +
            ...
            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_LR2_Straping.Add(GenerateObject(sqlDataReader));
                }
            }
            else
                arrT1_LR2_Straping.Add(new T1_LR2_Straping());
        ...
        {
            int jumlah = 0;
            string strSQL = "select COUNT(*) as id from T1_LR2_Straping where CONVERT(varchar,TglTrans,112) >='" + tgl1 + "' and CONVERT(varchar,TglTrans,112) <='" + tgl2 +
        ...
        {
            int jumlah = 0;
            string strSQL = "select * from T1_LR2_Straping where destid=" + destid;
            DataAccess dataAccess = new DataAccess(Global.ConnectionString());
            SqlDataReader sqlDataReader = dataAccess.RetrieveDataByString(strSQL);
            strError = dataAccess.Error;
        ...
        public T1_LR2_Straping GenerateObject(SqlDataReader sqlDataReader)
        {
            objT1_LR2_Straping = new T1_LR2_Straping();
            objT1_LR2_Straping.ID = Convert.ToInt32(sqlDataReader["ID"]);
            objT1_LR2_Straping.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
            objT1_LR2_Straping.PlantGroup = (sqlDataReader["gp"]).ToString();
            objT1_LR2_Straping.Formula = (sqlDataReader["FormulaCode"]).ToString();
            objT1_LR2_Straping.TglProduksi = Convert.ToDateTime(sqlDataReader["TglProduksi"]);
            objT1_LR2_Straping.TglTrans = Convert.ToDateTime(sqlDataReader["TglTrans"]);
            objT1_LR2_Straping.QtyIn = Convert.ToInt32(sqlDataReader["Qtyin"]);
            objT1_LR2_Straping.RakID = Convert.ToInt32(sqlDataReader["RakID"]);
            objT1_LR2_Straping.Rak = (sqlDataReader["Rak"]).ToString();
            objT1_LR2_Straping.HPP = Convert.ToDecimal(sqlDataReader["HPP"]);
            objT1_LR2_Straping.Partno = (sqlDataReader["PartNo"]).ToString();
            objT1_LR2_Straping.Lokasi = (sqlDataReader["Lokasi"]).ToString();
            objT1_LR2_Straping.Palet = (sqlDataReader["NoPAlet"]).ToString();
            return objT1_LR2_Straping;
        }
        public T1_LR2_Straping GenerateObjectForCuring(SqlDataReader sqlDataReader)
        {
            objT1_LR2_Straping = new T1_LR2_Straping();
            objT1_LR2_Straping.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
            objT1_LR2_Straping.PlantGroup = (sqlDataReader["Group"]).ToString();
            objT1_LR2_Straping.Formula = (sqlDataReader["FormulaCode"]).ToString();
            objT1_LR2_Straping.Palet = (sqlDataReader["NoPAlet"]).ToString();
            objT1_LR2_Straping.TglProduksi = Convert.ToDateTime(sqlDataReader["TglProduksi"]);
            objT1_LR2_Straping.Lokasi = (sqlDataReader["Lokasi"]).ToString();
            objT1_LR2_Straping.QtyIn = Convert.ToInt32(sqlDataReader["Qty"]);
            objT1_LR2_Straping.HPP = Convert.ToDecimal(sqlDataReader["HPP"]);
            objT1_LR2_Straping.Partno = (sqlDataReader["PartNo"]).ToString();
            return objT1_LR2_Straping;
        }
        public T1_LR2_Straping GenerateObjectforjemurlg(SqlDataReader sqlDataReader)
        {
            try
            {
                objT1_LR2_Straping = new T1_LR2_Straping();
                objT1_LR2_Straping.ID = Convert.ToInt32(sqlDataReader["ID"]);
                objT1_LR2_Straping.JemurID = Convert.ToInt32(sqlDataReader["JemurID"]);
                objT1_LR2_Straping.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
                objT1_LR2_Straping.PlantGroup = (sqlDataReader["gp"]).ToString();
                objT1_LR2_Straping.Formula = (sqlDataReader["FormulaCode"]).ToString();
                objT1_LR2_Straping.TglProduksi = Convert.ToDateTime(sqlDataReader["TglProduksi"]);
                objT1_LR2_Straping.TglTrans = Convert.ToDateTime(sqlDataReader["TglTrans"]);
                objT1_LR2_Straping.QtyIn = Convert.ToInt32(sqlDataReader["Qtyin"]);
                objT1_LR2_Straping.QtyOut = Convert.ToInt32(sqlDataReader["QtyOut"]);
                objT1_LR2_Straping.HPP = Convert.ToDecimal(sqlDataReader["HPP"]);
                objT1_LR2_Straping.RakID = Convert.ToInt32(sqlDataReader["RakID"]);
                objT1_LR2_Straping.Rak = (sqlDataReader["Rak"]).ToString();
                objT1_LR2_Straping.Partno = (sqlDataReader["PartNo"]).ToString();
                objT1_LR2_Straping.Lokasi = (sqlDataReader["Lokasi"]).ToString();
                objT1_LR2_Straping.LokasiTF = (sqlDataReader["LokasiTF"]).ToString();
                objT1_LR2_Straping.Palet = (sqlDataReader["NoPAlet"]).ToString();
            }
            catch
            {
        ...
        public T1_LR2_Straping GenerateObjectforserah(SqlDataReader sqlDataReader)
        {
            try
            {
                objT1_LR2_Straping = new T1_LR2_Straping();
                objT1_LR2_Straping.ID = Convert.ToInt32(sqlDataReader["ID"]);
                objT1_LR2_Straping.Flag = Convert.ToInt32(sqlDataReader["Flag"]);
                objT1_LR2_Straping.JemurID = Convert.ToInt32(sqlDataReader["JemurID"]);
                objT1_LR2_Straping.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
                objT1_LR2_Straping.PlantGroup = (sqlDataReader["gp"]).ToString();
                objT1_LR2_Straping.Formula = (sqlDataReader["FormulaCode"]).ToString();
                ...
                objT1_LR2_Straping.Lokasi = (sqlDataReader["Lokasi"]).ToString();
                objT1_LR2_Straping.Palet = (sqlDataReader["NoPAlet"]).ToString();
                objT1_LR2_Straping.ItemID = Convert.ToInt32(sqlDataReader["itemid"]);
                objT1_LR2_Straping.LuasA = Convert.ToInt32(sqlDataReader["LuasA"]);
                objT1_LR2_Straping.Sisa = Convert.ToInt32(sqlDataReader["Sisa"]);
                objT1_LR2_Straping.Fail = Convert.ToInt32(sqlDataReader["fail"]);
        ...
        public ArrayList RetrieveCountSheet(string lokasi, string tanggal1, string tanggal2, string nopalet)
        {
            ...
            if (lokasi == "curing")
                strSQL = "select top 100 null as TglTranslg,*,(select SUM(qtyin-qtyout) from T1_LR2_Straping where DestID=A.destid)as sisajemur from (select destid,  itemid0 as itemid,partno,Lokasiid,lokasi,tglproduksi,TglTrans,palet,Rak,sum(Qty) as saldo from vw_kartustockWIPDet  " +
                ...
                strSQL = "select  top 100  null as TglTranslg,*,(select SUM(qtyin-qtyout) from T1_LR2_Straping where DestID=A.destid)as sisajemur from " +
            ...
            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_LR2_Straping.Add(GenerateObjectForCountsheet(sqlDataReader));
                }
            }
            else
                arrT1_LR2_Straping.Add(new T1_LR2_Straping());
        ...
        public T1_LR2_Straping GenerateObjectForCountsheet(SqlDataReader sqlDataReader)
        {
            try
            {
                objT1_LR2_Straping = new T1_LR2_Straping();
                ...
                objT1_LR2_Straping.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
                //objT1_LR2_Straping.PlantGroup = (sqlDataReader["gp"]).ToString();
                objT1_LR2_Straping.LokasiID = Convert.ToInt32(sqlDataReader["LokasiID"]);
                objT1_LR2_Straping.TglProduksi = Convert.ToDateTime(sqlDataReader["TglProduksi"]);
                objT1_LR2_Straping.Partno = (sqlDataReader["PartNo"]).ToString();
                objT1_LR2_Straping.Lokasi = (sqlDataReader["Lokasi"]).ToString();
                objT1_LR2_Straping.Palet = (sqlDataReader["PAlet"]).ToString();
                objT1_LR2_Straping.QtyIn = Convert.ToInt32(sqlDataReader["saldo"]);
                objT1_LR2_Straping.ItemID = Convert.ToInt32(sqlDataReader["itemid"]);
                objT1_LR2_Straping.Rak = (sqlDataReader["Rak"]).ToString();
                objT1_LR2_Straping.TglTrans = Convert.ToDateTime(sqlDataReader["TglTrans"]);
                objT1_LR2_Straping.QtyOut = Convert.ToInt32(sqlDataReader["sisajemur"]);
                //objT1_LR2_Straping.HPP = Convert.ToDecimal(sqlDataReader["HPP"]);
                //objT1_LR2_Straping.RakID = Convert.ToInt32(sqlDataReader["RakID"]);

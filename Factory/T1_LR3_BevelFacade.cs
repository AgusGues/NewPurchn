...
namespace Factory
{
    public class T1_LR3_BevelFacade : BusinessFacade.AbstractTransactionFacadeF
    {
        private T1_LR3_Bevel objT1_LR3_Bevel = new T1_LR3_Bevel();
        private ArrayList arrT1_LR3_Bevel;
        private List<SqlParameter> sqlListParam;

        public T1_LR3_BevelFacade(object objDomain)
            : base(objDomain)
        {
            objT1_LR3_Bevel = (T1_LR3_Bevel)objDomain;
        }
        public T1_LR3_BevelFacade()
        {
        }
        ...
        public override int Insert(TransactionManager transManager)
        {
            try
            {
                ...
                sqlListParam.Add(new SqlParameter("@L1ID", objT1_LR3_Bevel.L1ID));
                sqlListParam.Add(new SqlParameter("@DestID", objT1_LR3_Bevel.DestID));
                sqlListParam.Add(new SqlParameter("@ItemID0", objT1_LR3_Bevel.ItemID0));
                sqlListParam.Add(new SqlParameter("@lokid0", objT1_LR3_Bevel.LokasiID0));
                sqlListParam.Add(new SqlParameter("@ItemID", objT1_LR3_Bevel.ItemID));
                sqlListParam.Add(new SqlParameter("@lokid", objT1_LR3_Bevel.LokasiID));
                sqlListParam.Add(new SqlParameter("@JemurID", objT1_LR3_Bevel.JemurID));
                sqlListParam.Add(new SqlParameter("@RakID", objT1_LR3_Bevel.RakID));
                sqlListParam.Add(new SqlParameter("@TglTrans", objT1_LR3_Bevel.TglTrans));
                sqlListParam.Add(new SqlParameter("@QtyIn", objT1_LR3_Bevel.QtyIn));
                sqlListParam.Add(new SqlParameter("@HPP", objT1_LR3_Bevel.HPP));
                sqlListParam.Add(new SqlParameter("@CreatedBy", objT1_LR3_Bevel.CreatedBy));
                int intResult = transManager.DoTransaction(sqlListParam, "spInsertT1_LR3_Bevel");
        ...
        public override int Update(TransactionManager transManager) //UpdateQtyJemur
        {
            try
            {
                objT1_LR3_Bevel = (T1_LR3_Bevel)objDomain;
                sqlListParam = new List<SqlParameter>();
                sqlListParam.Add(new SqlParameter("@Flag", objT1_LR3_Bevel.Flag));
                sqlListParam.Add(new SqlParameter("@ID", objT1_LR3_Bevel.ID));
                sqlListParam.Add(new SqlParameter("@QtyOut", objT1_LR3_Bevel.QtyOut));
                sqlListParam.Add(new SqlParameter("@CreatedBy", objT1_LR3_Bevel.CreatedBy));
                int intResult = transManager.DoTransaction(sqlListParam, "spUpdateQtyT1_LR3_Bevel");
                strError = transManager.Error;
                return intResult;
            }
            catch (Exception ex)
        ...
        public override int Insert1(TransactionManager transManager) //insert jemurlg
        {
            ...
            try
            {
                ...
                sqlListParam.Add(new SqlParameter("@lokid", objT1_LR3_Bevel.LokasiID));
                sqlListParam.Add(new SqlParameter("@L1ID", objT1_LR3_Bevel.L1ID));
                sqlListParam.Add(new SqlParameter("@JemurID", objT1_LR3_Bevel.ID));
                sqlListParam.Add(new SqlParameter("@DestID", objT1_LR3_Bevel.DestID));
                sqlListParam.Add(new SqlParameter("@ItemID", objT1_LR3_Bevel.ItemID));
                sqlListParam.Add(new SqlParameter("@RakID", objT1_LR3_Bevel.RakID));
                sqlListParam.Add(new SqlParameter("@TglTrans", objT1_LR3_Bevel.TglTrans));
                ...
                sqlListParam.Add(new SqlParameter("@HPP", objT1_LR3_Bevel.HPP));
                sqlListParam.Add(new SqlParameter("@CreatedBy", objT1_LR3_Bevel.CreatedBy));
                intResult = transManager.DoTransaction(sqlListParam, "spInsertT1_LR3_Bevel");
                strError = transManager.Error;
                return intResult;
            }
            catch (Exception ex)
        ...
        public override int Update1(TransactionManager transManager) //Update QtyJemurlg
        {
            try
            {
                ...
                sqlListParam.Add(new SqlParameter("@QtyOut", objT1_LR3_Bevel.QtyOut));
                sqlListParam.Add(new SqlParameter("@CreatedBy", objT1_LR3_Bevel.CreatedBy));
                int intResult = transManager.DoTransaction(sqlListParam, "spUpdateT1_LR3_Bevel");
                strError = transManager.Error;
                return intResult;
            }
            catch (Exception ex)
        ...
        public ArrayList RetrieveCuring(string tglProduksi, string criteria, string sorting)
        {
            ...
            strError = dataAccess.Error;
            arrT1_LR3_Bevel = new ArrayList();

            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_LR3_Bevel.Add(GenerateObjectForCuring(sqlDataReader));
                }
            }
            else
                arrT1_LR3_Bevel.Add(new T1_LR3_Bevel());

            return arrT1_LR3_Bevel;
        }
        public ArrayList RetrieveforJmrLg(string tglProduksi, string criteria, string sortby)
        {
            ...
            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_LR3_Bevel.Add(GenerateObjectforjemurlg(sqlDataReader));
                }
            }
            else
                arrT1_LR3_Bevel.Add(new T1_LR3_Bevel());
        ...
        public ArrayList RetrieveforSerah(string tglProduksi, string criteria, string sortby)
        {
            ...
            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_LR3_Bevel.Add(GenerateObjectforserah(sqlDataReader));
                }
            }
            else
                arrT1_LR3_Bevel.Add(new T1_LR3_Bevel());
        ...
        public T1_LR3_Bevel RetrieveJemur(string tglProduksi, string nopalet)
        {
            ...
            return new T1_LR3_Bevel();
        }
        public T1_LR3_Bevel RetrieveByID(string ID)
        {
        ...
        public ArrayList RetrieveforPelarian(string tglProduksi, string criteria, string sortby)
        {
            string strSQL = "SELECT top 25 0 AS Flag,A.ID AS DestID, A.ItemID, H.ID, H.ID AS JemurID, H.TglTrans, G.PartNo, G.Lebar * G.Panjang AS luasA, " +
                ...
                "FROM T1_LR3_Bevellg AS H left JOIN BM_Destacking AS A ON H.DestID = A.ID left JOIN FC_Items AS G ON H.ItemID0 = G.ID " +
        ...
        {
            string strSQL = "update T1_LR3_Bevel set qtyout=qtyout+" + qty + " where id=" + id;
            int intError = 0;
            DataAccess dataAccess = new DataAccess(Global.ConnectionString());
            SqlDataReader sqlDataReader = dataAccess.RetrieveDataByString(strSQL);
            strError = dataAccess.Error;
        ...
        public ArrayList RetrieveTransJmrLg(string TglTrans)
        {
            string strSQL = "SELECT TOP (25) A.ID AS DestID, H.ID, H.JemurID, E.FormulaCode, B.[Group] AS gp, G.PartNo, F.NoPAlet, C.Lokasi, A.TglProduksi, " +
                          ...
                          "T1_LR3_BevelLg AS H ON J.ID = H.LokID0 LEFT OUTER JOIN " +
        ...
        public ArrayList RetrieveByTglProduksi(string tglProduksi)
        {
            string strSQL = "SELECT A.ID as Destid,H.ID as ID,E.FormulaCode, B.[Group] as gp, G.PartNo, F.NoPAlet, C.Lokasi,A.TglProduksi,H.TglTrans, H.RakID,H.QtyIn,isnull(A.HPP,0) as HPP, I.Rak " +
                      ...
                      "T1_LR3_Bevel as H ON A.ID = H.DestID INNER JOIN " +
            ...
            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_LR3_Bevel.Add(GenerateObject(sqlDataReader));
                }
            }
            else
                arrT1_LR3_Bevel.Add(new T1_LR3_Bevel());
        ...
        {
            int jumlah = 0;
            string strSQL = "select COUNT(*) as id from T1_LR3_Bevel where CONVERT(varchar,TglTrans,112) >='" + tgl1 + "' and CONVERT(varchar,TglTrans,112) <='" + tgl2 +
        ...
        {
            int jumlah = 0;
            string strSQL = "select * from T1_LR3_Bevel where destid=" + destid;
            DataAccess dataAccess = new DataAccess(Global.ConnectionString());
            SqlDataReader sqlDataReader = dataAccess.RetrieveDataByString(strSQL);
            strError = dataAccess.Error;
        ...
        public T1_LR3_Bevel GenerateObject(SqlDataReader sqlDataReader)
        {
            objT1_LR3_Bevel = new T1_LR3_Bevel();
            objT1_LR3_Bevel.ID = Convert.ToInt32(sqlDataReader["ID"]);
            objT1_LR3_Bevel.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
            objT1_LR3_Bevel.PlantGroup = (sqlDataReader["gp"]).ToString();
            objT1_LR3_Bevel.Formula = (sqlDataReader["FormulaCode"]).ToString();
            objT1_LR3_Bevel.TglProduksi = Convert.ToDateTime(sqlDataReader["TglProduksi"]);
            objT1_LR3_Bevel.TglTrans = Convert.ToDateTime(sqlDataReader["TglTrans"]);
            objT1_LR3_Bevel.QtyIn = Convert.ToInt32(sqlDataReader["Qtyin"]);
            objT1_LR3_Bevel.RakID = Convert.ToInt32(sqlDataReader["RakID"]);
            objT1_LR3_Bevel.Rak = (sqlDataReader["Rak"]).ToString();
            objT1_LR3_Bevel.HPP = Convert.ToDecimal(sqlDataReader["HPP"]);
            objT1_LR3_Bevel.Partno = (sqlDataReader["PartNo"]).ToString();
            objT1_LR3_Bevel.Lokasi = (sqlDataReader["Lokasi"]).ToString();
            objT1_LR3_Bevel.Palet = (sqlDataReader["NoPAlet"]).ToString();
            return objT1_LR3_Bevel;
        }
        public T1_LR3_Bevel GenerateObjectForCuring(SqlDataReader sqlDataReader)
        {
            objT1_LR3_Bevel = new T1_LR3_Bevel();
            objT1_LR3_Bevel.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
            objT1_LR3_Bevel.PlantGroup = (sqlDataReader["Group"]).ToString();
            objT1_LR3_Bevel.Formula = (sqlDataReader["FormulaCode"]).ToString();
            objT1_LR3_Bevel.Palet = (sqlDataReader["NoPAlet"]).ToString();
            objT1_LR3_Bevel.TglProduksi = Convert.ToDateTime(sqlDataReader["TglProduksi"]);
            objT1_LR3_Bevel.Lokasi = (sqlDataReader["Lokasi"]).ToString();
            objT1_LR3_Bevel.QtyIn = Convert.ToInt32(sqlDataReader["Qty"]);
            objT1_LR3_Bevel.HPP = Convert.ToDecimal(sqlDataReader["HPP"]);
            objT1_LR3_Bevel.Partno = (sqlDataReader["PartNo"]).ToString();
            return objT1_LR3_Bevel;
        }
        public T1_LR3_Bevel GenerateObjectforjemurlg(SqlDataReader sqlDataReader)
        {
            try
            {
                objT1_LR3_Bevel = new T1_LR3_Bevel();
                objT1_LR3_Bevel.ID = Convert.ToInt32(sqlDataReader["ID"]);
                objT1_LR3_Bevel.JemurID = Convert.ToInt32(sqlDataReader["JemurID"]);
                objT1_LR3_Bevel.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
                objT1_LR3_Bevel.PlantGroup = (sqlDataReader["gp"]).ToString();
                objT1_LR3_Bevel.Formula = (sqlDataReader["FormulaCode"]).ToString();
                objT1_LR3_Bevel.TglProduksi = Convert.ToDateTime(sqlDataReader["TglProduksi"]);
                objT1_LR3_Bevel.TglTrans = Convert.ToDateTime(sqlDataReader["TglTrans"]);
                objT1_LR3_Bevel.QtyIn = Convert.ToInt32(sqlDataReader["Qtyin"]);
                objT1_LR3_Bevel.QtyOut = Convert.ToInt32(sqlDataReader["QtyOut"]);
                objT1_LR3_Bevel.HPP = Convert.ToDecimal(sqlDataReader["HPP"]);
                objT1_LR3_Bevel.RakID = Convert.ToInt32(sqlDataReader["RakID"]);
                objT1_LR3_Bevel.Rak = (sqlDataReader["Rak"]).ToString();
                objT1_LR3_Bevel.Partno = (sqlDataReader["PartNo"]).ToString();
                objT1_LR3_Bevel.Lokasi = (sqlDataReader["Lokasi"]).ToString();
                objT1_LR3_Bevel.LokasiTF = (sqlDataReader["LokasiTF"]).ToString();
                objT1_LR3_Bevel.Palet = (sqlDataReader["NoPAlet"]).ToString();
            }
            catch
            {
        ...
        public T1_LR3_Bevel GenerateObjectforserah(SqlDataReader sqlDataReader)
        {
            try
            {
                objT1_LR3_Bevel = new T1_LR3_Bevel();
                objT1_LR3_Bevel.ID = Convert.ToInt32(sqlDataReader["ID"]);
                objT1_LR3_Bevel.Flag = Convert.ToInt32(sqlDataReader["Flag"]);
                objT1_LR3_Bevel.JemurID = Convert.ToInt32(sqlDataReader["JemurID"]);
                objT1_LR3_Bevel.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
                objT1_LR3_Bevel.PlantGroup = (sqlDataReader["gp"]).ToString();
                objT1_LR3_Bevel.Formula = (sqlDataReader["FormulaCode"]).ToString();
                ...
                objT1_LR3_Bevel.Lokasi = (sqlDataReader["Lokasi"]).ToString();
                objT1_LR3_Bevel.Palet = (sqlDataReader["NoPAlet"]).ToString();
                objT1_LR3_Bevel.ItemID = Convert.ToInt32(sqlDataReader["itemid"]);
                objT1_LR3_Bevel.LuasA = Convert.ToInt32(sqlDataReader["LuasA"]);
                objT1_LR3_Bevel.Sisa = Convert.ToInt32(sqlDataReader["Sisa"]);
                objT1_LR3_Bevel.Fail = Convert.ToInt32(sqlDataReader["fail"]);
        ...
        public ArrayList RetrieveCountSheet(string lokasi, string tanggal1, string tanggal2, string nopalet)
        {
            ...
            if (lokasi == "curing")
                strSQL = "select top 100 null as TglTranslg,*,(select SUM(qtyin-qtyout) from T1_LR3_Bevel where DestID=A.destid)as sisajemur from (select destid,  itemid0 as itemid,partno,Lokasiid,lokasi,tglproduksi,TglTrans,palet,Rak,sum(Qty) as saldo from vw_kartustockWIPDet  " +
                ...
                strSQL = "select  top 100  null as TglTranslg,*,(select SUM(qtyin-qtyout) from T1_LR3_Bevel where DestID=A.destid)as sisajemur from " +
            ...
            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_LR3_Bevel.Add(GenerateObjectForCountsheet(sqlDataReader));
                }
            }
            else
                arrT1_LR3_Bevel.Add(new T1_LR3_Bevel());
        ...
        public T1_LR3_Bevel GenerateObjectForCountsheet(SqlDataReader sqlDataReader)
        {
            try
            {
                objT1_LR3_Bevel = new T1_LR3_Bevel();
                ...
                objT1_LR3_Bevel.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
                //objT1_LR3_Bevel.PlantGroup = (sqlDataReader["gp"]).ToString();
                objT1_LR3_Bevel.LokasiID = Convert.ToInt32(sqlDataReader["LokasiID"]);
                objT1_LR3_Bevel.TglProduksi = Convert.ToDateTime(sqlDataReader["TglProduksi"]);
                objT1_LR3_Bevel.Partno = (sqlDataReader["PartNo"]).ToString();
                objT1_LR3_Bevel.Lokasi = (sqlDataReader["Lokasi"]).ToString();
                objT1_LR3_Bevel.Palet = (sqlDataReader["PAlet"]).ToString();
                objT1_LR3_Bevel.QtyIn = Convert.ToInt32(sqlDataReader["saldo"]);
                objT1_LR3_Bevel.ItemID = Convert.ToInt32(sqlDataReader["itemid"]);
                objT1_LR3_Bevel.Rak = (sqlDataReader["Rak"]).ToString();
                objT1_LR3_Bevel.TglTrans = Convert.ToDateTime(sqlDataReader["TglTrans"]);
                objT1_LR3_Bevel.QtyOut = Convert.ToInt32(sqlDataReader["sisajemur"]);
                //objT1_LR3_Bevel.HPP = Convert.ToDecimal(sqlDataReader["HPP"]);
                //objT1_LR3_Bevel.RakID = Convert.ToInt32(sqlDataReader["RakID"]);

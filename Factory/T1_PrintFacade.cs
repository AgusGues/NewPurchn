...
namespace Factory
{
    public class T1_PrintFacade : BusinessFacade.AbstractTransactionFacadeF
    {
        private T1_Print objT1_Print = new T1_Print();
        private ArrayList arrT1_Print;
        private List<SqlParameter> sqlListParam;

        public T1_PrintFacade(object objDomain)
            : base(objDomain)
        {
            objT1_Print = (T1_Print)objDomain;
        }
        public T1_PrintFacade()
        {
        }
        ...
        public override int Insert(TransactionManager transManager)
        {
            try
            {
                ...
                sqlListParam.Add(new SqlParameter("@L1ID", objT1_Print.L1ID));
                sqlListParam.Add(new SqlParameter("@DestID", objT1_Print.DestID ));
                sqlListParam.Add(new SqlParameter("@ItemID0", objT1_Print.ItemID0));
                sqlListParam.Add(new SqlParameter("@lokid0", objT1_Print.LokasiID0));
                sqlListParam.Add(new SqlParameter("@ItemID", objT1_Print.ItemID));
                sqlListParam.Add(new SqlParameter("@lokid", objT1_Print.LokasiID));
                sqlListParam.Add(new SqlParameter("@JemurID", objT1_Print.JemurID));
                sqlListParam.Add(new SqlParameter("@RakID", objT1_Print.RakID  ));
                sqlListParam.Add(new SqlParameter("@TglTrans", objT1_Print.TglTrans ));
                sqlListParam.Add(new SqlParameter("@QtyIn", objT1_Print.QtyIn ));
                sqlListParam.Add(new SqlParameter("@HPP", objT1_Print.HPP ));
                sqlListParam.Add(new SqlParameter("@CreatedBy", objT1_Print.CreatedBy));
                int intResult = transManager.DoTransaction(sqlListParam, "spInsertT1_Print");
        ...
        public override int Update(TransactionManager transManager) //UpdateQtyJemur
        {
            try
            {
                objT1_Print = (T1_Print)objDomain;
                sqlListParam = new List<SqlParameter>();
                sqlListParam.Add(new SqlParameter("@Flag", objT1_Print.Flag));
                sqlListParam.Add(new SqlParameter("@ID", objT1_Print.ID));
                sqlListParam.Add(new SqlParameter("@QtyOut", objT1_Print.QtyOut));
                sqlListParam.Add(new SqlParameter("@CreatedBy", objT1_Print.CreatedBy));
                int intResult = transManager.DoTransaction(sqlListParam, "spUpdateQtyT1_Print");
                strError = transManager.Error;
                return intResult;
            }
            catch (Exception ex)
        ...
        public override int Insert1(TransactionManager transManager) //insert jemurlg
        {
            ...
            try
            {
                ...
                sqlListParam.Add(new SqlParameter("@lokid", objT1_Print.LokasiID ));
                sqlListParam.Add(new SqlParameter("@L1ID", objT1_Print.L1ID));
                sqlListParam.Add(new SqlParameter("@JemurID", objT1_Print.ID));
                sqlListParam.Add(new SqlParameter("@DestID", objT1_Print.DestID));
                sqlListParam.Add(new SqlParameter("@ItemID", objT1_Print.ItemID));
                sqlListParam.Add(new SqlParameter("@RakID", objT1_Print.RakID));
                sqlListParam.Add(new SqlParameter("@TglTrans", objT1_Print.TglTrans));
                ...
                sqlListParam.Add(new SqlParameter("@HPP", objT1_Print.HPP));
                sqlListParam.Add(new SqlParameter("@CreatedBy", objT1_Print.CreatedBy));
                intResult = transManager.DoTransaction(sqlListParam, "spInsertT1_Print");
                strError = transManager.Error;
                return intResult;
            }
            catch (Exception ex)
        ...
        public override int Update1(TransactionManager transManager) //Update QtyJemurlg
        {
            try
            {
                ...
                sqlListParam.Add(new SqlParameter("@QtyOut", objT1_Print.QtyOut ));
                sqlListParam.Add(new SqlParameter("@CreatedBy", objT1_Print.CreatedBy));
                int intResult = transManager.DoTransaction(sqlListParam, "spUpdateT1_Print");
                strError = transManager.Error;
                return intResult;
            }
            catch (Exception ex)
        ...
        public ArrayList RetrieveCuring(string tglProduksi, string criteria,string sorting )
        {
            ...
            strError = dataAccess.Error;
            arrT1_Print = new ArrayList();

            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_Print.Add(GenerateObjectForCuring(sqlDataReader));
                }
            }
            else
                arrT1_Print.Add(new T1_Print());
        ...
        public ArrayList RetrieveforJmrLg(string tglProduksi, string criteria,string sortby)
        {
            string strSQL = "SELECT top 15 0 AS Flag, A.ID AS DestID, A.ItemID, H.ID, H.ID AS JemurID, H.TglTrans, G.PartNo,G.Lebar * G.Panjang AS luasA, " +
                ...
                "FROM T1_Print AS H INNER JOIN BM_Destacking AS A ON H.DestID = A.ID INNER Join FC_Items AS G ON A.ItemID = G.ID " +
            ...
            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_Print.Add(GenerateObjectforjemurlg(sqlDataReader));
                }
            }
            else
                arrT1_Print.Add(new T1_Print());
        ...
        public ArrayList RetrieveforSerah(string tglProduksi, string criteria,string sortby)
        {
            ...
            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_Print.Add(GenerateObjectforserah(sqlDataReader));
                }
            }
            else
                arrT1_Print.Add(new T1_Print());
        ...
        public T1_Print  RetrieveJemur(string tglProduksi, string nopalet)
        {
        ...
        public T1_Print RetrieveByID(string ID, string asal)
        {
            string strSQL = string.Empty;
            if (asal == "T1_RuningSaw")
            {
                 strSQL = "select * from (SELECT  0 AS Flag, A.ID AS DestID, H.ItemID, H.ID, H.JemurID, H.TglTrans, G.PartNo,G.Lebar * G.Panjang AS luasA, " +
                    "CASE WHEN A.FormulaID > 0 THEN (SELECT formulacode FROM BM_Formula WHERE id = A.FormulaID) END AS FormulaCode,   " +
                    "CASE WHEN A.PlantGroupID > 0 THEN (SELECT [GROUp] FROM BM_PlantGroup WHERE id = A.plantgroupID) END AS gp,   " +
                    "CASE WHEN A.PaletID > 0 THEN (SELECT NoPAlet FROM BM_Palet WHERE id = A.PaletID) END AS NoPAlet,   " +
                    "CASE WHEN A.LokasiID > 0 THEN (SELECT Lokasi FROM FC_Lokasi WHERE id = A.LokasiID) END AS lokasi,   " +
            ...
            {
                 strSQL = "select * from (SELECT  0 AS Flag, A.ID AS DestID, H.ItemID, H.ID, H.ID AS JemurID, H.TglTrans, G.PartNo,G.Lebar * G.Panjang AS luasA, " +
                   "CASE WHEN A.FormulaID > 0 THEN (SELECT formulacode FROM BM_Formula WHERE id = A.FormulaID) END AS FormulaCode,   " +
                   "CASE WHEN A.PlantGroupID > 0 THEN (SELECT [GROUp] FROM BM_PlantGroup WHERE id = A.plantgroupID) END AS gp,   " +
                   "CASE WHEN A.PaletID > 0 THEN (SELECT NoPAlet FROM BM_Palet WHERE id = A.PaletID) END AS NoPAlet,   " +
                   "CASE WHEN A.LokasiID > 0 THEN (SELECT Lokasi FROM FC_Lokasi WHERE id = A.LokasiID) END AS lokasi,   " +
        ...
        public ArrayList RetrieveforPelarian(string tglProduksi, string criteria, string sortby)
        {
            string strSQL = "SELECT top 25 0 AS Flag,A.ID AS DestID, A.ItemID, H.ID, H.ID AS JemurID, H.TglTrans, G.PartNo, G.Lebar * G.Panjang AS luasA, " +
                ...
                "FROM T1_Printlg AS H left JOIN BM_Destacking AS A ON H.DestID = A.ID left JOIN FC_Items AS G ON H.ItemID0 = G.ID " +
        ...
        {
            string strSQL = "update T1_Print set qtyout=qtyout+" + qty + " where id=" + id;
            int intError = 0;
            DataAccess dataAccess = new DataAccess(Global.ConnectionString());
            SqlDataReader sqlDataReader = dataAccess.RetrieveDataByString(strSQL);
            strError = dataAccess.Error;
        ...
        public ArrayList RetrieveTransJmrLg(string TglTrans)
        {
            string strSQL = "SELECT TOP (25) A.ID AS DestID, H.ID, H.JemurID, E.FormulaCode, B.[Group] AS gp, G.PartNo, F.NoPAlet, C.Lokasi, A.TglProduksi, "+
                          ...
                          "T1_PrintLg AS H ON J.ID = H.LokID0 LEFT OUTER JOIN " +
        ...
        public ArrayList RetrieveByTglProduksi(string tglProduksi)
        {
            string strSQL = "SELECT A.ID as Destid,H.ID as ID,E.FormulaCode, B.[Group] as gp, G.PartNo, F.NoPAlet, C.Lokasi,A.TglProduksi,H.TglTrans, H.RakID,H.QtyIn,isnull(A.HPP,0) as HPP, I.Rak " +
                      ...
                      "T1_Print as H ON A.ID = H.DestID INNER JOIN " +
            ...
            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_Print.Add(GenerateObject(sqlDataReader));
                }
            }
            else
                arrT1_Print.Add(new T1_Print());
        ...
        {
            int jumlah = 0;
            string strSQL = "select COUNT(*) as id from T1_Print where CONVERT(varchar,TglTrans,112) >='" + tgl1 + "' and CONVERT(varchar,TglTrans,112) <='" + tgl2  +
        ...
        {
            int jumlah = 0;
            string strSQL = "select * from T1_Print where destid=" + destid ;
            DataAccess dataAccess = new DataAccess(Global.ConnectionString());
            SqlDataReader sqlDataReader = dataAccess.RetrieveDataByString(strSQL);
            strError = dataAccess.Error;
        ...
        public T1_Print GenerateObject(SqlDataReader sqlDataReader)
        {
            objT1_Print = new T1_Print();
            objT1_Print.ID = Convert.ToInt32(sqlDataReader["ID"]);
            objT1_Print.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
            objT1_Print.PlantGroup = (sqlDataReader["gp"]).ToString();
            objT1_Print.Formula = (sqlDataReader["FormulaCode"]).ToString();
            objT1_Print.TglProduksi = Convert.ToDateTime(sqlDataReader["TglProduksi"]);
            objT1_Print.TglTrans  = Convert.ToDateTime(sqlDataReader["TglTrans"]);
            objT1_Print.QtyIn = Convert.ToInt32(sqlDataReader["Qtyin"]);
            objT1_Print.RakID = Convert.ToInt32(sqlDataReader["RakID"]);
            objT1_Print.Rak = (sqlDataReader["Rak"]).ToString();
            objT1_Print.HPP = Convert.ToDecimal(sqlDataReader["HPP"]);
            objT1_Print.Partno = (sqlDataReader["PartNo"]).ToString();
            objT1_Print.Lokasi = (sqlDataReader["Lokasi"]).ToString();
            objT1_Print.Palet = (sqlDataReader["NoPAlet"]).ToString();
            return objT1_Print;
        }
        public T1_Print GenerateObjectForCuring(SqlDataReader sqlDataReader)
        {
            objT1_Print = new T1_Print();
            objT1_Print.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
            objT1_Print.PlantGroup = (sqlDataReader["Group"]).ToString();
            objT1_Print.Formula = (sqlDataReader["FormulaCode"]).ToString();
            objT1_Print.Palet = (sqlDataReader["NoPAlet"]).ToString();
            objT1_Print.TglProduksi = Convert.ToDateTime(sqlDataReader["TglProduksi"]);
            objT1_Print.Lokasi = (sqlDataReader["Lokasi"]).ToString();
            objT1_Print.QtyIn = Convert.ToInt32(sqlDataReader["Qty"]);
            objT1_Print.HPP  = Convert.ToDecimal(sqlDataReader["HPP"]);
            objT1_Print.Partno = (sqlDataReader["PartNo"]).ToString();
            return objT1_Print;
        }
        public T1_Print GenerateObjectforjemurlg(SqlDataReader sqlDataReader)
        {try {
            objT1_Print = new T1_Print();
            objT1_Print.ID = Convert.ToInt32(sqlDataReader["ID"]);
            objT1_Print.JemurID = Convert.ToInt32(sqlDataReader["JemurID"]);
            objT1_Print.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
            objT1_Print.PlantGroup = (sqlDataReader["gp"]).ToString();
            objT1_Print.Formula = (sqlDataReader["FormulaCode"]).ToString();
            objT1_Print.TglProduksi = Convert.ToDateTime(sqlDataReader["TglProduksi"]);
            objT1_Print.TglTrans = Convert.ToDateTime(sqlDataReader["TglTrans"]);
            objT1_Print.QtyIn = Convert.ToInt32(sqlDataReader["Qtyin"]);
            objT1_Print.QtyOut = Convert.ToInt32(sqlDataReader["QtyOut"]);
            objT1_Print.HPP = Convert.ToDecimal(sqlDataReader["HPP"]);
            objT1_Print.RakID = Convert.ToInt32(sqlDataReader["RakID"]);
            objT1_Print.Rak = (sqlDataReader["Rak"]).ToString();
            objT1_Print.Partno = (sqlDataReader["PartNo"]).ToString();
            objT1_Print.Lokasi = (sqlDataReader["Lokasi"]).ToString();
            objT1_Print.LokasiTF = (sqlDataReader["LokasiTF"]).ToString();
            objT1_Print.Palet = (sqlDataReader["NoPAlet"]).ToString();
            }
            catch
            {
        ...
        public T1_Print GenerateObjectforserah(SqlDataReader sqlDataReader)
        {
            try
            {
                objT1_Print = new T1_Print();
                objT1_Print.ID = Convert.ToInt32(sqlDataReader["ID"]);
                objT1_Print.Flag = Convert.ToInt32(sqlDataReader["Flag"]);
                objT1_Print.JemurID = Convert.ToInt32(sqlDataReader["JemurID"]);
                objT1_Print.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
                objT1_Print.PlantGroup = (sqlDataReader["gp"]).ToString();
                objT1_Print.Formula = (sqlDataReader["FormulaCode"]).ToString();
                ...
                objT1_Print.Lokasi = (sqlDataReader["Lokasi"]).ToString();
                objT1_Print.Palet = (sqlDataReader["NoPAlet"]).ToString();
                objT1_Print.ItemID = Convert.ToInt32(sqlDataReader["itemid"]);
                objT1_Print.LuasA = Convert.ToInt32(sqlDataReader["LuasA"]);
                objT1_Print.Sisa = Convert.ToInt32(sqlDataReader["Sisa"]);
                objT1_Print.Fail = Convert.ToInt32(sqlDataReader["fail"]);
        ...
        public ArrayList RetrieveCountSheet(string lokasi, string tanggal1, string tanggal2,string nopalet)
        {
            ...
            if (lokasi == "curing")
                strSQL = "select top 100 null as TglTranslg,*,(select SUM(qtyin-qtyout) from T1_Print where DestID=A.destid)as sisajemur from (select destid,  itemid0 as itemid,partno,Lokasiid,lokasi,tglproduksi,TglTrans,palet,Rak,sum(Qty) as saldo from vw_kartustockWIPDet  " +
                ...
                strSQL = "select  top 100  null as TglTranslg,*,(select SUM(qtyin-qtyout) from T1_Print where DestID=A.destid)as sisajemur from " +
            ...
            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    arrT1_Print.Add(GenerateObjectForCountsheet(sqlDataReader));
                }
            }
            else
                arrT1_Print.Add(new T1_Print());
        ...
        public T1_Print GenerateObjectForCountsheet(SqlDataReader sqlDataReader)
        {
            try
            {
                objT1_Print = new T1_Print();
                ...
                objT1_Print.DestID = Convert.ToInt32(sqlDataReader["DestID"]);
                //objT1_Print.PlantGroup = (sqlDataReader["gp"]).ToString();
                objT1_Print.LokasiID  = Convert.ToInt32(sqlDataReader["LokasiID"]);
                objT1_Print.TglProduksi = Convert.ToDateTime(sqlDataReader["TglProduksi"]);
                objT1_Print.Partno = (sqlDataReader["PartNo"]).ToString();
                objT1_Print.Lokasi = (sqlDataReader["Lokasi"]).ToString();
                objT1_Print.Palet = (sqlDataReader["PAlet"]).ToString();
                objT1_Print.QtyIn = Convert.ToInt32(sqlDataReader["saldo"]);
                objT1_Print.ItemID = Convert.ToInt32(sqlDataReader["itemid"]);
                objT1_Print.Rak = (sqlDataReader["Rak"]).ToString();
                objT1_Print.TglTrans = Convert.ToDateTime(sqlDataReader["TglTrans"]);
                objT1_Print.QtyOut = Convert.ToInt32(sqlDataReader["sisajemur"]);
                //objT1_Print.HPP = Convert.ToDecimal(sqlDataReader["HPP"]);
                //objT1_Print.RakID = Convert.ToInt32(sqlDataReader["RakID"]);

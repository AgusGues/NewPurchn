<%@ WebHandler Language="C#" Class="PreveiewPDFSarmut" %>
...
public class PreveiewPDFSarmut : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            context.Response.WriteFile("D:\\Data Lampiran Purchn\\Sarmut\\" + Convert.ToString(NamaFile));

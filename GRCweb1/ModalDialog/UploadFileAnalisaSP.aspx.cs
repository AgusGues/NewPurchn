...
{
    public partial class UploadFileAnalisaSP : System.Web.UI.Page
    {
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            if (Upload1.HasFile)
            {
                ...
                try
                {
                    ...
                    zl.CustomQuery = "insert into SPD_Attachment_AP(A_SarmutTransID, docName, FileName, RowStatus, CreatedBy, " +

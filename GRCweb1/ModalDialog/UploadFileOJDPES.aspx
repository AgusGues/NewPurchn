<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFileOJDPES.aspx.cs" Inherits="GRCweb1.ModalDialog.UploadFileOJDPES" %>
                ...
                <tr>
                    <td style="height: 49px; width: 100%">
                        <table class="nbTableHeader">
                            <tr>
                                <td style="width: 50%"><strong>UPLOAD DOCUMENT OJD</strong></td>
                                <td style="width: 20%">

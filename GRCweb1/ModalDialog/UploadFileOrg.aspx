<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFileOrg.aspx.cs" Inherits="GRCweb1.ModalDialog.UploadFileOrg" %>
                        ...
                        <tr>
                            ...
                            <td style="width:20%">
                                <div id="divImage" style="display: none; float: left; width: 100px; height: 9px;">
                                    <asp:Image ID="img1" runat="server" Height="10px" ImageUrl="~/Resource_Web/images/loading_animation2.gif"
                                        Width="75px" />
                                </div>
                            </td>
            ...
            <tr>
                <td>
                    ...
                    <table style="border-collapse:collapse; width:100%">
                        ...
                        <tr>
                            <td>Revisi</td>
                            <td><asp:TextBox ID="txtRevisi" runat="server" Text="0"></asp:TextBox></td>
                            <td>&nbsp;</td>
                        </tr>

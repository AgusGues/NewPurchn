<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFileSarmut.aspx.cs" Inherits="GRCweb1.ModalDialog.UploadFileSarmut" %>
            ...
            <tr>
                <td style="height: 49px; width: 100%">
                    <table class="nbTableHeader">
                        <tr>
                            <td style="width: 50%"><strong>UPLOAD DOCUMENT SARMUT / PEMANTAUAN</strong></td>
                            <td style="width:20%">

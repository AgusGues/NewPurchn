<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFileSarmutx.aspx.cs" Inherits="GRCweb1.ModalDialog.UploadFileSarmutx" %>
            ...
            <tr>
                <td style="height: 49px; width: 100%">
                    <table class="nbTableHeader">
                        <tr>
                            <td style="width: 50%"><strong>UPLOAD DOCUMENT ANALISA RESIKO</strong></td>
                            <td style="width:20%">

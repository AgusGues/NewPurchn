<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFileSosPES.aspx.cs" Inherits="GRCweb1.ModalDialog.UploadFileSosPES" %>
            ...
            <tr>
                <td style="height: 49px; width: 100%">
                    <table class="nbTableHeader">
                        <tr>
                            <td style="width: 50%"><strong>UPLOAD DOCUMENT SOSIALISASI PES</strong></td>
                            <td style="width:20%">

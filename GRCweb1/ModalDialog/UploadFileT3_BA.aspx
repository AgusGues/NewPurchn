<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFileT3_BA.aspx.cs" Inherits="GRCweb1.Modul.ModalDialog.UploadFileT3_BA" %>
            ...
            <tr>
                <td style="height: 49px; width: 100%">
                    <table class="nbTableHeader">
                        <tr>
                            <td style="width: 50%"><strong>UPLOAD DOCUMENT BERITA ACARA TAHAP 3</strong></td>
                            <td style="width:20%">

...
namespace GRCweb1.Modul.ModalDialog
{
    public partial class UploadFileT3_BA : System.Web.UI.Page
    {
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            if (Upload1.HasFile)
            {
                ...
                Upload1.PostedFile.SaveAs("D:\\Data Lampiran Purchn\\t3BA\\" + UploadedFileName);
                ...
                try
                {
                    ...
                    zl.CustomQuery =
                        "insert " + tablename + "( BAID, FileName, RowStatus, CreatedBy, CreatedTime, LastModifiedBy, LastModifiedTime)values(" +

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFileTask.aspx.cs" Inherits="GRCweb1.ModalDialog.UploadFileTask" %>
            ...
            <tr>
                <td style="height: 49px; width: 100%">
                    <table class="nbTableHeader">
                        <tr>
                            <td style="width: 50%"><strong>UPLOAD LAMPIRAN PENYELESAIAN TASK</strong></td>
                            <td style="width:20%">

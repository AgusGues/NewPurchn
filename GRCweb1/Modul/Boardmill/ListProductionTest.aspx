<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListProductionTest.aspx.cs" Inherits="GRCweb1.Modul.Boardmill.ListProductionTest" %>
                        ...
                        <table style="width: 100%; border-collapse: collapse; font-size: x-small">
                            ...
                            <tr>
                                <td colspan="5" valign="top" align="left">
                                    <div id="div2" runat="server" class="table-responsive" style="width:100%">
                                        <table id="headerPO" width="100%" style="border-collapse: collapse;" visible="true"
                                            ...
                                            <tr>
                                                ...
                                                <td width="10%" align="right" style="height: 24px">
                                                </td>
                                                <td width="25%" style="height: 24px">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%" colspan="2" style="width: 25%">
                                                    <asp:DropDownList ID="ddlPressing" runat="server" AutoPostBack="true" Width="76%">
                                                    </asp:DropDownList>
                                                </td>
                                                <td width="15%" align="right">
                                                    &nbsp;
                                            ...
                                            <table width="100%" style="border-collapse: collapse; font-size: x-small" id="lst1"
                                                ...
                                                <thead>
                                                    <tr class="tbHeader">
                                                        ...
                                                        <th class="kotak" rowspan="2" style="width: 6%">
                                                            Prod. Date
                                                        </th>
                                                        <th class="kotak" rowspan="2" style="width: 4%">
                                                            Formula
                                                ...
                                                <asp:Repeater ID="lstBendingStrength" runat="server" OnItemDataBound="lstBendingStrength_ItemDataBound">
                                                    <ItemTemplate>
                                                        <tr align="center" valign="top">
                                                            ...
                                                            <td border="1px;">
                                                                <%# Eval("ThicknessC", "{0:N1}")%>
                                                            </td>
                                                            <td border="1px;">
                                                                <%# Eval("ThicknessL", "{0:N1}")%>
                                                            </td>
                                                            <td border="1px;">
                                                                <%# Eval("PeakLoadC", "{0:N0}")%>
                                                            </td>
                                                            ...
                                                            <td border="1px;">
                                                                <%# Eval("PeakLoadCL", "{0:N0}")%>
                                                            </td>
                                                            <td border="1px;">
                                                                <%# Eval("PeakElongationC", "{0:N0}")%>
                                                            </td>
                                                            <td border="1px;">
                                                                <%# Eval("PeakElongationL", "{0:N0}")%>
                                                            </td>
                                                            <td border="1px;">
                                                                <%# Eval("PeakElongationCL", "{0:N0}")%>
                                                            </td>
                                                            <td border="1px;">
                                                                <%# Eval("BendingStrengthC", "{0:N0}")%>
                                                            </td>
                                                            <td border="1px;">
                                                                <%# Eval("BendingStrengthL", "{0:N0}")%>
                                                            </td>
                                                            <td border="1px;">
                                                                <%# Eval("BendingStrengthCL", "{0:N0}")%>
                                                            </td>
                                                            <td border="1px;">
                                                                <%# Eval("AreaUnderCurveC", "{0:N0}")%>
                                                            </td>
                                                            <td border="1px;">
                                                                <%# Eval("AreaUnderCurveL", "{0:N0}")%>
                                                            </td>
                                                            <td border="1px;">
                                                                <%# Eval("AreaUnderCurveCL", "{0:N0}")%>
                                                            </td>
                                                            <td border="1px;">
                                                                <%# Eval("Denisty", "{0:N2}")%>
                                                            </td>

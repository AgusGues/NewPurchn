<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BudgetingMasterFinishing.aspx.cs" Inherits="GRCweb1.Modul.Budgeting.BudgetingMasterFinishing" %>
                                ...
                                <div class="contentlist" style="height:400px">
                                    <table style="width:100%; border-collapse:collapse;" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr class="tbHeader">
                                            ...
                                            <th class="kotak tengah" rowspan="2" >ItemCode</th>
                                            <th class="kotak tengah" rowspan="2" >ItemName</th>
                                            <th class="kotak tengah" colspan="3">Budget</th>
                                            <%--<th class="kotak tengah" rowspan="2" ></th>--%>
                                            <th class="transparant">&nbsp;</th>
                                        </tr>
                                        <tr class="tbHeader">
                                            <th class="kotak tengah" style="width:10%">Satuan </th>
                                            <th class="kotak tengah" style="width:12%">Lembar</th>
                                            <th class="kotak tengah" style="width:12%">Rupiah</th>
                                        </tr>
                                        </thead>
                                        <tbody>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MaterialCCgroup.aspx.cs" Inherits="GRCweb1.Modul.Budgeting.MaterialCCgroup1" %>
                                    ...
                                    <tr id="forPJ" runat="server" visible="false">
                                        ...
                                        <td>
                                            <cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txtPathNo"
                                                CompletionSetCount="20" ServiceMethod="GetNoProdukCC" ServicePath="AutoComplete.asmx"
                                                MinimumPrefixLength="3" CompletionListCssClass="autocomplete_completionListElement"

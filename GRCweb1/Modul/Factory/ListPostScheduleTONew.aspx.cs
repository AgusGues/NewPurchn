...
{
    public partial class ListPostScheduleTONew : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Add")
            {
                ...
                Response.Redirect("PostingSuratJalanToCpdNew.aspx?ScheduleNo=" + row.Cells[0].Text + "&TONo=" + row.Cells[2].Text + "&Address1=" + row.Cells[6].Text + "&Address2=" + row.Cells[7].Text);
            }
        }

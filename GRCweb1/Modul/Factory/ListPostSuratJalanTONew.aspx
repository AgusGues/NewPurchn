<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListPostSuratJalanTONew.aspx.cs" Inherits="GRCweb1.Modul.Factory.ListPostSuratJalanTONew" %>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading clearfix">
                                <h2 class="panel-title pull-left">DAFTAR SURAT JALAN TO</h2>
                                <div class="pull-right">
                                    <span class="input-icon input-icon-right">
                                        <input id="btnFormSJ" runat="server" class="btn btn-sm btn-info"  style="background-image: url('file:///D:/GRCBoardProject/GRCBoardProject/Modul/images/Button_Back.gif');
                              background-color: white; font-weight: bold; font-size: 11px;" type="button" value="Form Surat Jalan" onserverclick="btnFormSJ_ServerClick" />
                                    </span>
                                    <span class="input-icon input-icon-right">
                            ...
                            <div class="panel-body">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                 ...
                                 <Columns>                                     
                                     ...
                                     <asp:BoundField DataField="DriverName" HeaderText="Nama Supir" />

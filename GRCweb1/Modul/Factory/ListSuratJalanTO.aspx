<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListSuratJalanTO.aspx.cs" Inherits="GRCweb1.Modul.Factory.ListSuratJalanTO" %>
                            ...
                            <div class="panel-heading clearfix">
                                ...
                                <div class="pull-right">
                                    <span class="input-icon input-icon-right">
                                        <input id="btnFormSJ" runat="server" class="btn btn-sm btn-info" style="background-color: white; font-weight: bold; font-size: 11px;"
                                            type="button" value="Form Surat Jalan" onserverclick="btnFormSJ_ServerClick" />
                                    </span>
                                    <span class="input-icon input-icon-right">
                                        <asp:DropDownList ID="ddlSearch" class="form-control" runat="server" Width="120px">
                                            ...
                                            <asp:ListItem Value="TransferOrderNo">No TO</asp:ListItem>

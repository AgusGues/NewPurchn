<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PostingSuratJalanCPD.aspx.cs" Inherits="GRCweb1.Modul.Factory.PostingSuratJalanCPD" %>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading clearfix">
                                <div class="panel-heading clearfix">
                                    <h2 class="panel-title pull-left">POSTING SHIPMENT SURAT JALAN OP</h2>
                                    <div class="pull-right">
                                        <span class="input-icon input-icon-right">
                                            <input id="btnSearch0" runat="server" class="btn btn-sm btn-info" onserverclick="btnSearch0_ServerClick" style="background-color: White; font-weight: bold; font-size: 11px;"
                                                type="button" value="Baru" />
                                            <input id="btnSave" runat="server" style="background-color: white; font-weight: bold; font-size: 11px;"
                                        ...
                                        <span class="input-icon input-icon-right">
                                            ...
                                            <asp:Button ID="btnCancelReceive" runat="server" Style="background-color: white; font-weight: bold; font-size: 11px;"
                                                Text="Cancel Receive" OnClick="btnCancelReceive_ServerClick"
                                                Visible="False" />
                                        ...
                                        <span>
                                            ...
                                            <input id="btnListOP" runat="server" style="background-color: White; font-weight: bold; font-size: 11px;"
                                                type="button" value="List OP" onserverclick="btnListTO_ServerClick"
                                                visible="False" />
                                        ...
                                        <span class="input-icon input-icon-right">
                                            ...
                                            <input id="btnAutoSJ" runat="server" style="background-color: White; font-weight: bold; font-size: xx-small;"
                                                type="button" value="Auto SJ" visible="False" onserverclick="btnAutoSJ_ServerClick" />
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <asp:TextBox ID="txtAlamat" runat="server" class="form-control" Height="50px" Width="350px"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <asp:TextBox ID="txtKeterangan" runat="server" class="form-control" Height="50px"

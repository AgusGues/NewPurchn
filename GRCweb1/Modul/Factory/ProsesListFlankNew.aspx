<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProsesListFlankNew.aspx.cs" Inherits="GRCweb1.Modul.Factory.ProsesListFlankNew" %>
        ...
        <ContentTemplate>
            <div id="Div1" runat="server">
                <table width="100%" class="table-responsive">
                    <tr>
                        <td align="left">
                            <strong><span class="auto-style1">PROSES LISTPLANK</span></strong>
                        </td>
                        <td align="right">
                            &nbsp;
                        </td>
                                ...
                                <asp:Panel ID="Panel2" runat="server" Width="100%">
                                    <table bgcolor="#CCCCCC" width="100%" class="table-responsive">
                                        <tr>
                                            <td colspan="2" style="font-size: x-small">
                                                <b>Dari&nbsp; lokasi / Proses =&gt;</b><asp:RadioButton ID="RBP99" runat="server"
                                                    GroupName="b" Text="P99" AutoPostBack="True" OnCheckedChanged="RBP99_CheckedChanged" EnableTheming="True" Font-Size="XX-Small" />
                                                <asp:RadioButton ID="RBI99" runat="server" AutoPostBack="True" Checked="True" GroupName="b"
                                                    OnCheckedChanged="RBI99_CheckedChanged" Text="I99" Font-Size="Smaller" />
                                                ...
                                                &nbsp;<asp:RadioButton ID="RBBevel" runat="server" AutoPostBack="True" GroupName="b"
                                                    OnCheckedChanged="RBBevel_CheckedChanged" Text="Bevel / CNC" />
                                            ...
                                            <td align="right" colspan="3" style="font-size: x-small">
                                                Filter By PartNo
                                            ...
                                            <td align="center" colspan="5" style="font-size: x-small; font-weight: normal;">
                                                <asp:Panel ID="Paneltransit" runat="server" Height="230px" ScrollBars="Both" BackColor="White"
                                                    ...
                                                    <asp:GridView ID="GridViewtrans0" runat="server" AutoGenerateColumns="False" PageSize="22"
                                                        Width="100%" CssClass="table-responsive">
                                        ...
                                        <tr>
                                            <td align="left" style="font-size: x-small; font-weight: normal;" valign="middle"
                                                ...
                                                <b>Ke Lokasi / Proses selanjutnya =&gt;&nbsp;
                                                    <asp:RadioButton ID="RBI990" runat="server" AutoPostBack="True" GroupName="c" OnCheckedChanged="RBI990_CheckedChanged"
                                                        Text="I99" />
                                                    ...
                                                    <asp:RadioButton ID="RBBevel0" runat="server" AutoPostBack="True" GroupName="c" OnCheckedChanged="RBBevel0_CheckedChanged"
                                                        Text="Bevel / CNC" />
                                                    <asp:RadioButton ID="RBPrint0" runat="server" AutoPostBack="True" GroupName="c" OnCheckedChanged="RBPrint0_CheckedChanged"
                                                        Text="Print" Visible="False" />
                                                    &nbsp;<asp:RadioButton ID="RBRenovasi" runat="server" AutoPostBack="True" GroupName="c"
                                                        OnCheckedChanged="RBRenovasi_CheckedChanged" Text="Renovasi 1" />
                                            ...
                                            <td align="right" style="font-size: x-small; font-weight: normal;" valign="middle">
                                                <b>
                                                    <asp:Panel ID="PCut2H" runat="server" Width="424px" BackColor="#CCCCFF">
                                                        <table style="width: 100%;" Class="table-responsive">
                                                            <tr>
                                                                <td align="center" style="font-size: x-small; font-weight: bold;">
                                                                    <asp:Label ID="LblProduk" runat="server" Text="Produk Tujuan"></asp:Label>
                                                                    ...
                                                                    &nbsp;<b><asp:RadioButton ID="RBNonStd" runat="server" AutoPostBack="True" GroupName="e"
                                                                        ...
                                                                        &nbsp;<asp:RadioButton ID="RBKali15" runat="server" AutoPostBack="True" GroupName="e"
                                                                            OnCheckedChanged="RBKali15_CheckedChanged" Text="300 mm" />
                                                                        <b>&nbsp;</b></b> 
                                                                           <b>
                                                                            <br />
                                                                        ...
                                                                        OnTextChanged="RBKaliNSTD_CheckedChanged" Width="48px"></asp:TextBox>
                                                                        <%--</b>&nbsp;mm</b> --%>
                                            ...
                                            <td align="right" style="font-size: x-small; font-weight: normal;" valign="middle">
                                                <input id="btnTansfer" runat="server" onserverclick="btnTansfer_ServerClick" style="background-color: white;
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" colspan="4" style="font-size: x-small; font-weight: normal;" valign="middle">
                                                <asp:Label ID="LblPartnoT1" runat="server" Text="Partno Transfer "></asp:Label>
                                                ...
                                                &nbsp;<asp:Label ID="LblJumlahT1" runat="server" Text="Jumlah Transfer "></asp:Label>
                                           ...
                                           <%--     <asp:Panel ID="Panel9" runat="server">
                                                <asp:Label ID="LblPartnoT3" runat="server" Text="Partno Transfer "></asp:Label>
                                                ...
                                                &nbsp;<asp:Label ID="LblJumlahT3" runat="server" Text="Jumlah Transfer "></asp:Label>
                                              ...
                                              <%--  
                                                ...
                                                &nbsp;<asp:Label ID="LblJumlahT1" runat="server" Text="Jumlah Transfer "></asp:Label>&nbsp;<b><asp:TextBox
                                                    ID="txtQtyTransfer" runat="server" AutoPostBack="True" BorderStyle="Groove" Height="21px"
                                                    onfocus="this.select();" Width="48px" ReadOnly="True"></asp:TextBox></b>
                                                    </td>
                                                    
                                                       <td align="left" colspan="4" style="font-size: x-small; font-weight: normal;" valign="middle">
                                                      <asp:Label ID="Label3" runat="server" Text="Partno Transfer "></asp:Label>
                                                <asp:TextBox ID="txtPartnoTransfer2" runat="server" AutoPostBack="True" BorderStyle="Groove"
                                                    Height="21px" onfocus="this.select();" OnTextChanged="txtPartnoOK_TextChanged"
                                                    Width="175px"></asp:TextBox>
                          
                                                &nbsp;<asp:Label ID="Label4" runat="server" Text="Jumlah Transfer "></asp:Label>&nbsp;<b><asp:TextBox
                                                    ID="txtQtyTransfer2" runat="server" AutoPostBack="True" BorderStyle="Groove" Height="21px"
                                                    onfocus="this.select();" Width="48px" ReadOnly="True"></asp:TextBox></b>
                                                     </td>--%>
                                        </tr>
                                        
                                        <tr id="trCnC1" runat="server" visible="false">
                                            <td align="left" style="font-size: x-small; font-weight: normal;" valign="middle">
                                                &nbsp;
                                                <asp:CheckBox ID="ChkBPCNC" runat="server" AutoPostBack="True" OnCheckedChanged="ChkBPCNC_CheckedChanged"
                                                    Text="Input BP untuk proses CNC" Visible="False" />
                                            </td>
                                            <td align="left" colspan="4" style="font-size: x-small; font-weight: normal;" valign="middle">
                                                <asp:Panel ID="PanelNonStd" runat="server" Height="26px" Visible="False">
                                                    <table style="width: 100%;" class="table-responsive">
                                                        <tr>
                                                            <td align="left" colspan="4" style="font-size: x-small; font-weight: normal;" valign="middle">
                                                                <asp:Label ID="LblPartnoT2" runat="server" Text="Partno Transfer " Visible="False"></asp:Label>
                                                                <asp:TextBox ID="txtPartnoTransfer0" runat="server" AutoPostBack="True" BorderStyle="Groove"
                                                                    Height="21px" onfocus="this.select();" OnTextChanged="txtPartnoOK_TextChanged"
                                                                    Width="175px"></asp:TextBox>
                                                                <cc1:AutoCompleteExtender ID="txtPartnoTransfer0_AutoCompleteExtender" runat="server"
                                                                    CompletionInterval="200" CompletionSetCount="10" EnableCaching="true" FirstRowSelected="True"
                                                                    MinimumPrefixLength="1" ServiceMethod="GetNoProdukJadi" ServicePath="AutoComplete.asmx"
                                                                    TargetControlID="txtPartnoTransfer0">
                                                                </cc1:AutoCompleteExtender>
                                                                &nbsp;<b><asp:Label ID="LblJumlahT2" runat="server" Text="Jumlah Transfer " Visible="False"></asp:Label><asp:TextBox
                                                                    ID="txtQtyTransfer0" runat="server" AutoPostBack="True" BorderStyle="Groove"
                                                                    Height="21px" onfocus="this.select();" ReadOnly="True" Width="48px"></asp:TextBox></b></td>
                                                        </tr>
                                                    </table>
                                                </asp:Panel>
                                            </td>
                                        ...
                                        <!-- Keluar Alur ListPlank -->
                                        <tr id="trCnC2" runat="server" visible="false">
                                            <td align="left" style="font-size: x-small; font-weight: normal;" valign="middle">
                                                &nbsp;
                                                <asp:CheckBox ID="ChkCnC" runat="server" AutoPostBack="True" OnCheckedChanged="ChkCnC_CheckedChanged" Visible="False" Font-Size="XX-Small" Text="Keluar alur ListPlank" />
                                                </td>
                                            <td align="left" colspan="4" style="font-size: x-small; font-weight: normal;" valign="middle">
                                        ...
                                        <tr>
                                            <td align="left" colspan="5" style="font-size: x-small; font-weight: normal;" valign="middle">
                                                <asp:Panel ID="PanelSerah" runat="server" Visible="False" BackColor="#99CCFF">
                                                    <table style="width: 100%;" class="table-responsive">
                                                        <tr>
                                                            <td align="left" style="font-size: x-small; font-weight: bold;" bgcolor="#0099CC">
                                                                &nbsp;
                                                            </td>
                                                            <td align="left" bgcolor="#0099CC" style="font-size: x-small; font-weight: bold;">
                                                                &nbsp;
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size: x-small; font-weight: normal;" colspan="3">
                                                                ...
                                                                &nbsp;<asp:TextBox ID="txtPartnoOK" runat="server" AutoPostBack="True" BorderStyle="Groove"
                                                                    Height="21px" onfocus="this.select();" OnTextChanged="txtPartnoOK_TextChanged"
                                                                    Width="175px"></asp:TextBox><cc1:AutoCompleteExtender ID="AutoCompleteExtender2"
                                                                        runat="server" CompletionInterval="200" CompletionSetCount="10" EnableCaching="true"
                                                                ...
                                                                &nbsp;&nbsp;<asp:Label ID="LabelqtyOK" runat="server" Text="Qty"></asp:Label><asp:TextBox
                                                                    ID="txtQtyOK" runat="server" AutoPostBack="True" Height="21px" onfocus="this.select();"
                                                                    ReadOnly="True" Width="57px"></asp:TextBox></td>
                                                            ...
                                                            <td align="left" style="font-size: x-small; font-weight: normal;">
                                                                <asp:TextBox ID="txtlokOK" runat="server" Height="21px" Width="57px" AutoPostBack="True"
                                                                    OnTextChanged="txtlokOK_TextChanged" Visible="False"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size: x-small; font-weight: normal;" colspan="3">
                                                                ...
                                                                &nbsp;
                                                                <asp:TextBox ID="txtPartnoBP" runat="server" AutoPostBack="True" BorderStyle="Groove"
                                                                    Height="21px" onfocus="this.select();" OnTextChanged="txtPartnoBP_TextChanged"
                                                                ...
                                                                <cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" CompletionInterval="200"
                                                                    CompletionSetCount="10" EnableCaching="true" FirstRowSelected="True" MinimumPrefixLength="1"
                                                                    ServiceMethod="GetNoProdukJadi" ServicePath="AutoComplete.asmx" 
                                                                    TargetControlID="txtPartnoBP">
                                                                </cc1:AutoCompleteExtender>
                                                                &nbsp;
                                                                <asp:Label ID="LabelqtyBP" runat="server" Text="Qty" Visible="False"></asp:Label>
                                                                &nbsp;
                                                                <asp:TextBox ID="txtQtyBP" runat="server" AutoPostBack="True" Height="21px" onfocus="this.select();"
                                                                    ReadOnly="True" Visible="False" Width="57px"></asp:TextBox>
                                                            </td>
                                                            <td align="left" style="font-size: x-small; font-weight: normal;">
                                                                &nbsp;
                                                            </td>
                                                            ...
                                                            <td align="left" style="font-size: x-small; font-weight: normal;">
                                                                <asp:TextBox ID="txtlokBP" runat="server" Height="21px" Width="57px" Visible="False"></asp:TextBox>

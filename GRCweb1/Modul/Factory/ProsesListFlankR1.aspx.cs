...
{
    public partial class ProsesListFlankR1 : System.Web.UI.Page
    {
        ...
        private void LoadPartno()
        {
            ...
            if (RBI99.Checked == true)
                tblname = "T1_LR1_listplank";
            if (RBRuningSaw.Checked == true)
                tblname = "T1_LR1_RuningSaw";
            if (RBBevel.Checked == true)
                tblname = "T1_LR1_Bevel";
            if (RBPrint.Checked == true)
                tblname = "T1_LR1_Print";
            if (RBStraping.Checked == true)
                tblname = "T1_LR1_Straping";
        ...
        private void LoadDataTransit()
        {
            ...
            if (RBI99.Checked == true)
                arrT1serah = Serah.RetrieveStockLR1Listplank1(ddlPartno.SelectedItem.Text);
            if (RBRuningSaw.Checked == true)
                arrT1serah = Serah.RetrieveStockLR1RuningSaw(ddlPartno.SelectedItem.Text);
            if (RBBevel.Checked == true)
                arrT1serah = Serah.RetrieveStockLR1Bevel(ddlPartno.SelectedItem.Text);
            if (RBStraping.Checked == true)
                arrT1serah = Serah.RetrieveStockLR1Straping(ddlPartno.SelectedItem.Text);
            ...
            if (ddlPartno.SelectedItem.Text != string.Empty)
            {
                ...
                if (RBNonStd.Checked == true)
                {
                    if (RBI99.Checked == true || RBP99.Checked == true)
                    {
                        txtPartnoTransfer.Text = ddlPartno.SelectedItem.Text.Substring(0, 9) + "0250" + ddlPartno.SelectedItem.Text.Substring(13, 4) + sisi;
        ...
        protected int pengali()
        {
            ...
            try
            {
                ...
                if (lebar == "0100")
                {
                    ...
                    RBNonStd.Visible = false;
                    Panel9.Visible = false;
                }
                if (lebar == "0200" || lebar == "0220")
                {
                    RBKali13.Visible = true;
                ...
                if (lebar == "0250")
                {
                    ...
                    if (RBKali13.Checked == true)
                    {
                        ...
                        txtPartnoTransfer2.Text = ddlPartno.SelectedItem.Text.Substring(0, 9) + "0150" + ddlPartno.SelectedItem.Text.Substring(13, 4) + sisi;
                    }
                    else
                    {
                        txtQtyTransfer2.Text = "";
                        txtPartnoTransfer2.Text = "0";
                    }
                }
                if (lebar == "0300")
                {
                ...
                if (RBKali13.Checked == true)
                {
                    ...
                    if (Convert.ToInt32(lebar) > 300)
                    {
                        pengali0 = (Convert.ToInt32(lebar) / 100);
                        pengali0 = Convert.ToInt32(pengali0);
                        //if ((Convert.ToInt32(lebar) - (pengali0 * 100)) > 0)
                        //{
                        //    txtPartnoTransfer2.Text = ddlPartno.SelectedItem.Text.Substring(0, 9) + (Convert.ToInt32(lebar) - (pengali0 * 100)).ToString().PadLeft(4, '0') +
                        //        ddlPartno.SelectedItem.Text.Substring(13, 4) + sisi;
                ...
                if (RBKali14.Checked == true)
                {
                    ...
                    if (Convert.ToInt32(lebar) > 300)
                    {
                        pengali0 = (Convert.ToInt32(lebar) / 200);
                        pengali0 = Convert.ToInt32(pengali0);
                        //if ((Convert.ToInt32(lebar) - (pengali0 * 200)) > 0)
                        //{
                        //    txtPartnoTransfer2.Text = ddlPartno.SelectedItem.Text.Substring(0, 9) + (Convert.ToInt32(lebar) - (pengali0 * 200)).ToString().PadLeft(4, '0') +
                        //        ddlPartno.SelectedItem.Text.Substring(13, 4) + sisi;
                        //    txtQtyTransfer2.Text = txtQtyOut.Text;
                        //}
                        //else
                ...
                if (RBKali15.Checked == true)
                {
                    ...
                    if (Convert.ToInt32(lebar) > 300)
                    {
                        pengali0 = (Convert.ToInt32(lebar) / 300);
                        pengali0 = Convert.ToInt32(pengali0);
                        //if ((Convert.ToInt32(lebar) - (pengali0 * 300)) > 0)
                        //{
                        //    txtPartnoTransfer2.Text = ddlPartno.SelectedItem.Text.Substring(0, 9) + (Convert.ToInt32(lebar) - (pengali0 * 300)).ToString().PadLeft(4, '0') +
                        //        ddlPartno.SelectedItem.Text.Substring(13, 4) + sisi;
                        //    txtQtyTransfer2.Text = txtQtyOut.Text;
                        //}
                        //else
                ...
                if (RBNonStd.Checked == true)
                {
                    ...
                    if (Convert.ToInt32(lebar) >= 300)
                    {
                        pengali0 = (Convert.ToInt32(lebar) / 250);
                        pengali0 = Convert.ToInt32(pengali0);
                        //if ((Convert.ToInt32(lebar) - (pengali0 * 250)) > 0)
                        //{
                        //    txtPartnoTransfer2.Text = ddlPartno.SelectedItem.Text.Substring(0, 9) + (Convert.ToInt32(lebar) - (pengali0 * 250)).ToString().PadLeft(4, '0') +
                        //        ddlPartno.SelectedItem.Text.Substring(13, 4) + sisi;
                        //    txtQtyTransfer2.Text = txtQtyOut.Text ;
                        //}
                        //else
        ...
        protected void TransferData()
        {
            ...
            T1_LR1_ListPlank T1_LR1listplank = new T1_LR1_ListPlank();
            T1_LR1_RuningSaw T1_LR1runingsaw = new T1_LR1_RuningSaw();
            T1_LR1_RuningSawFacade T1_LR1runingsawF = new T1_LR1_RuningSawFacade();
            T1_LR1_Bevel T1_LR1bevel = new T1_LR1_Bevel();
            T1_LR1_BevelFacade T1_LR1bevelF = new T1_LR1_BevelFacade();
            T1_LR1_Straping T1_LR1straping = new T1_LR1_Straping();
            T1_LR1_StrapingFacade T1_LR1strapingF = new T1_LR1_StrapingFacade();
            T1_SerahFacade serahF = new T1_SerahFacade();
            FC_Items items = new FC_Items();
            FC_ItemsFacade itemsF = new FC_ItemsFacade();
            T1_LR2_ListPlank T1LR2ListPlank = new T1_LR2_ListPlank();
            T1_LR2_ListPlankFacade T1LR2ListPlankF = new T1_LR2_ListPlankFacade();
            ...
            AbstractTransactionFacadeF absTrans = new T1_LR1_ListPlankFacade(T1_LR1listplank);
            for (int i = 0; i <= GridViewtrans0.Rows.Count - 1; i++)
            {
                TextBox txtQtyMutasi = (TextBox)GridViewtrans0.Rows[i].FindControl("txtQtyMutasi");
                if (txtQtyMutasi.Text != string.Empty)
                {
                    ...
                    if (RBI99.Checked == true && ChkCnC.Checked == false)
                    {
                        ...
                        T1_LR1runingsaw.QtyIn = kali * Convert.ToInt32(txtQtyMutasi.Text);
                        T1_LR1runingsaw.QtyAsal = Convert.ToInt32(txtQtyMutasi.Text);
                    ...
                    {
                        string Proses = "i99R1"; Session["Proses"] = Proses;
                    ...
                    {
                        items = itemsF.RetrieveByPartNo(txtPartnoTransfer.Text);
                        T1_LR1bevel = T1_LR1bevelF.RetrieveByID(GridViewtrans0.Rows[i].Cells[0].Text);
                        T1_LR1bevel.L1ID = Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text);
                        T1_LR1bevel.LokasiID0 = dest.GetLokID("I99");
                        T1_LR1bevel.ItemID0 = dest.GetPartnoID(GridViewtrans0.Rows[i].Cells[3].Text);
                        T1_LR1bevel.ItemID = items.ID;
                        T1_LR1bevel.TglTrans = DateTime.Parse(txtTanggal.Text);
                        T1_LR1bevel.QtyIn = Convert.ToInt32(txtQtyMutasi.Text);
                        T1_LR1bevel.LokasiID = T1_LR1bevel.LokasiID0;
                        T1_LR1bevel.CreatedBy = users.UserName;
                        absTrans = new T1_LR1_BevelFacade(T1_LR1bevel);
                        intresult = absTrans.Insert(transManager);
                        if (absTrans.Error != string.Empty)
                        {
                            transManager.RollbackTransaction();
                    ...
                    {
                        string Proses = "RsR1"; Session["Proses"] = Proses;
                        items = itemsF.RetrieveByPartNo(ddlPartno.SelectedItem.ToString());
                        T1_Serah serah = new T1_Serah();
                    ...
                    if (RBBevel.Checked == true)
                    {
                        if (RBStraping0.Checked == true)
                        {
                            ...
                            T1_LR1straping = T1_LR1strapingF.RetrieveByID(GridViewtrans0.Rows[i].Cells[0].Text);
                            T1_LR1straping.L1ID = Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text);
                            T1_LR1straping.LokasiID0 = dest.GetLokID("I99");
                            T1_LR1straping.ItemID0 = dest.GetPartnoID(GridViewtrans0.Rows[i].Cells[3].Text);
                            T1_LR1straping.ItemID = items.ID;
                            T1_LR1straping.TglTrans = DateTime.Parse(txtTanggal.Text);
                            T1_LR1straping.QtyIn = Convert.ToInt32(txtQtyMutasi.Text);
                            T1_LR1straping.LokasiID = T1_LR1straping.LokasiID0;
                            T1_LR1straping.CreatedBy = users.UserName;
                            absTrans = new T1_LR1_StrapingFacade(T1_LR1straping);
                            intresult = absTrans.Insert(transManager);
                            if (absTrans.Error != string.Empty)
                            {
                                transManager.RollbackTransaction();
                        ...
                        {
                            items = itemsF.RetrieveByPartNo(partno);
                            T1LR2ListPlank = T1LR2ListPlankF.RetrieveByID(GridViewtrans0.Rows[i].Cells[0].Text);
                            T1LR2ListPlank.ItemID0 = items.ID;
                            T1LR2ListPlank.LokasiID0 = dest.GetLokID("I99");
                            T1LR2ListPlank.LokasiID = T1LR2ListPlank.LokasiID0;
                            T1LR2ListPlank.L1ID = Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text);
                            T1LR2ListPlank.ItemID = items.ID;
                            T1LR2ListPlank.TglTrans = DateTime.Parse(txtTanggal.Text);
                            T1LR2ListPlank.QtyIn = Convert.ToInt32(txtQtyMutasi.Text);
                            T1LR2ListPlank.QtyOut = 0;
                            T1LR2ListPlank.HPP = 0;
                            T1LR2ListPlank.CreatedBy = users.UserName;
                            AbstractTransactionFacadeF absTrans1 = new T1_LR2_ListPlankFacade(T1LR2ListPlank);
                        ...
                        if (RBLogistik.Checked == true)
                        {
                            items = itemsF.RetrieveByPartNo(partno);
                            T1_Serah serah = new T1_Serah();
                            serah = serahF.RetrieveByIDLR1Bevel(GridViewtrans0.Rows[i].Cells[0].Text);
                    ...
                    if (RBStraping.Checked == true)
                    {
                        ...
                        items = itemsF.RetrieveByPartNo(partno);
                        T1_Serah serah = new T1_Serah();
                        serah = serahF.RetrieveByIDLR1_Print(GridViewtrans0.Rows[i].Cells[0].Text);
                        serah.PartnoSer = partno;
                        serah.PartnoDest = GridViewtrans0.Rows[i].Cells[3].Text;
                        serah.ItemIDSer = items.ID;
                        serah.QtyIn = Convert.ToInt32(txtQtyMutasi.Text);
            ...
            if (rekam == "sukses")
            {
                for (int i = 0; i <= GridViewtrans0.Rows.Count - 1; i++)
                {
                    ...
                    if (txtQtyMutasi.Text != string.Empty)
                    {
                        if (RBI99.Checked == true)
                        {
                            T1_LR1_ListPlankFacade T1_LR1listplankF = new T1_LR1_ListPlankFacade();
                            T1_LR1listplankF.UpdateFail(Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text), Convert.ToInt32(txtQtyMutasi.Text));
                        }
                        if (RBRuningSaw.Checked == true)
                        {
                            T1_LR1_RuningSawFacade T1_LR1RuningSawF = new T1_LR1_RuningSawFacade();
                            T1_LR1RuningSawF.UpdateFail(Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text), Convert.ToInt32(txtQtyMutasi.Text));
                        }
                        if (RBBevel.Checked == true)
                        {
                            T1_LR1bevelF.UpdateFail(Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text), Convert.ToInt32(txtQtyMutasi.Text));
                        }
                        if (RBStraping.Checked == true)
                        {
                            T1_LR1strapingF = new T1_LR1_StrapingFacade();
                            T1_LR1strapingF.UpdateFail(Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text), Convert.ToInt32(txtQtyMutasi.Text));
                        }
                    }
                }
            }
        ...
        private void loadDynamicGrid(string tgl1, string tgl2)
        {
            ...
            "select  * from ( select distinct tanggal tanggal0,partnoasal from  vw_KartuStockListplankR1 AI where CONVERT(char,tanggal,112)>=@tgl1 and CONVERT(char,tanggal,112)<=@tgl2) as P left join   " +
            "(  " +
            "select tanggal,PartNoAsal PartNoAsal0,PartNo,sum(qtyin)qtyin,sum(qtyout)qtyout from (   " +
            "select tanggal,PartNoAsal,PartNo,qty qtyin,0 qtyout from vw_KartuStockListplankR1  where qty>0 and process='i99'   " +
            "union all   " +
            "select tanggal,PartNoAsal,PartNo,0 qtyin,qty*-1 qtyout from vw_KartuStockListplankR1  where qty<0 and process='i99') as i99  " +
            ...
            "select tanggal,PartNoAsal,PartNo,qty qtyin,0 qtyout from vw_KartuStockListplankR1  where qty>0 and process='runingsaw'  " +
            "union all   " +
            "select tanggal,PartNoAsal,PartNo,0 qtyin ,qty*-1 qtyout from vw_KartuStockListplankR1  where qty<0 and process='runingsaw') as runingsaw   " +
            ...
            "select tanggal,PartNoAsal,PartNo,qty qtyin,0 qtyout from vw_KartuStockListplankR1  where qty>0 and process='Bevel'   " +
            "union all   " +
            "select tanggal,PartNoAsal,PartNo,0 qtyin,qty*-1 qtyout from vw_KartuStockListplankR1  where qty<0 and process='Bevel') as Bevel   " +
            ...
            "select tanggal,PartNoAsal,PartNo,qty qtyin,0 qtyout from vw_KartuStockListplankR1  where qty>0 and process='StrapingR1'   " +
            "union all   " +
            "select tanggal,PartNoAsal,PartNo,0 qtyin,qty*-1 qtyout from vw_KartuStockListplankR1  where qty<0 and process='StrapingR1') as straping   " +
        ...
        protected void RBNonStd_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (RBI99.Checked == true || RBP99.Checked == true)
            {
                ...
                txtPartnoTransfer.Text = ddlPartno.SelectedItem.Text.Substring(0, 9) + "0250" + ddlPartno.SelectedItem.Text.Substring(13, 4) + sisi;
                // txtQtyTransfer2.Text = "0";
                //txtPartnoTransfer2.Text = ddlPartno.SelectedItem.Text.Substring(0, 9) +
                //    (Int32.Parse(ddlPartno.SelectedItem.Text.Substring(9, 4)) - 1000).ToString().PadLeft(4, '0') + ddlPartno.SelectedItem.Text.Substring(13, 4) + sisi;
                txtPartnoOK.Text = (ddlPartno.SelectedItem.Text.Substring(0, 3) + "-3-" + ddlPartno.SelectedItem.Text.Substring(6, 3) + "0250" + ddlPartno.SelectedItem.Text.Substring(13, 4)).Trim() + sisi + sisi;
                txtPartnoBP.Text = (ddlPartno.SelectedItem.Text.Substring(0, 3) + "-P-" + ddlPartno.SelectedItem.Text.Substring(6, 3) + "0250" + ddlPartno.SelectedItem.Text.Substring(13, 4)).Trim() + sisi + sisi;
            }
            else
            {
                txtQtyTransfer.Text = txtQtyOut.Text;
        ...
        protected void RBBevel_CheckedChanged(object sender, EventArgs e)
        {
            if (RBBevel.Checked == true)
            {
                ...
                RBKali13.Visible = false;
                RBKali14.Visible = false;
                RBKali15.Visible = false; txtPartnoTransfer.Visible = false;
                RBLogistik.Checked = false;
                RBStraping0.Checked = true;
                RBRenovasi.Checked = false;
                RBBevel0.Checked = false;
        ...
        protected void RBKali15_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (RBI99.Checked == true || RBP99.Checked == true)
            {
                ...
                //txtQtyTransfer2.Text = "0";
                //txtPartnoTransfer2.Text = ddlPartno.SelectedItem.Text.Substring(0, 9) +
                //    (Int32.Parse(ddlPartno.SelectedItem.Text.Substring(9, 4)) - 1200).ToString().PadLeft(4, '0') + ddlPartno.SelectedItem.Text.Substring(13, 4) + sisi;
                txtPartnoOK.Text = (ddlPartno.SelectedItem.Text.Substring(0, 3) + "-3-" + ddlPartno.SelectedItem.Text.Substring(6, 3) + "0300" + ddlPartno.SelectedItem.Text.Substring(13, 4)).Trim() + sisi;
                txtPartnoBP.Text = (ddlPartno.SelectedItem.Text.Substring(0, 3) + "-P-" + ddlPartno.SelectedItem.Text.Substring(6, 3) + "0300" + ddlPartno.SelectedItem.Text.Substring(13, 4)).Trim() + sisi;
            }
            else
        ...
        protected void grvMergeHeader_RowCreated(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                HeaderCell.Text = "Renovasi 1";
                HeaderCell.ColumnSpan = 3;
                HeaderGridRow.Cells.Add(HeaderCell);
                HeaderCell = new TableCell();
                HeaderCell.Text = "Runing Saw R1";
                HeaderCell.ColumnSpan = 3;
                HeaderGridRow.Cells.Add(HeaderCell);
                HeaderCell = new TableCell();
                HeaderCell.Text = "Bevel R1";
                HeaderCell.ColumnSpan = 3;
                HeaderGridRow.Cells.Add(HeaderCell);
                HeaderCell = new TableCell();
                HeaderCell.Text = "Straping R1";
                HeaderCell.ColumnSpan = 3;
                HeaderGridRow.Cells.Add(HeaderCell);
        ...
        protected void ChkCnC_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                PanelCnC2.Visible = false; Panel9.Visible = true; Panel1.Visible = true;

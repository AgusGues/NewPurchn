<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProsesListFlankR2.aspx.cs" Inherits="GRCweb1.Modul.Factory.ProsesListFlankR2" %>
        ...
        <ContentTemplate>
            <div id="Div1" runat="server">
                <table width="100%" class="table-responsive">
                    <tr>
                        <td align="left">
                            <strong><span class="auto-style1">PROSES LISTPLANK RENOVASI 2</span></strong>
                        </td>
                        <td align="right">&nbsp;
                        </td>
                    </tr>
                                        ...
                                        <tr>
                                            <td colspan="2" style="font-size: x-small">
                                                ...
                                                <asp:RadioButton ID="RBI99" runat="server" AutoPostBack="True" Checked="True" GroupName="b"
                                                    OnCheckedChanged="RBI99_CheckedChanged" Text="Renovasi 2" />
                                        ...
                                        <tr>
                                            <td align="left" style="font-size: x-small; font-weight: normal;" valign="middle"
                                                ...
                                                <b>Ke Lokasi / Proses selanjutnya =&gt;&nbsp;
                                                    ...
                                                    &nbsp;<b><asp:RadioButton ID="RBRenovasi" runat="server"
                                                        AutoPostBack="True" GroupName="c" OnCheckedChanged="RBRenovasi_CheckedChanged"
                                                        Text="Renovasi 3" />
                                                    </b>
                                                    ...
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            <td align="left" colspan="4" style="font-size: x-small; font-weight: normal;" valign="middle">
                                                                ...
                                                                &nbsp;<asp:Label ID="LabelLokasi" runat="server" Text="Lokasi" Visible="true"></asp:Label><asp:TextBox
                                                                    ID="txtLokasi" runat="server" AutoPostBack="True" BorderStyle="Groove"
                                                                    Height="21px" onfocus="this.select();" ReadOnly="false" Width="48px"></asp:TextBox><cc1:AutoCompleteExtender ID="AutoCompleteExtender7" runat="server"
                                                                        CompletionInterval="200" CompletionSetCount="10" EnableCaching="true" FirstRowSelected="True"
                                                                        MinimumPrefixLength="1" ServiceMethod="GetLokasiStock" ServicePath="AutoComplete.asmx"
                                                                        TargetControlID="txtLokasi">
                                                                    </cc1:AutoCompleteExtender>

                                                                &nbsp;<asp:Label ID="LabelPartnoTCnC" runat="server" Text="Qty" Visible="true"></asp:Label><asp:TextBox

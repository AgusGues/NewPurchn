...
{
    public partial class ProsesListFlankR2 : System.Web.UI.Page
    {
        ...
        private void LoadPartno()
        {
            ...
            if (RBI99.Checked == true)
                tblname = "T1_LR2_listplank";
            if (RBRuningSaw.Checked == true)
                tblname = "T1_LR2_RuningSaw";
            if (RBBevel.Checked == true)
                tblname = "T1_LR2_Bevel";
            if (RBPrint.Checked == true)
                tblname = "T1_LR2_Print";
            if (RBStraping.Checked == true)
                tblname = "T1_LR2_Straping";
        ...
        private void LoadDataTransit()
        {
            ...
            if (RBI99.Checked == true)
                arrT1serah = Serah.RetrieveStockLR2Listplank1(ddlPartno.SelectedItem.Text);
            if (RBRuningSaw.Checked == true)
                arrT1serah = Serah.RetrieveStockLR2RuningSaw(ddlPartno.SelectedItem.Text);
            if (RBBevel.Checked == true)
                arrT1serah = Serah.RetrieveStockLR2Bevel(ddlPartno.SelectedItem.Text);
            if (RBStraping.Checked == true)
                arrT1serah = Serah.RetrieveStockLR2Straping(ddlPartno.SelectedItem.Text);
        ...
        protected void TransferData()
        {
            ...
            T1_LR2_ListPlank T1_LR2listplank = new T1_LR2_ListPlank();
            //T1_LR2_ListPlank2 T1_LR2listplank2 = new T1_LR2_ListPlank2();
            //T1_LR2_ListPlank2Facade T1_LR2listplank2F = new T1_LR2_ListPlank2Facade();
            T1_LR2_RuningSaw T1_LR2runingsaw = new T1_LR2_RuningSaw();
            T1_LR2_RuningSawFacade T1_LR2runingsawF = new T1_LR2_RuningSawFacade();
            T1_LR2_Bevel T1_LR2bevel = new T1_LR2_Bevel();
            T1_LR2_BevelFacade T1_LR2bevelF = new T1_LR2_BevelFacade();
            T1_LR2_Straping T1_LR2straping = new T1_LR2_Straping();
            T1_LR2_StrapingFacade T1_LR2strapingF = new T1_LR2_StrapingFacade();
            T1_SerahFacade serahF = new T1_SerahFacade();
            FC_Items items = new FC_Items();
            FC_ItemsFacade itemsF = new FC_ItemsFacade();
            T1_LR3_ListPlank T1LR3ListPlank = new T1_LR3_ListPlank();
            T1_LR3_ListPlankFacade T1LR3ListPlankF = new T1_LR3_ListPlankFacade();
            ...
            AbstractTransactionFacadeF absTrans = new T1_LR2_ListPlankFacade(T1_LR2listplank);
            for (int i = 0; i <= GridViewtrans0.Rows.Count - 1; i++)
            {
                TextBox txtQtyMutasi = (TextBox)GridViewtrans0.Rows[i].FindControl("txtQtyMutasi");
                if (txtQtyMutasi.Text != string.Empty)
                {
                    ...
                    {
                        items = itemsF.RetrieveByPartNo(txtPartnoTransfer.Text);
                        T1_LR2runingsaw = T1_LR2runingsawF.RetrieveByID(GridViewtrans0.Rows[i].Cells[0].Text);
                        T1_LR2runingsaw.L1ID = Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text);
                        T1_LR2runingsaw.LokasiID0 = dest.GetLokID("I99");
                        T1_LR2runingsaw.ItemID0 = dest.GetPartnoID(GridViewtrans0.Rows[i].Cells[5].Text);
                        T1_LR2runingsaw.ItemID = items.ID;
                        T1_LR2runingsaw.TglTrans = DateTime.Parse(txtTanggal.Text);
                        T1_LR2runingsaw.QtyIn = kali * Convert.ToInt32(txtQtyMutasi.Text);
                        T1_LR2runingsaw.QtyAsal = Convert.ToInt32(txtQtyMutasi.Text);
                        T1_LR2runingsaw.LokasiID = T1_LR2runingsaw.LokasiID0;
                        T1_LR2runingsaw.CreatedBy = users.UserName;
                        absTrans = new T1_LR2_RuningSawFacade(T1_LR2runingsaw);
                        ...
                        if (Panel9.Visible == true)
                        {
                            ...
                            T1_LR2runingsaw.ItemID = items.ID;
                            T1_LR2runingsaw.TglTrans = DateTime.Parse(txtTanggal.Text);
                            T1_LR2runingsaw.QtyIn = Convert.ToInt32(txtQtyMutasi.Text);
                            T1_LR2runingsaw.QtyAsal = 0;
                            T1_LR2runingsaw.LokasiID = T1_LR2runingsaw.LokasiID0;
                            T1_LR2runingsaw.CreatedBy = users.UserName;
                            absTrans = new T1_LR2_RuningSawFacade(T1_LR2runingsaw);
                            intresult = absTrans.Insert(transManager);
                    ...
                    {
                        string Proses = "i99R2"; Session["Proses"] = Proses;
                    ...
                    {
                        items = itemsF.RetrieveByPartNo(txtPartnoTransfer.Text);
                        T1_LR2bevel = T1_LR2bevelF.RetrieveByID(GridViewtrans0.Rows[i].Cells[0].Text);
                        T1_LR2bevel.L1ID = Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text);
                        T1_LR2bevel.LokasiID0 = dest.GetLokID("I99");
                        T1_LR2bevel.ItemID0 = dest.GetPartnoID(GridViewtrans0.Rows[i].Cells[3].Text);
                        T1_LR2bevel.ItemID = items.ID;
                        T1_LR2bevel.TglTrans = DateTime.Parse(txtTanggal.Text);
                        T1_LR2bevel.QtyIn = Convert.ToInt32(txtQtyMutasi.Text);
                        T1_LR2bevel.LokasiID = T1_LR2bevel.LokasiID0;
                        T1_LR2bevel.CreatedBy = users.UserName;
                        absTrans = new T1_LR2_BevelFacade(T1_LR2bevel);
                        intresult = absTrans.Insert(transManager);
                        if (absTrans.Error != string.Empty)
                        {
                            transManager.RollbackTransaction();
                    ...
                    {
                        string Proses = "RsR2"; Session["Proses"] = Proses;
                        items = itemsF.RetrieveByPartNo(ddlPartno.SelectedItem.ToString());
                        T1_Serah serah = new T1_Serah();
                    ...
                    if (RBBevel.Checked == true)
                    {
                        ...
                        if (RBLogistik.Checked == true && RBBP.Checked == true)
                        {
                            ...
                            T1_Serah serah = new T1_Serah();
                            serah = serahF.RetrieveByIDLR2_Bevel(GridViewtrans0.Rows[i].Cells[0].Text);
                        ...
                        {
                            items = itemsF.RetrieveByPartNo(partno);
                            T1LR3ListPlank = T1LR3ListPlankF.RetrieveByID(GridViewtrans0.Rows[i].Cells[0].Text);
                            T1LR3ListPlank.ItemID0 = items.ID;
                            T1LR3ListPlank.LokasiID0 = dest.GetLokID("I99");
                            T1LR3ListPlank.LokasiID = T1LR3ListPlank.LokasiID0;
                            T1LR3ListPlank.L1ID = Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text);
                            T1LR3ListPlank.ItemID = items.ID;
                            T1LR3ListPlank.TglTrans = DateTime.Parse(txtTanggal.Text);
                            T1LR3ListPlank.QtyIn = Convert.ToInt32(txtQtyMutasi.Text);
                            T1LR3ListPlank.QtyOut = 0;
                            T1LR3ListPlank.HPP = 0;
                            T1LR3ListPlank.CreatedBy = users.UserName;
                            AbstractTransactionFacadeF absTrans1 = new T1_LR3_ListPlankFacade(T1LR3ListPlank);
                        ...
                        {
                            items = itemsF.RetrieveByPartNo(partno);
                            T1_LR2straping = T1_LR2strapingF.RetrieveByID(GridViewtrans0.Rows[i].Cells[0].Text);
                            T1_LR2straping.L1ID = Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text);
                            T1_LR2straping.LokasiID0 = dest.GetLokID("I99");
                            T1_LR2straping.ItemID0 = dest.GetPartnoID(GridViewtrans0.Rows[i].Cells[3].Text);
                            T1_LR2straping.ItemID = items.ID;
                            T1_LR2straping.TglTrans = DateTime.Parse(txtTanggal.Text);
                            T1_LR2straping.QtyIn = Convert.ToInt32(txtQtyMutasi.Text);
                            T1_LR2straping.LokasiID = T1_LR2straping.LokasiID0;
                            T1_LR2straping.CreatedBy = users.UserName;
                            absTrans = new T1_LR2_StrapingFacade(T1_LR2straping);
                            intresult = absTrans.Insert(transManager);
                            if (absTrans.Error != string.Empty)
                            {
                                transManager.RollbackTransaction();
                    ...
                    if (RBStraping.Checked == true)
                    {
                        ...
                        items = itemsF.RetrieveByPartNo(partno);
                        T1_Serah serah = new T1_Serah();
                        serah = serahF.RetrieveByIDLR2_Print(GridViewtrans0.Rows[i].Cells[0].Text);
                        serah.PartnoSer = partno;
                        serah.PartnoDest = GridViewtrans0.Rows[i].Cells[3].Text;
                        serah.ItemIDSer = items.ID;
                        serah.QtyIn = Convert.ToInt32(txtQtyMutasi.Text);
            ...
            if (rekam == "sukses")
            {
                for (int i = 0; i <= GridViewtrans0.Rows.Count - 1; i++)
                {
                    ...
                    if (txtQtyMutasi.Text != string.Empty)
                    {
                        if (RBI99.Checked == true)
                        {
                            T1_LR2_ListPlankFacade T1_LR2listplankF = new T1_LR2_ListPlankFacade();
                            T1_LR2listplankF.UpdateFail(Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text), Convert.ToInt32(txtQtyMutasi.Text));
                        }
                        if (RBRuningSaw.Checked == true)
                        {
                            T1_LR2_RuningSawFacade T1_LR2RuningSawF = new T1_LR2_RuningSawFacade();
                            T1_LR2RuningSawF.UpdateFail(Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text), Convert.ToInt32(txtQtyMutasi.Text));
                        }
                        if (RBBevel.Checked == true)
                        {
                            T1_LR2bevelF.UpdateFail(Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text), Convert.ToInt32(txtQtyMutasi.Text));
                        }
                        if (RBStraping.Checked == true)
                        {
                            T1_LR2strapingF = new T1_LR2_StrapingFacade();
                            T1_LR2strapingF.UpdateFail(Convert.ToInt32(GridViewtrans0.Rows[i].Cells[0].Text), Convert.ToInt32(txtQtyMutasi.Text));
                        }
                    }
                }
            }
        ...
        private void loadDynamicGrid(string tgl1, string tgl2)
        {
            ...
            "select  * from ( select distinct tanggal tanggal0,partnoasal from  vw_KartuStockListplankR2 AI where CONVERT(char,tanggal,112)>=@tgl1 and CONVERT(char,tanggal,112)<=@tgl2) as P left join   " +
            "(  " +
            "select tanggal,PartNoAsal PartNoAsal0,PartNo,sum(qtyin)qtyin,sum(qtyout)qtyout from (   " +
            "select tanggal,PartNoAsal,PartNo,qty qtyin,0 qtyout from vw_KartuStockListplankR2  where qty>0 and process='i99'   " +
            "union all   " +
            "select tanggal,PartNoAsal,PartNo,0 qtyin,qty*-1 qtyout from vw_KartuStockListplankR2  where qty<0 and process='i99') as i99  " +
            ...
            "select tanggal,PartNoAsal,PartNo,qty qtyin,0 qtyout from vw_KartuStockListplankR2  where qty>0 and process='runingsaw'  " +
            "union all   " +
            "select tanggal,PartNoAsal,PartNo,0 qtyin ,qty*-1 qtyout from vw_KartuStockListplankR2  where qty<0 and process='runingsaw') as runingsaw   " +
            ...
            "select tanggal,PartNoAsal,PartNo,qty qtyin,0 qtyout from vw_KartuStockListplankR2  where qty>0 and process='Bevel'   " +
            "union all   " +
            "select tanggal,PartNoAsal,PartNo,0 qtyin,qty*-1 qtyout from vw_KartuStockListplankR2  where qty<0 and process='Bevel') as Bevel   " +
            ...
            "select tanggal,PartNoAsal,PartNo,qty qtyin,0 qtyout from vw_KartuStockListplankR2  where qty>0 and process='StrapingR2'   " +
            "union all   " +
            "select tanggal,PartNoAsal,PartNo,0 qtyin,qty*-1 qtyout from vw_KartuStockListplankR2  where qty<0 and process='StrapingR2') as straping   " +
        ...
        protected void RBKali15_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (RBI99.Checked == true || RBP99.Checked == true)
            {
                int kali = pengali();
                txtQtyTransfer.Text = (kali * Convert.ToInt32(txtQtyOut.Text)).ToString();
                if (kali == 1) txtQtyTransfer2.Text = "0";
        ...
        protected void grvMergeHeader_RowCreated(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                HeaderCell.Text = "Renovasi 2";
                HeaderCell.ColumnSpan = 3;
                HeaderGridRow.Cells.Add(HeaderCell);
                HeaderCell = new TableCell();
                HeaderCell.Text = "Runing Saw R2";
                HeaderCell.ColumnSpan = 3;
                HeaderGridRow.Cells.Add(HeaderCell);
                HeaderCell = new TableCell();
                HeaderCell.Text = "Bevel R2";
                HeaderCell.ColumnSpan = 3;
                HeaderGridRow.Cells.Add(HeaderCell);
                HeaderCell = new TableCell();
                HeaderCell.Text = "Straping R2";
                HeaderCell.ColumnSpan = 3;
                HeaderGridRow.Cells.Add(HeaderCell);

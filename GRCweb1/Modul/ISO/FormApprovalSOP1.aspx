<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormApprovalSOP1.aspx.cs" Inherits="GRCweb1.Modul.ISO.FormApprovalSOP1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function updatePES(id) {
                window.showModalDialog("../../ModalDialog/UnApprovePES.aspx?p=" + id, "ISO PES", "resizable:yes;dialogHeight: 400px; dialogWidth: 517px;scrollbars:no;");
            }
                                        ...
                                        <tr>
                                            <td style="width: 100%; height: 49px">
                                                <table class="nbTableHeader">
                                                    <tr>
                                                        <td style="width: 100%">
                                                            <%--<strong>&nbsp;APPROVAL <%=(Request.QueryString["p"]==null)?"SOP":Request.QueryString["p"].ToString() %></strong>--%>
                                                        </td>
                                                        <td style="width: 75px">&nbsp;
                                                        </td>
                                                        <td style="width: 75px">
                                                        ...
                                                        <td style="width: 5px">
                                                            <input id="btnUpdate" runat="server" onserverclick="btnUpdate_ServerClick"
                                                                cssclass="btn btn-primary btn-sm" type="button" value="Approve" disabled="true" />
                                                        </td>
                                                        <td style="width: 5px">
                                                            <input id="btnUnUpdate" runat="server" onserverclick="btnUnUpdate_ServerClick" cssclass="btn btn-primary btn-sm"
                                                        ...
                                                        <td style="width: 70px">
                                                            <input id="btnList" runat="server" cssclass="btn btn-primary btn-sm"
                                                        ...
                                                        <td style="width: 70px">
                                                            <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control input-sm" Width="128px"></asp:TextBox>
                                                        </td>
                                                        <td style="width: 70px">
                                                    ...
                                                    <table class="tblForm" id="Table4" style="width: 100%; font-size: x-small; border-collapse: collapse; display: block">
                                                        <tr>
                                                            ...
                                                            <td style="width: 196px;">
                                                                <asp:TextBox ID="txtTaskNo" runat="server" AutoPostBack="True" ReadOnly="True" CssClass="form-control input-sm" Width="233px"></asp:TextBox>
                                                                <asp:TextBox ID="txtID" runat="server" Visible="false"></asp:TextBox>
                                                            </td>
                                                            <td style="height: 3px; width: 154px;">&nbsp; PIC
                                                            </td>
                                                            <td style="width: 245px;">
                                                                <asp:TextBox ID="txtPic" runat="server" CssClass="form-control input-sm" AutoPostBack="True" ReadOnly="True" Width="233px"></asp:TextBox>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 196px;">
                                                                <%--<cc1:CalendarExtender ID="CalendarExtender2" TargetControlID="txtTglMulai" Format="dd-MMM-yyyy" runat="server"></cc1:CalendarExtender>--%>
                                                ...
                                                <div>
                                                    ...
                                                    <table style="width: 100%; border-collapse: collapse; font-size: medium">
                                                        <tr>
                                                            ...
                                                            <td style="width: 10%">PIC Name</td>
                                                            <td style="width: 35%">
                                                                <asp:TextBox Width="90%" CssClass="form-control input-sm" ReadOnly="true" ID="txtPICname" runat="server"></asp:TextBox></td>
                                                            <td style="width: 40%">
                                                                <asp:TextBox ID="txtUserID" runat="server" Visible="false"></asp:TextBox></td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;</td>
                                                            <td>Jabatan</td>
                                                            <td>
                                                                <asp:TextBox ID="txtJabatan" CssClass="form-control input-sm" runat="server" Width="75%" ReadOnly="true"></asp:TextBox></td>
                                                            <td>
                                                                <asp:HiddenField ID="txtJabatanID" runat="server" />
                                                            </td>
                                                        </tr>
                                                        <%--<tr>
                                        <td>&nbsp;</td>
                                        <td>Periode</td>
                                        <td><asp:TextBox ID="txtPeriode" runat="server" ReadOnly="true"></asp:TextBox></td>
                                        <td>&nbsp;</td>
                                    </tr>--%>
                                                    </table>
                                                    <hr />
                                                                        ...
                                                                        <asp:Repeater ID="lstRkp" runat="server" OnItemDataBound="lstRkp_DataBound">
                                                                            <ItemTemplate>
                                                                                <tr class=" EvenRows baris">
                                                                                    ...
                                                                                    <%-- <td class="kotak tengah"> <asp:ImageButton ID="edit" runat="server" ImageUrl="~/images/clipboard_16.png" CommandArgument='<%# Eval("ID") %>'
                                                                    CommandName="Edit" Visible="false"  ToolTip="Tambah Alasan UnApprove" />
                                                                <asp:ImageButton ID="simpan" runat="server" ImageUrl="~/images/Save_blue.png" CommandArgument='<%# Eval("ID") %>'
                                                                    CommandName="Save" Visible="false" /></td>--%>
                                            ...
                                            <tr class="OddRows baris">
                                                ...
                                                <td class="kotak"><%# Eval("SOPName") %></td>
                                                <td class="kotak tengah"><%# Eval("BobotNilai", "{0:N0}")%>%</td>
                                                <td class="kotak tengah"><%# Eval("Jan","{0:N0}") %></td>
                                                <td class="kotak tengah"><%# Eval("JanS", "{0:N0}")%></td>
                                                <td class="kotak tengah"><%# Eval("Feb", "{0:N0}")%></td>
                                                <td class="kotak tengah"><%# Eval("FebS", "{0:N0}")%></td>
                                            </tr>
                                            </AlternatingItemTemplate>--%>
                                                                        </asp:Repeater>

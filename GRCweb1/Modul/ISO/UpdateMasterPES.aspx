...
<ContentTemplate>
                                ...
                                <table style="width: 100%; font-size: x-small; border-collapse: collapse">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:ListItem Value="0">--PilihPes--</asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    meta:resourcekey="ddlPICResource1" OnSelectedIndexChanged="ddlPIC_SelectedIndexChanged">
                                        <asp:ListItem Value="0">--PilihPic--</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td>
                                &nbsp
                        ...
                        <div id="lst" runat="server">
                            ...
                            <thead>
                                <tr class=" tbHeader baris">
                                    <th class="kotak" rowspan="3" style="width: 20%">
                                        No.
                                    </th>
                                    ...
                                    <th class="kotak" rowspan="2" colspan="2" style="width: 40%">
                                        Description
                                    </th>
                                    <th class="kotak" rowspan="2" colspan="2" style="width: 20%">
                                        Target
                                    </th>
                                    <th class="kotak" rowspan="2" colspan="2" style="width: 20%">
                                        Bobot (%)
                                    </th>
                                    <th class="kotak" rowspan="2" colspan="3" style="width: 20%">
                                        Program Checking
                                    </th>
                                    <th class="kotak" colspan="4" style="width: 20%">
                                        Pencapaian
                                    </th>
                                    <th class="kotak" rowspan="2" colspan="2" style="width: 40%">
                                        Verifikasi________________
                                    </th>
                                    <th class="kotak" rowspan="3" style="width: 20%">
                                        Action
                                    </th>
                                ...
                                <tr class="tbHeader baris">
                                    <th class="kotak" colspan="2" style="width: 10%">
                                        Target
                                    </th>
                                    <th class="kotak" colspan="2" style="width: 10%">
                                        Score
    ...
    <tr class=" tbHeader baris">
        <td class="kotak" rowspan="3" style="width: 4%">
        ...
        <td class="kotak" rowspan="2" colspan="2" style="width: 40%">

        </td>
        <td class="kotak" rowspan="2" colspan="2" style="width: 12%">
        ...
        <td class="kotak" rowspan="2" colspan="3" style="width: 12%">

        </td>
        <td class="kotak" colspan="4" style="width: 12%">

        </td>
        <td class="kotak" rowspan="2" colspan="2">
...
<table>
    <tr>
        ...
        <tr class=" tbHeader baris">
            <th class="kotak" rowspan="3" style="width: 4%">
                No.
            </th>
            <%--<th class="kotak" rowspan="3" style="width:4%" visible="false"></th>--%>
            <th class="kotak" rowspan="3" style="width: 4%">
            ...
            <th class="kotak" rowspan="2" colspan="2" style="width: 12%">
                Target
            </th>
            <th class="kotak" rowspan="2" colspan="2" style="width: 5%">
                Bobot (%)
            </th>
            <th class="kotak" rowspan="2" colspan="2" style="width: 12%">
                Program Checking
            </th>
            <th class="kotak" colspan="4" style="width: 12%">
                Pencapaian
            </th>
        </tr>
        <tr class="tbHeader baris">
...
<tr class="EvenRows baris" valign="top">
    ...
    <td class="kotak tengah" rowspan="5">
        <asp:Label ID="lblPic" runat="server" Text="____"></asp:Label>
        <div style="padding:2px;"></div>
        <asp:DropDownList ID="ddlAutoLink" runat="server" AutoPostBack="True" Width="200px"
        meta:resourcekey="ddlAutoLink1">
            <asp:ListItem Value="0">Pilih AutoLink</asp:ListItem>
        </asp:DropDownList>
</td>
<td class="kotak tengah" rowspan="5">

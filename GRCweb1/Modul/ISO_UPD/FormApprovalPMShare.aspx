<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormApprovalPMShare.aspx.cs" Inherits="GRCweb1.Modul.ISO_UPD.FormApprovalPMShare" %>
    ...
    <div id="div1" runat="server" class="table-responsive" style="width:100%">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <span>Approval Share Upd</span>
                <div class="pull-right">
                    <asp:Button class="btn btn-info" ID="btnPrev" runat="server" Text="<-Prev" Enabled="false" 
                    OnClick="btnPrev_Click"/>
                    <asp:Button class="btn btn-info" ID="btnApprove" runat="server" Text="Ikut" 
                    OnClick="btnApprove_Click" />
                    <asp:Button class="btn btn-info" ID="btnNotApprove" runat="server" Text="Tidak Ikut" Enabled="false"
                    OnClick="btnNotApprove_Click" />
                    <asp:Button class="btn btn-info" ID="btnNext" runat="server" Text="Next->" 
            ...
            <div class="panel-body">
                        ...
                        <tr>
                            ...
                            <td style="width: 40%">
                                <table style="width: 100%">
                                    <tr style="width: 100%">
                                        <%--<td style="width: 20%">
                                        <asp:Label ID="LabelInfoShare" runat="server" Style="font-family: 'Agency FB'; font-size: small; font-weight: 700" Visible="True">&nbsp; Kembali Ke Approval Dokumen</asp:Label></td>--%>
                                        <td style="height: 3px; width: 100%;" valign="top" class="text-right">
                                            <asp:RadioButton ID="RBNotShare" runat="server" AutoPostBack="True" GroupName="a"
                                            OnCheckedChanged="RBNotShare_CheckedChanged" 
                                            Text="Kembali Ke Approval Dokumen >>" TextAlign="Left"
                                            Width="220px" /></asp:RadioButton>
                                        </td>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <asp:TextBox class="form-control" width="100%" ID="txtNoS" runat="server" Visible="true" ReadOnly="true"></asp:TextBox>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <asp:Label ID="LabelDibuatOleh" runat="server" Visible="true">Distribusi Oleh</asp:Label>
                                </div>
                                <div class="col-md-8">
                                    <asp:TextBox class="form-control" width="100%" ID="txtDibuatOleh" runat="server" Visible="true" ReadOnly="true"></asp:TextBox>
                                    <div style="padding: 2px;"></div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <asp:Label ID="LabelTglPengajuan" runat="server" Visible="true">Tgl. Distribusi</asp:Label>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <asp:TextBox class="form-control" ID="txtAlasan" runat="server" TextMode="MultiLine" Rows="6" Visible="true"
                ...
                <div>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <asp:Label ID="LabelNoDok" runat="server" Visible="true">NoDokument</asp:Label>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:Label ID="LabelNamaDok1" runat="server" Visible="true">NamaDokument :</asp:Label>
                                </div>
                                <div class="col-md-12">
                                    <asp:TextBox class="form-control" ID="txtNamDok1" runat="server" Rows="1" Visible="true"
                                    ReadOnly="true"></asp:TextBox>
                                    <div style="padding:2px;"></div>
                                </div>
                            </div>
                ...
                <div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    font-weight: 700" Visible="true">&nbsp; REVISI KE </asp:Label>
                                </div>
                                <div class="col-md-8">
                                    <asp:TextBox class="form-control" ID="txtRevisi" runat="server" Visible="true" ReadOnly="true"></asp:TextBox>
                                    <div style="padding:2px;"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    font-weight: 700" Visible="true">&nbsp; Alasan Cancel </asp:Label>
                                </div>
                                <div class="col-md-8">
                                    <asp:TextBox class="form-control" ID="txtAlasanCancel" runat="server" TextMode="MultiLine" Rows="4" Visible="true" ></asp:TextBox>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:Label ID="Label8" runat="server" Visible="true">Lampiran :</asp:Label>
                                    <asp:Label ID="Label21" runat="server" Visible="true">&nbsp; </asp:Label>
                                    <div style="padding:2px;"></div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    OnRowDataBound="GridView4_RowDataBound" Style="font-family: 'Courier New', Courier, monospace;" GridLines="None" ShowHeader="False">
                                    <Columns>
                ...
                <div style="overflow: hidden" class="table-responsive">
                    <table style="width: 100%; border-collapse: collapse;">
                        <tr>
                            <td style="width: 100%; font-family: 'Agency FB'; font-size: small;color: #FFFFFF;" bgcolor="#9900CC" align="center">
                                <table>
                                    <tr>
                                        <td style="width: 100%; color: #000000; font-family: 'Agency FB'; font-weight: bold;"; align="center">
                                            .:: Preview Dokumen Lampiran ::.
                                        </td>                                            
                                    </tr>
                                </table>
                            </td>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LapBulHarianA.aspx.cs" Inherits="GRCweb1.Modul.ListReport.LapBulHarianA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Cetak() {
            MyPopUpWin("../Report/Report.aspx?IdReport=RekapLapHarian", 900, 800)
        }
    </script>
                                    ...
                                    <table class="tblForm" id="Table4" style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 169px; height: 19px">
                                                <cc1:CalendarExtender ID="CalendarExtender1" TargetControlID="txtFromPostingPeriod"
                                                    Format="dd-MMM-yyyy" runat="server" EnableViewState="true"></cc1:CalendarExtender>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 204px; height: 19px;">
                                                ...
                                                <asp:Button ID="btnPrint" runat="server" Text="Preview" OnClick="btnPrint_ServerClick" />
                                            </td>
                                            <td style="width: 169px; height: 19px">&nbsp;
                                            </td>
                                            <td style="width: 209px; height: 19px">&nbsp;

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DefectPerLine.aspx.cs" Inherits="GRCweb1.Modul.ListReportDefect.DefectPerLine" %>
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:TextBox ID="txtdrtanggal" runat="server" AutoPostBack="True" Height="21px" Width="151px"
                    OnTextChanged="txtdrtanggal_TextChanged"></asp:TextBox>
                ...
                <asp:TextBox ID="txtsdtanggal" runat="server" AutoPostBack="True" Height="21px" Width="151px"
                    OnTextChanged="txtsdtanggal_TextChanged"></asp:TextBox>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LASimetris.aspx.cs" Inherits="GRCweb1.Modul.ListReportT1T3.LASimetris" %>
            ...
            <head>
                ...
                <script src="../../assets/jquery-confirm-v3.3.4/js/jquery-confirm.js" type="text/javascript"></script>
                    ...
                    <script type="text/javascript">
                        ...
                        function Cetak() {
                            MyPopUpWin("../ReportT1T3/Report.aspx?IdReport=LASimetris", 600, 1200)
                        }
                    </script>
            </head>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">LAPORAN HARIAN ASIMETRIS</h3>
                            </div>
                            <div class="panel-body">
                                <div class="col-xs-12 col-sm-6">
                                    <div class="row">
                                        ...
                                        <span>
                                            <asp:RadioButton ID="RBTgl0" runat="server" GroupName="a" Text="Tgl. Potong"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <asp:TextBox ID="txtFromPostingPeriod" runat="server" class="form-control" Width="233"

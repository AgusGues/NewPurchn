...
{
    public partial class LASimetris : System.Web.UI.Page
    {
        ...
        protected void btnPrint_ServerClick(object sender, EventArgs e)
        {
            ...
            if (RBTgl.Checked == true)
                strQuery = reportFacade.ViewLASimetris(periodeAwal, periodeAkhir, 1);
            else
                strQuery = reportFacade.ViewLASimetris(periodeAwal, periodeAkhir, 0);
        ...
        {
            //string myScript = "var wn = window.showModalDialog('../../ReportT1T3/Report.aspx?IdReport=LASimetris', '', 'resizable:yes;dialogHeight: 600px; dialogWidth: 1200px;scrollbars=yes');";

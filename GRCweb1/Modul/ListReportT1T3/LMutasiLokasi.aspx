<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LMutasiLokasi.aspx.cs" Inherits="GRCweb1.Modul.ListReportT1T3.LMutasiLokasi" %>
            ...
            <head>
                ...
                <script src="../../assets/jquery-confirm-v3.3.4/js/jquery-confirm.js" type="text/javascript"></script>
                    ...
                    <script type="text/javascript">
                        ...
                        function Cetak() {
                            MyPopUpWin("../ReportT1T3/Report.aspx?IdReport=LMutasiLokasi", 900, 800)
                        }
                    </script>
            </head>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">LAPORAN MUTASI LOKASI</h3>
                            </div>
                            <div class="panel-body">
                                <div class="col-xs-12 col-sm-6">
                                    <div class="row">
                                        <span>
                                            <asp:RadioButton ID="RBTgl" runat="server" Checked="True" Style="margin:10px" GroupName="a" Text="Tgl. Transaksi"
                                                ToolTip="Tanggal Input Data" />
                                        </span>
                                        <span>
                                            <asp:RadioButton ID="RBTgl0" runat="server" GroupName="a" Text="Tgl. Potong" ToolTip="Tanggal Potong Stock" />
                                        </span>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">

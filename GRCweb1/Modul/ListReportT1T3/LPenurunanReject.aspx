<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LPenurunanReject.aspx.cs" Inherits="GRCweb1.Modul.ListReportT1T3.LPenurunanReject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <script type="text/javascript">
       ...
       function Cetak() {
           MyPopUpWin("../ReportT1T3/Report.aspx?IdReport=PenurunanReject", 900, 800)
       }
       function Cetak2() {
           MyPopUpWin("../ReportT1T3/Report.aspx?IdReport=LPemantauan4mm", 900, 800)
       }
   </script>
       </head>
        ...
        <div class="row">
            <div class="col-xs-12 col-xs-12 form-group-sm">
                <div class="panel panel-primary">   
                    <div class="panel-heading">LAPORAN REJECT PRODUK</div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LProduktifitasOutput.aspx.cs" Inherits="GRCweb1.Modul.ListReportT1T3.LProduktifitasOutput" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <table style="width: 100%; font-size: x-small;" bgcolor="#CCCCCC">
                <tr>
                    <td colspan="2">PENCAPAIAN PRODUKTIFITAS
                    </td>
                </tr>
                <tr>
                    <td>Bulan
                ...
                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Preview" />
                        ...
                        <asp:Button ID="Button5" runat="server" OnClick="Button5_Click" Text="Posting" />
                    </td>
                    <td align="right">
                                ...
                                <tr>
                                    <div class="contentlist" id="lst" runat="server" onscroll="setScrollPosition(this.scrollTop);">
                                        <table style="width: 100%; border-collapse: collapse; font-size: x-small" border="0"
                                            ...
                                            <thead>
                                                <tr class="tbHeader">
                                                    <th rowspan="1" style="width: 5%" class="kotak">ID
                                                    </th>
                                                    <th rowspan="1" style="width: 5%" class="kotak">Line
                                                    </th>
                                                    <th style="width: 10%" class="kotak">GP
                                                    </th>
                                                    <th style="width: 10%" class="kotak">Waktu(Menit)
                                                    </th>
                                                    <th rowspan="1" style="width: 10%" class="kotak">Ketebalan
                                                    </th>
                                                    <th rowspan="1" style="width: 10%" class="kotak">Target(M3)
                                                    </th>
                                                    <th rowspan="1" style="width: 10%" class="kotak">Produktifitas(M3)
                                                    </th>
                                                    <th colspan="1" style="width: 10%" class="kotak">Produktifitas(M3/Shift)
                                                    </th>
                                                    <th rowspan="1" style="width: 10%">konversi
                                                    </th>
                                                    <th rowspan="1" style="width: 10%">Persen
                                                    </th>
                                                    <th rowspan="1" style="width: 10%">stdTarget
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="OddRows baris" style="font-weight: bold">
                                                            ...
                                                            <td class="kotak" style="width: 10%">
                                                                <%# Eval("ProduktifitasM3")%>
                                                            </td>
                                                            <td class="kotak tengah" style="width: 10%">
                                                                <%# Eval("ProduktifitasM3Shift")%>
                                                            </td>
                                                            <td class="kotak tengah" style="width: 10%">
                                                                <%# Eval("konversi")%>
                                                            </td>
                                    ...
                                    <td>
                                        <asp:GridView ID="GridEdit" runat="server" AutoGenerateColumns="False" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Persen" HeaderText="Persen" />
                                ...
                                <div style="overflow: scroll;" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                    ...
                                    <asp:Panel ID="Panel2" runat="server" Font-Size="X-Small" Visible="False">
                                        <table style="width: 100%; font-size: x-small;">
                                            ...
                                            <tr>
                                                <td style="height: 19px" width="10%">&nbsp; Grand Total
                                                </td>
                                                <td align="right" style="height: 19px">
                                                    <asp:Label ID="LblTgl2" runat="server"></asp:Label>
                                                </td>
                                                <td style="height: 19px">mm
                                                </td>
                                                <td style="height: 19px">&nbsp;
                                                </td>
                                                <td style="height: 19px">&nbsp;
                                                ...
                                                <td style="height: 19px" colspan="4">Dibuat :
                                                </td>
                                                <td style="height: 19px">&nbsp;
                                                </td>
                                                <td colspan="4" style="height: 19px">Disetujui :
                                                </td>
                                                <td colspan="2" style="height: 19px" width="20%">&nbsp; Mengetahui :
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp; Total Hari Kerja
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">&nbsp;<asp:Label ID="LblTgl5" runat="server"></asp:Label>
                                                </td>
                                                <td>m3
                                                </td>
                                                <td>&nbsp;
                                                ...
                                                <td colspan="4">Maulana Yusuf
                                                </td>
                                                <td>&nbsp;
                                                </td>
                                                <td colspan="4">Linda Kusumastutie
                                                </td>
                                                <td colspan="2">&nbsp; Ir. Makruf N
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LStockCuring.aspx.cs" Inherits="GRCweb1.Modul.ListReportT1T3.LStockCuring1" %>
            ...
            <head>
                ...
                <script src="../../assets/jquery-confirm-v3.3.4/js/jquery-confirm.js" type="text/javascript"></script>
                    ...
                    <script type="text/javascript">
                        ...
                        function Cetak() {
                            MyPopUpWin("../ReportT1T3/Report.aspx?IdReport=LT1SaldoPerLokasi", 900, 800)
                        }
                        function Cetak1() {
                            MyPopUpWin("../ReportT1T3/Report.aspx?IdReport=LT1SaldoPerLokasiDet", 900, 800);
                        }
                        function Cetak2() {
                            MyPopUpWin("../ReportT1T3/Report.aspx?IdReport=LT1SaldoPerLokasiPeta", 900, 800);
                        }
                    </script>
            </head>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="col-xs-12 col-sm-12">
                                    <div class="row">
                                        <span>
                                            <asp:RadioButton ID="RBTgl" runat="server" Style="margin: 10px" AutoPostBack="True"
                                                Checked="True" Font-Size="X-Small" GroupName="a" OnCheckedChanged="RBTgl_CheckedChanged"
                                                Text="Rekap Pemetaan per Lokasi" />
                                        </span>
                                        <span>
                                            <asp:RadioButton ID="RBBln0" runat="server" Style="margin: 10px" AutoPostBack="True" Font-Size="X-Small"
                                                GroupName="a" OnCheckedChanged="RBBln_CheckedChanged" Text="Stock Curing Detail" />
                                        </span>
                                        <span>
                                            <asp:RadioButton ID="RBBln1" runat="server" Style="margin: 10px" AutoPostBack="True" Font-Size="X-Small"
                                                GroupName="a" OnCheckedChanged="RBBln_CheckedChanged" Text="Stock Jemur Detail" />
                                        </span>
                                        <span>
                                            <asp:RadioButton ID="RBBln2" runat="server" AutoPostBack="True" Font-Size="X-Small"
                                                GroupName="a" OnCheckedChanged="RBBln2_CheckedChanged" Text="Pemantauan Produksi Harian" />
                                        </span>
                                    </div>

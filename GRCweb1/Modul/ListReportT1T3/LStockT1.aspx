<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LStockT1.aspx.cs" Inherits="GRCweb1.Modul.ListReportT1T3.LStockT1" %>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">LAPORAN STOCK TAHAP 1</h3>
                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <asp:TextBox ID="txtNoProduksi" runat="server" AutoPostBack="True" class="form-control"
                                                    OnTextChanged="txtNoProduksi_TextChanged" Width="200px"></asp:TextBox>

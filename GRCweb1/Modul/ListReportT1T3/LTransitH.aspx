<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LTransitH.aspx.cs" Inherits="GRCweb1.Modul.ListReportT1T3.LTransitH" %>
            ...
            <head>
                ...
                <script src="../../assets/jquery-confirm-v3.3.4/js/jquery-confirm.js" type="text/javascript"></script>
                    ...
                    <script type="text/javascript">
                        ...
                        function Cetak() {
                            MyPopUpWin("../ReportT1T3/Report.aspx?IdReport=LTransitH", 900, 800)
                        }
                    </script>
            </head>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">LAPORAN HARIAN TRANSIT OUT</h3>
                            </div>
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <asp:TextBox ID="txtFromPostingPeriod1" runat="server" AutoPostBack="True" BorderStyle="Groove"
                                                Visible="False" Width="233"></asp:TextBox>
                                            <cc1:CalendarExtender ID="txtFromPostingPeriod1_CalendarExtender" runat="server"
                                                Format="dd-MMM-yyyy" TargetControlID="txtFromPostingPeriod1"></cc1:CalendarExtender>
                                            </span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <span>
                                                                                            <asp:TextBox ID="txtToPostingPeriod1" runat="server" AutoPostBack="True" BorderStyle="Groove"
                                                Visible="False" Width="233"></asp:TextBox>
                                            <cc1:CalendarExtender ID="txtToPostingPeriod1_CalendarExtender" runat="server" Format="dd-MMM-yyyy"
                                                TargetControlID="txtToPostingPeriod1"></cc1:CalendarExtender>
                                            </span>
                                            <div style="padding: 2px"></div>
                                        </div>
                                    </div>

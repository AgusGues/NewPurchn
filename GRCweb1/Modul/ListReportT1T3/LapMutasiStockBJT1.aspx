<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LapMutasiStockBJT1.aspx.cs" Inherits="GRCweb1.Modul.ListReportT1T3.LapMutasiStockBJT1" %>
            ...
            <head>
                ...
                <script src="../../assets/jquery-confirm-v3.3.4/js/jquery-confirm.js" type="text/javascript"></script>
                    ...
                    <script type="text/javascript">
                        ...
                        function Cetak() {
                            MyPopUpWin("../ReportT1T3/Report.aspx?IdReport=LMutasiBJT1", 900, 800)
                        }
                        function Cetak1() {
                            MyPopUpWin("../ReportT1T3/Report.aspx?IdReport=LMutasiBJT1Rekap", 900, 800);
                        }
                    </script>
            </head>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">LAPORAN MUTASI STOCK BARANG JADI TAHAP 1</h3>
                            </div>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <asp:Panel ID="Panel3" runat="server" Width="280px">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox ID="txtTahun" runat="server" Width="132px" class="form-control" ontextchanged="txtTahun_TextChanged"></asp:TextBox></td>
                                                <div style="padding: 2px"></div>
                                            </div>
                                        </div>
                                    </asp:Panel>

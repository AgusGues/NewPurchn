...
{
    public partial class LapMutasiStockBJT1 : System.Web.UI.Page
    {
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (RBBulanan.Checked == true)
                {
                    ...
                    {
                        strQuery = reportFacade.ViewMutasiBJT1DetRekapKonversi(thnbln, strQtyLastMonth, strQtyMonth);
                ...
                else
                {
                    ...
                    //if (RBNormal.Checked == true)
                    //{
                    strQuery = reportFacade.ViewMutasiBJT1DetRekapHarian(intTanggal, intTanggal0, strHQtyLastMonth, strQtyMonth);
        ...
        {
            //string myScript = "var wn = window.showModalDialog('../../ReportT1T3/Report.aspx?IdReport=LMutasiBJT1', '', 'resizable:yes;dialogHeight: 600px; dialogWidth: 1200px;scrollbars=yes');";

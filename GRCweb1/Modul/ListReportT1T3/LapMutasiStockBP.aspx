<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LapMutasiStockBP.aspx.cs" Inherits="GRCweb1.Modul.ListReportT1T3.LapMutasiStockBP" %>
            ...
            <head>
                ...
                <script src="../../assets/jquery-confirm-v3.3.4/js/jquery-confirm.js" type="text/javascript"></script>
                    ...
                    <script type="text/javascript">
                        ...
                        function Cetak() {
                            MyPopUpWin("../ReportT1T3/Report.aspx?IdReport=LMutasiBP", 900, 800)
                        }
                        function Cetak1() {
                            MyPopUpWin("../ReportT1T3/Report.aspx?IdReport=LMutasiBPRekap", 900, 800);
                        }
                    </script>
            </head>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">LAPORAN MUTASI STOCK BARANG POTONG</h3>
                            </div>
                            <div class="panel-body">
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <asp:Panel ID="Panel3" runat="server" Width="280px">
                                        <div class="row">
                                            <asp:TextBox ID="txtPartno" runat="server" AutoPostBack="True" BorderStyle="Groove"
                                                    Font-Size="X-Small" Height="23px" Width="224px" Visible="False"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label for="form-field-9" style="font-size: 14px">Departemen</label>
                                        </div>
                                        <div class="col-md-9">
                                            <asp:DropDownList ID="ddDept" runat="server" class="form-control" Width="132px"

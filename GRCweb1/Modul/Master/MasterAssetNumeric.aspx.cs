...
{
    public partial class MasterAssetNumeric : System.Web.UI.Page
    {
        ...
        private void LoadLokasi()
        {
            ...
            foreach (DomainAsset NewAsset in arrGroup)
            {
        ...
        protected void ddlIndukAsset_Change(object sender, EventArgs e)
        {
            ...
            //DomainAsset domain1 = facadeKodePlant.GetLastNumKomponen( ddlIndukAsset.SelectedItem.ToString().Substring(0,15) );
        ...
        protected void LoadDataUrutan()
        {
            ...
            string urut = string.Empty;
            FacadeAsset facadeKodePlant = new FacadeAsset();
            DomainAsset domain1 = facadeKodePlant.GetLastNumKomponen(ddlIndukAsset.SelectedItem.ToString().Substring(0, Convert.ToInt32(query)));
            if (int.Parse(domain1.ItemKode) > 0)
                urut = (int.Parse(domain1.ItemKode) + 1).ToString().PadLeft(3, '0');
            else
                urut = "001";
        ...
        protected void txtClassAsset_Change(object sender, EventArgs e)
        {
            ...
            DomainAsset DCekClassID = new DomainAsset();
            ...
            DomainAsset DCekKode2 = new DomainAsset();
        ...
        protected void txtCLassNew_Change(object sender, EventArgs e)
        {
            ...
            //DomainAsset DCekSubClassID = new DomainAsset();
            ...
            {
                DomainAsset DCekSubClass = new DomainAsset();
            ...
            else if (ddlJenis.SelectedItem.ToString().Trim() == "TUNGGAL")
            {
                ...
                DomainAsset DCekAssetTunggal = new DomainAsset();
                ...
                else if (DCekAssetTunggal.NamaAsset == null)
                {
                    ...
                    //txtLeadTime.Enabled = true;
                    DomainAsset DCekAssetTNoUrut0 = new DomainAsset();
                    ...
                    DomainAsset DCekAssetTNoUrut = new DomainAsset();
        ...
        protected void ddlClasAsset_Change(object sender, EventArgs e)
        {
            ...
            //LoadDeptAsset();        
            Users user = (Users)Session["Users"];
            DomainAsset domain1 = new DomainAsset();
        ...
        protected void ddlSubClassAsset_Change(object sender, EventArgs e)
        {
            ...
            DomainAsset domainNoUrut = new DomainAsset();
            ...
            DomainAsset DCekKodeAsset = new DomainAsset();
            ...
            //AutoCompleteExtender2.ContextKey = ddlSubClassAsset.SelectedItem.ToString().Trim();
            AutoCompleteExtender2.ContextKey = txtClassAsset.Text.Trim();

        }
        //protected void ddlSubClassAsset_Change(object sender, EventArgs e)
        //{
        //    DomainAsset domain1S = new DomainAsset();
        //    FacadeAsset facade1S = new FacadeAsset();
        //    domain1S = facade1S.RetrieveKodeSubClass(Convert.ToInt32(ddlClasAsset.SelectedValue), ddlSubClassAsset.SelectedItem.ToString().Trim());

        //    if (domain1S.KodeSubClass == null)
        //    {
        //        DisplayAJAXMessage(this, "Data SubClass tidak ada, silahkan Hub. IT u/ dilakukan pengecekan !! ");
        //        return;
        //    }

        //    Session["KodeSubClass"] = domain1S.KodeSubClass.ToString();
        //    Session["SubClassID"] = domain1S.SubClassID;

        //    int KodeDeptTemp = Convert.ToInt32(ddlDeptID.SelectedValue);
        //    string KodeDept = (KodeDeptTemp) < 9 ? "0" + KodeDeptTemp.ToString() : KodeDeptTemp.ToString();

        //    string GroupAsset = ddlGroupAsset.SelectedValue.ToString();

        //    int ClassAsset = Convert.ToInt32(ddlClasAsset.SelectedValue);
        //    int SubClassAsset = Convert.ToInt32(ddlSubClassAsset.SelectedValue);

        //    DomainAsset domain2S = new DomainAsset();
        //    FacadeAsset facade2S = new FacadeAsset();
        //    domain2S = facade2S.RetrieveKode(ClassAsset, SubClassAsset);

        //    DomainAsset domainLastAsset = new DomainAsset();
        //    FacadeAsset facadeLastAsset = new FacadeAsset();
        //    int LastAsset = facadeLastAsset.RetrieveLastAsset(KodeDept.Trim(), GroupAsset.Trim(), Session["KodeClass"].ToString().Trim(), Session["KodeSubClass"].ToString().Trim());

        //    // TYambahan
        //    int DeptIDTemp = int.Parse(ddlDeptID.SelectedValue);
        //    string DeptID = (DeptIDTemp) < 10 ? "0" + DeptIDTemp.ToString().Trim() : DeptIDTemp.ToString().Trim();
        //    string Group = ddlGroupAsset.SelectedValue.ToString().Trim();
        //    int ClassTemp = Convert.ToInt32(Session["ClassID"]);
        //    string Class = (ClassTemp) < 10 ? "0" + ClassTemp.ToString().Trim() : ClassTemp.ToString().Trim();
        //    int SubClassTemp = Convert.ToInt32(Session["SubClassID"]);
        //    string SubClass = (SubClassTemp) < 10 ? "0" + SubClassTemp.ToString().Trim() : SubClassTemp.ToString().Trim();

        //    //if (SubClassTemp < 10)
        //    //{
        //    //    string SubClassTemp2 = "00" + SubClassTemp.ToString(); Session["SubClass"] = SubClassTemp2.Trim();
        //    //}
        //    //else if (SubClassTemp > 9 && SubClassTemp < 100)
        //    //{
        //    //    string SubClassTemp2 = "0" + SubClassTemp.ToString(); Session["SubClass"] = SubClassTemp2.Trim();
        //    //}
        //    //else if (SubClassTemp > 99)
        //    //{
        //    //    string SubClassTemp2 = SubClassTemp.ToString(); Session["SubClass"] = SubClassTemp2.Trim();
        //    //}
        //    string KodeAsset = DeptID + "." + Group + "." + Session["KodeClass"].ToString().Trim() + "." + Session["KodeSubClass"].ToString().Trim();

        //    DomainAsset domainKodeAsset = new DomainAsset();
        //    FacadeAsset facadeKodeAsset = new FacadeAsset();
        //    domainKodeAsset = facadeKodeAsset.RetrieveKodeAsset(KodeAsset);

        //    if (domainKodeAsset.Total == 1)
        //    {
        //        //Session["HeadID"] = 1;
        //        txtKodeIndukAsset.Text = ViewState["ddlDeptID"].ToString() + "." + ddlGroupAsset.SelectedValue.ToString() + "." + Session["KodeClass"].ToString().Trim() + "." + Session["KodeSubClass"].ToString().Trim();
        //        txtSubCLass.Text = ddlSubClassAsset.SelectedItem.ToString().Trim();
        //        txtSubCLass.Focus();
        //        txtSubCLass.Enabled = true;
        //    }
        //    else if (domainKodeAsset.Total > 1)
        //    {
        //        int NomorUrut = LastAsset + 1;
        //        //Session["HeadID"] = 0;
        //        if (NomorUrut < 10)
        //        { string NoUrut = "00" + NomorUrut.ToString().Trim(); Session["NoUrut"] = NoUrut; }
        //        else if (NomorUrut > 9 && LastAsset < 100)
        //        { string NoUrut = "0" + NomorUrut.ToString().Trim(); Session["NoUrut"] = NoUrut; }
        //        else if (NomorUrut > 99)
        //        { string NoUrut = NomorUrut.ToString().Trim(); Session["NoUrut"] = NoUrut; }

        //        //txtSubCLass.Text = ddlSubClassAsset.SelectedItem.ToString().Trim();
        //        txtSubCLass.Focus();
        //        txtSubCLass.Enabled = true;

        //        if (domain2S.KodeSubClass != string.Empty)
        //        {
        //            txtKodeIndukAsset.Text = ViewState["ddlDeptID"].ToString() + "." + ddlGroupAsset.SelectedValue.ToString() + "." + Session["KodeClass"].ToString().Trim() + "." + domain2S.KodeSubClass.Trim() + "." + Session["NoUrut"].ToString();

        //        }
        //        else
        //        {
        //            DisplayAJAXMessage(this, " SubClass dari Class" + " " + ":" + " " + ddlClasAsset.SelectedItem.ToString().Trim() + " " + " belum ada ! ");
        //            return;
        //        }
        //    }
        //    // EndTambahan
        ...
        //    //DomainAsset domainLastAsset = new DomainAsset();
        //    //FacadeAsset facadeLastAsset = new FacadeAsset();
        //    //int LastAsset = facadeLastAsset.RetrieveLastAsset(ClassID, domain1S.SubClassID.ToString(),ddlGroupAsset.SelectedValue.ToString());
        ...
        //    //DomainAsset domainLastAsset = new DomainAsset();
        //    //FacadeAsset facadeLastAsset = new FacadeAsset();
        //    //int LastAsset = facadeLastAsset.RetrieveLastAsset(KodeDept.Trim(), GroupAsset.Trim() ,domain2S.KodeClass.Trim(), domain2S.KodeSubClass.Trim());
        ...
        protected void ddlDeptID_Change(object sender, EventArgs e)
        {
            //LoadSubClassAsset();
            Users user = (Users)Session["Users"];
            //txtKodeIndukAsset.Text = ddlGroupAsset.SelectedValue.ToString() + "." + Session["KodeClass"].ToString() + "." + ddlDeptID.SelectedValue.ToString() + ".00.000";
            //txtKodeIndukAsset.Text = ddlDeptID.SelectedValue.ToString().PadLeft(2, '0') + ".0.00.000.000";
            //ViewState["ddlDeptID"] = ddlDeptID.SelectedValue.ToString().PadLeft(2, '0');
        ...
        //private void LoadClassAsset()
        //{
        //    //ddlClasAsset.Enabled = true;
        //    //ddlDeptID.Enabled = true;

        //    ArrayList arrClass = new ArrayList();
        //    FacadeAsset facadeClass = new FacadeAsset();
        //    arrClass = facadeClass.RetrieveClassAsset(Convert.ToInt32(ddlGroupAsset.SelectedValue));
        //    ddlClasAsset.Items.Clear();
        //    ddlClasAsset.Items.Add(new ListItem("-- Pilih Class --", "0"));
        //    foreach (DomainAsset NewClass in arrClass)
        //    {
        //        ddlClasAsset.Items.Add(new ListItem(NewClass.NamaClass, NewClass.ID.ToString()));
        //    } 
        //}

        //private void LoadSubClassAsset()
        //{
        //    ddlSubClassAsset.Enabled = true;

        //    ArrayList arrSubClass = new ArrayList();
        //    FacadeAsset facadeSubClass = new FacadeAsset();
        //    arrSubClass = facadeSubClass.RetrieveSubClassAsset(Convert.ToInt32(ddlClasAsset.SelectedValue), ddlClasAsset.SelectedItem.ToString());
        //    ddlSubClassAsset.Items.Clear();
        //    ddlSubClassAsset.Items.Add(new ListItem("-- Pilih SubClass --", "0"));
        //    foreach (DomainAsset NewSubClass in arrSubClass)
        //    {
        //        ddlSubClassAsset.Items.Add(new ListItem(NewSubClass.NamaSubClass, NewSubClass.ID.ToString()));
        //    }
        //}
        ...
        private void LoadDeptAsset()
        {
            ...
            foreach (DomainAsset Dept in arrDept)
            {
                ddlDeptID.Items.Add(new ListItem(Dept.Department, Dept.DeptID.ToString()));
            }

            //ikutin master Dept aja
            //ddlDeptID.Items.Add(new ListItem("BOARDMILL", "1"));
            //ddlDeptID.Items.Add(new ListItem("FINISHING", "2"));
            //ddlDeptID.Items.Add(new ListItem("MAINTENANCE", "3"));
            //ddlDeptID.Items.Add(new ListItem("LOGISTIK", "4"));
            //ddlDeptID.Items.Add(new ListItem("HRD & GA", "5"));
            //ddlDeptID.Items.Add(new ListItem("QA", "6"));
            //ddlDeptID.Items.Add(new ListItem("IT", "7"));
            //ddlDeptID.Items.Add(new ListItem("TRANSPORTATION", "8"));

            //txtKodeIndukAsset.Text = ddlGroupAsset.SelectedValue.ToString() +"."+ Session["KodeSubClass"].ToString()+"."+ ddlDeptID.SelectedValue.ToString()+".00.000";
        }
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            //    Improvement improvement = improvementFacade.RetrieveById(int.Parse(row.Cells[0].Text));

            //    if (improvement.Approval <= ((Users)Session["Users"]).Apv )
            //    {
        ...
        {
            Response.Redirect("MasterAssetNumeric.aspx");
        }
        ...
        protected void btnSave_ServerClick(object sender, EventArgs e)
        {
            ...
            DomainAsset D1 = new DomainAsset();
            ...
            DomainAsset domainSave = new DomainAsset();
            ...
            //domainSave.NamaAsset = txtCLassNew.Text.Trim().ToUpper() + " " + txtType.Text.Trim() + " " + txtUkuran.Text.Trim() + " " + "Merk:" + " " + txtMerk.Text.Trim() + " " + txtJenis.Text.Trim() + " " + txtPartNumber.Text.Trim();


            if (ddlJenis.SelectedItem.ToString().Trim() == "TUNGGAL")
            {
                //string merk = string.Empty;
                //if (txtMerk.Text == "")
                //{
                //    merk = "";
                //}
        ...
        protected void btnSaveAssetKomp_ServerClick(object sender, EventArgs e)
        {
            ...
            DomainAsset domainCek = new DomainAsset();
            ...
            DomainAsset domainSaveAssetKomponen = new DomainAsset();
        ...
        private void LoadDataAsset()
        {
            ...
            foreach (DomainAsset asset in arrDataAsset)
            {
        ...
        protected void RBLama_CheckedChanged(object sender, EventArgs e)
        {
            ...
            foreach (DomainAsset NewAssetLama in arrAssetLama)
            {
        ...
        private void LoadDeptPIC()
        {
            ...
            foreach (DomainAsset NewDept in arrDept)
            {
...
public class FacadeAsset
{
    ...
    public int InsertAssetUtama(object objDomain)
    {
        try
        {
            objAsset = (DomainAsset)objDomain;
            ...
            int result = da.ProcessData(sqlListParam, "spInsert_AssetForAM");
    ...
    public int InsertKomponenAsset(object objDomain)
    {
        try
        {
            ...
            DataAccess da = new DataAccess(Global.ConnectionString());
            int result = da.ProcessData(sqlListParam, "spInsert_AssetKomponenForAM");
            strError = da.Error;
            return result;
        }
        catch (Exception ex)
    ...
    private DomainAsset GenerateObjectGroupAsset(SqlDataReader sdr)
    {
    ...
    private DomainAsset GenerateObjectClassAsset(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    private DomainAsset GenerateObjectSubClass(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    public DomainAsset RetrieveKodeSubClass(int KodeClass, string NamaClass)
    {
    ...
    private DomainAsset GenerateObjectKodeSubClass(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    public DomainAsset RetrieveKodeClass(string NamaClasss, string GroupAsset)
    {
        string result = string.Empty;
        string StrSql =
    ...
    private DomainAsset GenerateObjectKodeClass(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    public DomainAsset RetrieveKodePlant(string NamaAsset)
    {
    ...
    public DomainAsset GetLastNumKomponen(string itemMaster)
    {
        string hasil = string.Empty;
        string StrSql =
    ...
    private DomainAsset GenerateObjectKodePlant(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    private DomainAsset GenerateObjectDataGrid(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    private DomainAsset GenerateObjectDataGridAT(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    private DomainAsset GenerateObjectDataGridKomponen(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    public ArrayList RetrieveAssetUtama()
    {
        ...
        " from Asset where Head=1 and RowStatus>-1  and LEN(ItemCode)>=" + query + ") as xx inner join Asset B ON B.ItemCode=xx.KodeAsset and B.Head=1 ) as xx1 " +
        " where NamaAsset not in (select NamaAsset from AM_Asset where RowStatus>-1) order by NamaProjectAsset ";
        DataAccess dataAccess = new DataAccess(Global.ConnectionString());
        SqlDataReader sqlDataReader = dataAccess.RetrieveDataByString(strSQL);
        strError = dataAccess.Error;
        arrData = new ArrayList();
    ...
    private DomainAsset GenerateObjectDataAsset(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    private DomainAsset GenerateObjectAssetLama(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    private DomainAsset GenerateObjectLokasi(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    public DomainAsset RetrieveKode(int ClassID, int SubClassID)
    {
        string hasil = string.Empty;
        string StrSql =
    ...
    private DomainAsset GenerateObjectKode(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    public DomainAsset RetrieveKodeAsset(string KodeAsset)
    {
        string hasil = string.Empty;
        string StrSql =
    ...
    //public DomainAsset RetrieveKodeClass(string NamaClass)
    //{
    //    string hasil = string.Empty;
    //    string StrSql =
    ...
    //    return new DomainAsset();
    //}
    private DomainAsset GenerateObjectKode2(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    public DomainAsset RetrieveClass(string Nama, string Group)
    {
        string StrSql =
            //" select COUNT(KodeAsset)NoUrut  from AM_Asset where KodeAsset like'%" + NamaKompAsset + "%' and JenisAsset=2 and RowStatus>-1 ";
    ...
    private DomainAsset GenerateObjectKodeAsset(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    public DomainAsset RetrieveNoUrut(string NamaClasss, string GroupAsset)
    {
        string result = string.Empty;
        string StrSql =
    ...
    private DomainAsset GenerateObjectUrut(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    public DomainAsset RetrieveSubClassNew(string NamaSubClass, string Group)
    {
        string result = string.Empty;
        string StrSql =
    ...
    private DomainAsset GenerateObjectSubClassNew(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
        objAsset.NamaSubClass = sdr["NamaSubClass"].ToString();
        return objAsset;
    ...
    public DomainAsset RetrieveClassID(string NamaClass, string Group)
    {
        string result = string.Empty;
        string StrSql =
    ...
    private DomainAsset GenerateObjectClassID(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
        objAsset.ClassID = Convert.ToInt32(sdr["ClassID"]);
        return objAsset;
    ...
    private DomainAsset GenerateObjectDept2(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
    ...
    private DomainAsset GenerateObjectDept(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
        objAsset.Department = sdr["Department"].ToString();
        objAsset.DeptID = Convert.ToInt32(sdr["DeptID"]);
    ...
    public DomainAsset RetrieveAssetTunggal(string NamaAsset, string Group)
    {
        string result = string.Empty;
        string StrSql =
    ...
    private DomainAsset GenerateObjectAssetTunggal(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
        objAsset.NamaAsset = sdr["NamaAsset"].ToString();
        return objAsset;
    ...
    //public DomainAsset RetrieveAssetTNoUrut(string NamaAsset,string klass,string SubKlass, string Group)
    public DomainAsset RetrieveAssetTNoUrut(string NamaAsset, string klass, string Group)
    {
        string result = string.Empty;
        string StrSql =
    ...
    //public DomainAsset RetrieveAssetTNoUrut0(string NamaAsset, string klass, string SubKlass, string Group)
    public DomainAsset RetrieveAssetTNoUrut0(string NamaAsset, string klass, string Group)
    {
        ...
        else
        {
            ...
            " select COUNT(Total)Total from (select isnull(CAST(SUBSTRING(AMKodeAsset_New," + query + ",3) as Decimal(2)),0)Total from Asset " +
            " where AMgroupID=" + Group + " and AMclassID in (select ID from AM_Class  where NamaClass='" + klass + "' and RowStatus>-1)  ) as xx ";
        }
        string result = string.Empty;
    ...
    private DomainAsset GenerateObjectAssetTNoUrut(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
        objAsset.Total = Convert.ToInt32(sdr["Total"]);
        return objAsset;
    ...
    public DomainAsset RetrieveIDSubClass(string NamaAsset, string klass, string SubKlass, string Group)
    {
        string result = string.Empty;
        string StrSql =
    ...
    private DomainAsset GenerateObjectIDSubClass(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
        objAsset.SubClassID = Convert.ToInt32(sdr["SubClassID"]);
        objAsset.KodeSubClass = sdr["KodeSubClass"].ToString();
    ...
    public DomainAsset RetrieveSClassID(string klass, string SubKlass, string Group)
    {
        string result = string.Empty;
        string StrSql =
    ...
    private DomainAsset GenerateObjectIDSubClass2(SqlDataReader sdr)
    {
        DomainAsset objAsset = new DomainAsset();
        objAsset.SubClassID = Convert.ToInt32(sdr["SubClassID"]);
        return objAsset;

...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RekapTask.aspx.cs" Inherits="GRCweb1.Modul.Pes.RekapTask" %>
		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class=panel-heading>
					<span class="the-title">Rekap Task</span>
				</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-md-6">
							...
							<div class="row">
								...
								<div class="col-md-8">
									<select class="form-control input-sm select2" id="Status" style="width: 100%;"></select>
									<div style="padding: 2px"></div>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-4">PemberiTask</div>
								<div class="col-md-8">
									<input  type="text" class="form-control input-sm" id="PemberiTask" disabled="">
									<div style="padding: 2px"></div>
								</div>
							</div>
						</div>
					...
					<div class="table-responsive table-scroll">
						<table class="table" id="datatable" style="width: 120%;">
							<thead>
								<tr>
									<th style="width: 400px">PicUser</th>
									<th style="width: 300px">TaskNo</th>
									<th style="width: 500px">TaskName</th>
									<th style="width: 200px">TglMulai</th>
									<th style="width: 200px">Target1</th>
									<th style="width: 200px">Target2</th>
									<th style="width: 200px">Target3</th>
									<th style="width: 200px">Target4</th>
									<th style="width: 200px">Target5</th>
									<th style="width: 200px">Target6</th>
									<th style="width: 200px">TglSelesai</th>
									<th style="width: 10px">Bobot</th>
									<th style="width: 10px">Point</th>
...
<script src="../../Scripts/Pes/RekapTask.js" type="text/javascript"></script>
</asp:Content>

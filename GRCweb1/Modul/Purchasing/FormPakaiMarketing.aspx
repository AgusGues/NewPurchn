<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormPakaiMarketing.aspx.cs" Inherits="GRCweb1.Modul.Purchasing.FormPakaiMarketing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Cetak() {
            var wn = window.showModalDialog("../Report/Report.aspx?IdReport=SlipPakaiMKT", "", "resizable:yes;dialogHeight: 600px; dialogWidth: 900px;scrollbars=yes");
        }
    ...
    <cc1:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server" TargetControlID="btnCancel" ConfirmText="Anda yakin untuk Cancel Surat Jalan?" OnClientCancel="onCancel" ConfirmOnFormSubmit="false" />
    ...
    <div id="Div1" runat="server" class="table-responsive" style="width: 100%">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <span>Marketing Drawing Slip</span>
                <div class="pull-right">
                    ...
                    <asp:DropDownList ID="ddlSearch" runat="server" Width="120px">
                        <asp:ListItem Value="ScheduleNo">MDS No</asp:ListItem>
                    </asp:DropDownList>
    ...
    <%--ReasonCancel--%>
    <asp:Label ID="lblHiddenDelete" runat="server" Text=""></asp:Label>
    <cc1:ModalPopupExtender ID="mpePopUpDelete" runat="server"
        TargetControlID="lblHiddenDelete"
        PopupControlID="PanDelete"
        CancelControlID="btnDeleteClose"
        BackgroundCssClass="modalBackground">
    </cc1:ModalPopupExtender>
    <asp:Panel ID="PanDelete" runat="server" CssClass="Popup" align="center" Style="width: 600px;">

        <div class="panel panel-primary">
            <div class="panel-heading">
                <span class="text-left">ALASAN CANCEL</span>
                <div class="pull-right">
                    <input id="btnDeleteClose" runat="server" style="background-color: white; font-weight: bold; font-size: 11px;" type="button" value="Close" onserverclick="btnDeleteClose_ServerClick" />
                    <input id="btnDeleteUpdate" runat="server" style="background-color: white; font-weight: bold; font-size: 11px;" type="button" value="Update" onserverclick="btnDeleteUpdate_ServerClick" />
                </div>
            </div>
            <div class="panel-body">
                <asp:TextBox ID="txtAlasanCancelDelete" runat="server" class="form-control" Width="100%" TextMode="MultiLine" Rows="5"></asp:TextBox>
            </div>
        </div>

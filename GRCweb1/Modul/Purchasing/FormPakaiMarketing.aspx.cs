...
{
    public partial class FormPakaiMarketing : System.Web.UI.Page
    {
        ...
        {
            txtAlasanCancelDelete.Text = string.Empty;
        }


        protected void btnDeleteUpdate_ServerClick(object sender, EventArgs e)
        {
            Session["AlasanCancel"] = txtAlasanCancelDelete.Text;
            Session["AlasanBatal"] = txtAlasanCancelDelete.Text;
            Session["AlasanTolak"] = txtAlasanCancelDelete.Text;
        ...
        protected void btnUpdate_ServerClick(object sender, EventArgs e)
        {
            ...
            kd = companyFacade.GetKodeCompany(((Users)Session["Users"]).UnitKerjaID) + "K";

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormPakaiRePack.aspx.cs" Inherits="GRCweb1.Modul.Purchasing.FormPakaiRePack" %>
    ...
    <div id="Div1" runat="server" class="table-responsive" style="width: 100%">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <span>Re-Pack Drawing Slip</span>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <asp:Button class="btn btn-info" ID="lbAddOP" runat="server" Font-Size="10pt" OnClick="lbAddOP_Click"
                                Text="Tambah" />
                                <div style="padding:2px;"></div>
                            </div>
                        </div>

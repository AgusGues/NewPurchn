...
{
    public partial class FormPakaiRePack : System.Web.UI.Page
    {
        ...
        {
            string FlagNonGrc = " and A.GroupID in (7) ";
            Session["FlagNonGrc"] = FlagNonGrc;
            ...
            arrInventory = inventoryFacade.RetrieveByCriteriaForRePack("A.ItemName", txtCariNamaBrg.Text, Session["FlagNonGrc"].ToString());
            ...
            if (e.CommandName == "AddDelete")
            {
                ...
                if (intApv > 0)
                {
                    ...
                    if (Session["id"] != null)
                    {
                        ...
                        string strPakaiTipe = companyFacade.GetKodeCompany(((Users)Session["Users"]).UnitKerjaID) + "K";
        ...
        protected void btnList_ServerClick(object sender, EventArgs e)
        {
            Company company = new Company();
            CompanyFacade companyFacade = new CompanyFacade();
            string kd = companyFacade.GetKodeCompany(((Users)Session["Users"]).UnitKerjaID) + "R";
        ...
        protected void lbAddOP_Click(object sender, EventArgs e)
        {
            ...
            Company company = new Company();
            CompanyFacade companyFacade = new CompanyFacade();
            string kd = companyFacade.GetKodeCompany(((Users)Session["Users"]).UnitKerjaID) + "K";
        ...
        protected void btnUpdate_ServerClick(object sender, EventArgs e)
        {
            ...
            kd = companyFacade.GetKodeCompany(((Users)Session["Users"]).UnitKerjaID) + "R";
            ...
            //10 for MARKETING khusus Re-Pack saja nih
            pakai.PakaiTipe = 10;
        ...
        private void InsertLog(string eventName)
        {
            ...
            eventLog.ModulName = "Entry Pemakaian Marketing";

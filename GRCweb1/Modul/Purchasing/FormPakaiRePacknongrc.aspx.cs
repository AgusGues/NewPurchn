...
{
    public partial class FormPakaiRePacknongrc : System.Web.UI.Page
    {
        ...
        {
            string FlagNonGrc = " and A.GroupID in (14) ";
            ...
            if (e.CommandName == "AddDelete")
            {
                ...
                if (intApv > 0)
                {
                    ...
                    if (Session["id"] != null)
                    {
                        ...
                        string strPakaiTipe = companyFacade.GetKodeCompany(((Users)Session["Users"]).UnitKerjaID) + "G";
        ...
        protected void btnList_ServerClick(object sender, EventArgs e)
        {
            Company company = new Company();
            CompanyFacade companyFacade = new CompanyFacade();
            string kd = companyFacade.GetKodeCompany(((Users)Session["Users"]).UnitKerjaID) + "G";
        ...
        protected void btnUpdate_ServerClick(object sender, EventArgs e)
        {
            ...
            kd = companyFacade.GetKodeCompany(((Users)Session["Users"]).UnitKerjaID) + "G";
        ...
        private void InsertLog(string eventName)
        {
            ...
            eventLog.ModulName = "Entry Pemakaian Repack Non GRC";

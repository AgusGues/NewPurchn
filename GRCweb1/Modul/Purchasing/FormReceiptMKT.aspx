<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormReceiptMKT.aspx.cs" Inherits="GRCweb1.Modul.Purchasing.FormReceiptMKT" %>
...
<script language="javaScript" type="text/javascript">
	...
	function Cetak() {
		var wn = window.showModalDialog("../Report/Report.aspx?IdReport=SlipMKT", "", "resizable:yes;dialogHeight: 600px; dialogWidth: 900px;scrollbars=yes");
	}
	...
	<div id="Div1" runat="server">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<span>Marketing Receipt Slip</span>
				<div class="pull-right">
					...
					<asp:ListItem Value="ScheduleNo">Kode Mkt</asp:ListItem></asp:DropDownList>
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="row">
							<div class="col-md-4">Kode Mkt</div>
							<div class="col-md-8">
						...
						<div class="row">
							...
							<div class="col-md-8">
								<asp:TextBox class="form-control" ID="txtCariOP" runat="server" AutoPostBack="True"></asp:TextBox>
								<div style="padding: 2px;"></div>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col-md-4">KodeItem</div>
							<div class="col-md-8">
					...
					<div class="col-md-6">
						...
						<div class="row">
							...
							<div class="col-md-8">
								...
								<asp:TextBox ID="txtPrice" runat="server" BorderStyle="Groove" ReadOnly="True" Visible="False"
						...
						<div class="row">
							<div class="col-md-12 text-right">
								<asp:LinkButton class="btn btn-info" ID="lbAddOP" runat="server" OnClick="lbAddOP_Click">Tambah</asp:LinkButton>
								<div style="padding: 2px;"></div>
							</div>
						</div>
					</div>
				...
				<div class="table-responsive">
					<div id="div2" style="height: 250px; overflow: auto" class="contentlist">

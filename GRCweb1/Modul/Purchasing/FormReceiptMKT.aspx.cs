...
{
    public partial class FormReceiptMKT : System.Web.UI.Page
    {
        public enum Status
        {
            Open = 0,
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (txtCariOP.Text != string.Empty)
                {
                    ...
                    {
                        //if (txtCariOP.Text.Substring(0, 2) == (kd + "I"))
                        //{
        ...
        private void LoadReceipt(string strReceiptNo)
        {
            ...
            //string forReceipt = companyFacade.GetKodeCompany(((Users)Session["Users"]).UnitKerjaID) + "S";
            //string forReceipt = "KS";
            string forReceipt = companyFacade.GetKodeCompany(((Users)Session["Users"]).UnitKerjaID) + "K";
            clearForm();
        ...
        protected void btnList_ServerClick(object sender, EventArgs e)
        {
            ...
            //Response.Redirect("ListReceiptMRS.aspx?approve=KS");
        }
        ...
        private void InsertLog(string eventName)
        {
            ...
            eventLog.ModulName = "Entry Marketing Receipt";

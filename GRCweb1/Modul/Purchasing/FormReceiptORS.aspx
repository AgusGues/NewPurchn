<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormReceiptORS.aspx.cs" Inherits="GRCweb1.Modul.Purchasing.FormReceiptORS" %>
...
<script type="text/javascript">
	...
	function Cetak() 
	{
		var wn = window.showModalDialog("../Report/Report.aspx?IdReport=SlipORS", "", "resizable:yes;dialogHeight: 600px; dialogWidth: 900px;scrollbars=yes");
	}
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="pull-right">
					...
					<asp:ListItem Value="ScheduleNo">ORS No</asp:ListItem></asp:DropDownList>
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="row">
							<div class="col-md-4">Kode Ors</div>
							<div class="col-md-8">
					...
					<div class="col-md-6">
						...
						<div class="row">
							<div class="col-md-12 text-right">
								<asp:Button class="btn btn-info" Text="Tambah" ID="lbAddOP" runat="server" OnClick="lbAddOP_Click" />
								<div style="padding:2px;"></div>
							</div>
						</div>
					</div>

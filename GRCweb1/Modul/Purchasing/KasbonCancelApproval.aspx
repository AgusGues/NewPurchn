<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="KasbonCancelApproval.aspx.cs" Inherits="GRCweb1.Modul.Purchasing.KasbonCancelApproval" %>
                        ...
                        <table class="nbTableHeader">
                            <tr style="">
                                ...
                                <td style="width:85%; padding-right:10px; text-align:right">
                                    ...
                                    &nbsp;
                                    <asp:TextBox ID="txtCari" Width="250px" Text="Find by Nomor PO" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" runat="server" placeholder="Find by Nomor PO"></asp:TextBox>
                        ...
                        <div class="" style="padding-top:5px;">
                            <table class="tbStandart">
                                ...
                                <tr>
                                    ...
                                    <td class="FormField" colspan="3"></td>
                                    <td class="FormField">Approval: <b><asp:Label ID="txtStatus" runat="server"></asp:Label></b> <br />
                                    Status : <b><asp:Label ID="txtCancel" runat="server" Visible="false"></asp:Label></b> <br />
                                    <asp:Label ID="txtID" runat="server" Visible="false"></asp:Label></td>
                                </tr>
                            </table>
                            <hr />

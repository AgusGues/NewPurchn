<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="KasbonList.aspx.cs" Inherits="GRCweb1.Modul.Purchasing.KasbonList" %>
                        ...
                        <tr>
                            <td style="width: 100%; height: 49px">
                                <table class="nbTableHeader">
                                    <tr>
                                        <td style="width: 218%">
                                            <%--<strong>List Kasbon</strong>--%>
                                        </td>
                                        <td style="width: 75px">
                                            <input id="btnUpdate" runat="server" CssClass="btn btn-primary btn-sm" type="button" value="Form Kasbon" onserverclick="btnUpdate_ServerClick" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control input-sm" Width="120px"></asp:TextBox>
                                        </td>
                                        <td style="width: 3px">
                                    ...
                                    <div id="div2" style="width: 100%; height: 450px; overflow: auto">
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="KasbonDate" HeaderText="Tanggal" />

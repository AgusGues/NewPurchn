...
{
    public partial class KasbonList : System.Web.UI.Page
    {
        ...
        private void LoadData(string strGroupID)
        {
            KasbonFacade kasbonFacade = new KasbonFacade();
            ArrayList arrKasbonDetail = new ArrayList();
            arrKasbonDetail = kasbonFacade.RetrieveAllK(int.Parse(strGroupID), "and k.Notawar like ", txtSearch.Text);
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Add")
            {
                ...
                Response.Redirect("KasbonInput.aspx?NoPengajuan=" + row.Cells[0].Text);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    e.Row.Cells[8].Text = "Realisasi Head";
                }
                if (e.Row.Cells[8].Text == "4")
                {
                    e.Row.Cells[8].Text = "Realisasi Finance";
                }

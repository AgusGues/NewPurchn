<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListPakaiApprove.aspx.cs" Inherits="GRCweb1.Modul.Purchasing.ListPakaiApprove" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ContentTemplate>            
    <div id="Div1" runat="server" with="100%" class="table-responsive">
...
width="100%">
  ...
  <TR>
    <TD style="width: 100%;">
        ...
        <TBODY>
        <TR >
          <TD style="width: 703px; height: 49px" ><table class=nbTableHeader>
                  <tr>
                      <td style="width: 218%">
                          <strong>Daftar Pemakaian</strong></td>                      
                      <td style="width: 75px">
                          <input id="btnUpdate" runat="server" style="background-image: url('file:///D:/GRCBoardProject/GRCBoardProject/Modul/images/Button_Back.gif');
                              ...
                              type="button" value="Form Approve Pemakaian" 
                              onserverclick="btnUpdate_ServerClick" /></td>                      
                      <td>
                          <asp:DropDownList ID="ddlSearch" runat="server" Width="120px"> 
                            <asp:ListItem Value="ScheduleNo">No Pakai</asp:ListItem>                             
                          </asp:DropDownList></td>
                      <td>
                           ...
                           <div id="div2" style="width:770px;height:400px;overflow:auto">
                             <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                 ...
                                 <Columns>                                     
                                     ...
                                     <asp:BoundField DataField="PakaiTipe" HeaderText="Tipe" />                                     

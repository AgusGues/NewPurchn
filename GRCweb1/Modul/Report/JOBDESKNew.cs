...
namespace GRCweb1.Modul.Report {
    ...
    public class JOBDESKNew : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GRCweb1.Modul.Report.JOBDESKNew.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedJOBDESKNew : Component, ICachedReport {
        
        public CachedJOBDESKNew() {
        }

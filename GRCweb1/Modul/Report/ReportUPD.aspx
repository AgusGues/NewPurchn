<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportUPD.aspx.cs" Inherits="GRCweb1.Modul.Report.ReportUPD" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.4000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <form id="form1" runat="server">
        <div class="row" style="width: 100%">
            <div class="col-xs-12 col-sm-12">
                ...
                <div class="card-body bg-default-gradient" style="width: 100%">
                    <div class="row">
                        <div class="col-md-12">

...
namespace GRCweb1.Modul.ReportT1T3 {
    ...
    public class LReadyStock1 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GRCweb1.Modul.ReportT1T3.LReadyStock1.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedLReadyStock1 : Component, ICachedReport {
        
        public CachedLReadyStock1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            LReadyStock1 rpt = new LReadyStock1();
            rpt.Site = this.Site;
            return rpt;
        }

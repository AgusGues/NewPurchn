<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LapLoadingMuatan.aspx.cs" Inherits="GRCweb1.Modul.Sarmut.LapLoadingMuatan" %>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">Laporan Loading Time</h3>
                            </div>
                                        ...
                                        <div class="col-md-9">
                                            <asp:TextBox ID="txtTgl1" runat="server" class="form-control" Width="150px"></asp:TextBox>
                                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd-MMM-yyyy"
                                                    TargetControlID="txtTgl1" Enabled="True">
                                        ...
                                        <div class="col-md-9">
                                            <asp:TextBox ID="txtTgl2" runat="server" class="form-control" Width="150px"></asp:TextBox>
                                                <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd-MMM-yyyy"
                                                    TargetControlID="txtTgl2" Enabled="True">
                                                </cc1:CalendarExtender>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    <div class="row">
                                        <asp:Button ID="btnPreview" class="btn btn-sm btn-primary" runat="server" Text="Preview" OnClick="btnPreview_Click"/>
                                                <asp:Button ID="btnExport" class="btn btn-sm btn-success" runat="server" Text="Export to Excel" OnClick="btnExport_Click"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <asp:Repeater ID="lstSch" runat="server" OnItemDataBound="lstSch_DataBound">
                                                <ItemTemplate>
                                                    <tr class="OddRows baris">
                                                                     <td class="kotak" nowrap="nowrap" style="width: 5%; font-size: small;
                                                            font-weight: bolder;" bgcolor="#00CC00">
                                                           <%# Container.ItemIndex+1 %>
                                                        </td>
                                                        <td class="kotak" nowrap="nowrap" style="width: 30%; font-size: small;
                                                            font-weight: bolder;" bgcolor="#00CC00">
                                                            <%# Eval("ScheduleNo")%>
                                                        </td>
                                                                                                             <td class="kotak" nowrap="nowrap"  style="width: 10%; font-size: small;
                                                            font-weight: bolder;" bgcolor="#00CC00">
                                                            <%# Eval("Mobil")%>
                                                        </td>
                                        
                                                                                                             <td class="kotak" nowrap="nowrap"  style="width: 15%; font-size: small;
                                                            font-weight: bolder;" bgcolor="#00CC00">
                                                            <%# Eval("TglIn")%>
                                                        </td>
                                                                                                             <td class="kotak" nowrap="nowrap" style="width: 15%; font-size: small;
                                                          ...
                                                          <%# Eval("JenisKendaraan")%>
                                                            ...
                                                            <asp:Repeater ID="lstSj" runat="server" OnItemDataBound="lstSj_DataBound">
                                                            <ItemTemplate>
                                                                <tr class="EvenRows baris">
                                                                    <td class="kotak tengah" nowrap="nowrap" style="width: 5%">
                                                                        <span class="angka"></span>
                                                                    </td>
                                                                    <td class="kotak" nowrap="nowrap" colspan="2" style="width: 30%">
                                                                        <%#  Eval("SuratJalanNo")%>
                                                                    </td>
                                                                    <td class="kotak tengah" colspan="2" style="width: 5%">
                                                                        <%# Eval("Description")%>
                                                                    </td>

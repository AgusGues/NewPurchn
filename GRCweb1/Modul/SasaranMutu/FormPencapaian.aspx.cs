...
{
    public partial class FormPencapaian : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                DisplayLabel(16, 0);    //Over Time
                DisplayLabel(5, 0);    //Tingkat Ketidakhadiran
            }
            //else
        ...
        {
            string[] arrLabel = { "label-success", "label-warning", "label-danger", "label-info", "label-inverse", "label-white", "label-purple", "label-default",
                "label-grey","label-holder","label-important","label-left","label-light","label-lg","label-pink","label-primary","label-sm","label-white", "label-xlg","label-yellow"};

            string strDivCtrp = string.Empty; string strPGridView = string.Empty;
            strDivCtrp = "DivCtrp" + sarMutDeptID.ToString();
            strPGridView = "PGridView" + sarMutDeptID.ToString() + "a";
            ...
            if (arrOutputProduksiCtrp.Count > 0)
            {
                ...
                //"                   <span class=\"label label-success arrowed-right\"> Board Mill > Tingkat Produktivitas Delivery Plant</span>" +
                "                   <span class=\"label "+ arrLabel[1] + " arrowed-right\"> "+ xDept + " > "+xSarmut+" </span>" +
                "				</h5>" +
                ...
                //"                               <table id=\"PGridView53a\" style=\"width:100%;border-collapse:collapse;font-family:·L³n¥¿¶ÂÅé, Tahoma, Arial, Verdana;font-weight: normal;font-size: 12px;color: #333333;\">" +
                "                   <div id=\""+strDivCtrp+"\" runat=\"server\"> " +
                "                               <table id=\""+strPGridView+"\" style=\"width:100%;border-collapse:collapse;font-family:·L³n¥¿¶ÂÅé, Tahoma, Arial, Verdana;font-weight: normal;font-size: 12px;color: #333333;\">" +

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewApvTPP.aspx.cs" Inherits="GRCweb1.Modul.TPP.NewApvTPP" %>
        ...
        <ContentTemplate>
            <div id="div1" runat="server" class="table-responsive" style="width:100%">
                <table>
                            ...
                            <table class="nbTableHeader">
                                <tr style="">
                                    <td style="width: 20%; padding-left: 15px">
                                        <b style="text-align: center">&nbsp;APPROVAL TPP
                                            <br />
                                        </b>
                                    </td>
                    ...
                    <tr>
                        <td>
                            <div style="width: 99%; background-color: white; padding: 5px">
...
&nbsp;<asp:Panel ID="Panelklausul" runat="server" Height="100px" ScrollBars="Vertical" Visible="False" Width="100%" Wrap="False">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="border: thin solid #000000" width="25%">

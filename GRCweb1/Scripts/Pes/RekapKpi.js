...
function ListTahun(){
	$('.the-loader').show();
	$.ajax({
	    url: 'RekapKpi.aspx/ListTahun', type: 'POST', contentType: 'application/json; charset=utf-8', dataType: 'json',
...
function ListDept(){
	$('.the-loader').show();
	$.ajax({
	    url: 'RekapKpi.aspx/ListDept', type: 'POST', contentType: 'application/json; charset=utf-8', dataType: 'json',
		success:function(data){
...
$('#Department').change(function(){
	$('.the-loader').show();
	$.ajax({
	    url: 'RekapKpi.aspx/ListPic', type: 'POST', contentType: 'application/json; charset=utf-8', dataType: 'json',
		data : JSON.stringify({
			dept:$('#Department').val()
		}),
		success:function(data){
...
$('#BtnFind').click(function(){
	...
	$.ajax({
	    url: 'RekapKpi.aspx/ListData', type: 'POST', contentType: 'application/json; charset=utf-8', dataType: 'json',
		data : JSON.stringify({
			dept:$('#Department').val(),
			user:PicUser
		}),
		success:function(output){
			$.each(output.d,function(i,b){
				...
				$.ajax({
				    url: 'RekapKpi.aspx/ListDataDtl', type: 'POST', contentType: 'application/json; charset=utf-8', dataType: 'json',
					data : JSON.stringify({
						dept:$('#Department').val(),
						user:userpes,
						bulan:$('#Bulan').val(),

var vesselflow = function () {
    ...
    var initdata = function () {
        ...
        GetBerthAlert();
        GetSPBBelumNota();
        var datapie = localStorage.getItem("data");
        if (datapie) {
            var data = JSON.parse(datapie);
            setdatapie(data);
            reload();
        } else {
            $.ajax({
                url: "/VesselFlow/get_data_vesselflow",
                method: "GET",
                dataType: "json",
                async: false,
    ...
    var GetPilotAlert = function () {
        ...
        $.ajax({
            url: "/VesselFlow/GetDataPilotAlert",
            method: "GET",
            dataType: "json",
            async: true,
            success: function (msgd) {
    ...
    var GetBerthAlert = function () {
        ...
        $.ajax({
            url: "/VesselFlow/GetDataBerthAlert",
            method: "GET",
            dataType: "json",
            async: true,
            success: function (msgd) {
    ...
    var setdatapie = function (xdata) {
        $.each(xdata, function (i, items) {
            ...
            //setpieitem(items.KAWASAN + (2), items.TOTAL_PRCN, items.TOTAL_PRCN_T, items.PRCN);

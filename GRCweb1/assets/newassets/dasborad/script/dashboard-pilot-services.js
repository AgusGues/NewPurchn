$(document).ready(function () {
    //var TuggingServicesLocal = localStorage.getItem('dataTuggingServices');
    //var AvaPanduLocal = localStorage.getItem('dataAvaPandu');
    //var PilotWorkLocal = localStorage.getItem('dataPilotWork');
    //var VesselProgLocal = localStorage.getItem('dataVesselProg');
    //var WTPLocal = localStorage.getItem('dataWTP');
    //var PilotWeekLocal = localStorage.getItem('dataPilotWeek');
    //var TuggingLocal = localStorage.getItem('dataTugging');

    //if (TuggingServicesLocal != null) {
    //    DrawData(TuggingServicesLocal);
    //}
    //if (AvaPanduLocal != null) {
    //    DrawPandu(AvaPanduLocal);
    //}
    //if (PilotWorkLocal != null) {
    //    DrawGerakanPandu(PilotWorkLocal);
    //}
    //if (VesselProgLocal != null) {
    //    DrawVesselProgress(VesselProgLocal);
    //}
    //if (WTPLocal != null) {
    //    DrawWTP(WTPLocal);
    //}
    //if (PilotWeekLocal != null) {
    //    DrawPanduWeek(PilotWeekLocal);
    //}
    //if (TuggingLocal != null) {
    //    DrawTugging(TuggingLocal);
    //}
...
/*
function drawCountDown(data) {
    var tglSkrg = new Date();
    var tglMulai = toDateFromJson(data.TGL_MULAI);
    var tglSelesai = toDateFromJson(data.TGL_SELESAI);

    var miliCountDown = tglSelesai - tglSkrg;
    var newDate = new Date(miliCountDown);

    $('#' + data.NAMA_KAWASAN + "cd").text(miliSecondToClock(miliCountDown));
}

function miliSecondToClock(mili) {
    var hour = 0;
    var minute = 0;
    var strHour = "00";
    var strMinute = "00";
        ...
        series: [{
            ...
            axisLine: {
                lineStyle: {
                    width: 110,
                    color: [
                        [(data.EXCELLENT / 100), '#28a745'],
                        [(data.FAIR / 100), '#007bff'],
